  ...
  async getCampaigns(query: BonusCampaignsQuery = {}): Promise<BonusCampaignsListResponse> {
    try {
      ...
      if (response.success && response.data) {
        if (__DEV__)
          console.log(
            '[BonusZone] Fetched successfully:',
  ...
  async fundCampaign(id: string, amount: number): Promise<BonusCampaignAdmin> {
    try {
      ...
      if (response.success && response.data) {
        if (__DEV__)
          console.log(
            '[BonusZone] Campaign funded, new budget:',
            response.data.reward?.totalBudget
          );
        return response.data;
      }
  ...
  async getDashboard(): Promise<BonusZoneDashboard> {
    try {
      ...
      if (response.success && response.data) {
        if (__DEV__)
          console.log(
            '[BonusZone] Dashboard fetched, active campaigns:',
  ...
  async getFraudAlerts(limit?: number): Promise<BonusFraudAlert[]> {
    try {
      ...
      if (response.success && response.data) {
        ...
        if (__DEV__) console.log('[BonusZone] Fraud alerts fetched:', alerts.length);
        return alerts;
      }

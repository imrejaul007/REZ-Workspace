...
class MerchantsService {
  ...
  async createMerchant(data: {
    ...
    try {
      if (__DEV__) console.log('[Merchants] Creating merchant:', data.businessName);
      ...
      if (__DEV__) console.error('[Merchants] Create merchant error:', error.message);
  ...
  async updateStoreSettings(
    ...
    try {
      if (__DEV__) console.log('[Merchants] Updating store settings:', storeId, settings);
      ...
      if (__DEV__) console.error('[Merchants] Update store settings error:', error.message);
  ...
  async toggleStoreProgram(
    ...
    try {
      if (__DEV__)
        console.log('[Merchants] Toggling program for store:', storeId, isProgramMerchant);
      ...
      if (__DEV__) console.error('[Merchants] Toggle store program error:', error.message);

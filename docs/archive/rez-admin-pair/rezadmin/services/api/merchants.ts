  ...
  async getMerchants(
    ...
    try {
      ...
      if (response.success) {
        ...
        return validateResponse(MerchantsListResponseSchema, normalised, 'MerchantsService.getMerchants');
      }
  ...
  async getMerchant(merchantId: string): Promise<Merchant> {
    try {
      ...
      if (response.success && response.data) {
        ...
        return validateResponse(MerchantSchema, normalised, 'MerchantsService.getMerchant');
      }

...
**New:** REZ Identity Hub v2.0 (Port 6000) - 25 data sources for pre-call research
...
| Port | Service | Company | Type | Description |
|------|---------|---------|------|-------------|
| **6000** | rez-identity-hub | RTNM | Intelligence | Unified User Intelligence - Pre-Call Research (25 data sources) |
...
#### REZ Identity Hub v2.0 (Port 6000) - NEW
...
| RABTUL (Auth, Wallet, Payment, Order, Catalog) | RABTUL | Identity, balance, transactions |
...
| REZ Atlas | REZ Merchant | Lead scores, signals, territory |
| HOJAI AI | HOJAI | Memory, agents, knowledge graph |
| REZ Intelligence | HOJAI | Intent, signals, predictions |

**Features:** MongoDB persistence, Event Bus (4025), Background sync, Admin dashboard at `/admin`

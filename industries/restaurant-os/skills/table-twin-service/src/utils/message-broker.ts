...
class MessageBroker {
  ...
  async connect(): Promise<void> {
    ...
    try {
      ...
      await this.channel.assertQueue('restaurant.table.events', { durable: true });
      await this.channel.assertQueue('restaurant.order.events', { durable: true });

      await this.channel.bindQueue('restaurant.table.events', 'restaurant.events', 'restaurant.table.*');

...
export function apiKeyAuth(req: AuthRequest, res: Response, next: NextFunction): void {
  ...
  const validApiKey = process.env.API_KEY || 'driver-twin-api-key';
...
export function extractServiceId(req: AuthRequest, _res: Response, next: NextFunction): void {
...
export function extractUserId(req: AuthRequest, _res: Response, next: NextFunction): void {

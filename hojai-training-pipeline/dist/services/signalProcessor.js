...
import { SignalEventSchema, LearningSource, LearningType, LearningStage, LearningStatus } from '../types/index.js';
...
export class SignalProcessor {
    highValueSignals = new Set(['conversion', 'error', 'purchase', 'signup']);
    signalToLearningType = {
    ...
    async processSignal(signal) {
        try {
            ...
            const signalEvent = validatedSignal;
     ...
     */
    async extractPatternFromSignal(signal) {
     ...
     */
    async processConversation(conversationId, messages, metadata) {
        try {

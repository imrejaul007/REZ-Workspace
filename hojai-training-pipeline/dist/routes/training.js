...
import { LearningSource, LearningType, SignalEventSchema } from '../types/index.js';
...
router.post('/conversation', async (req, res) => {
    try {
        ...
        const result = await learner.learnFromConversation(validated.conversationId, validated.messages, {
            tenantId: validated.tenantId,
            userId: validated.userId
        });
        res.status(200).json({
...
router.post('/correction', async (req, res) => {
    try {
        ...
        const result = await learner.learnFromCorrection(validated.originalContent, validated.correctedContent, validated.reason, {
            tenantId: validated.tenantId,
            userId: validated.userId,

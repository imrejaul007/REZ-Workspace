...
import { PERMISSION_DEFINITIONS, createResponse, createErrorResponse, tenantMiddleware } from '../index.js';
const router = Router();
/**
 * GET /api/permissions
 ...
 */
router.get('/categories', tenantMiddleware(), (req, res) => {
    const ctx = req.tenantContext;
 ...
 */
router.post('/check', tenantMiddleware(), (req, res) => {
    const ctx = req.tenantContext;

...
export type Industry = 'retail' | 'healthcare' | 'hospitality' | 'jewellery' | 'education' | 'finance' | 'real_estate';
...
export type IdentityType = 'phone' | 'email' | 'device_id' | 'device_fingerprint' | 'ip_address' | 'cookie_id' | 'account_id';
...
export type ConversationChannel = 'whatsapp' | 'instagram' | 'facebook' | 'webchat' | 'api';
...
export type MessageContentType = 'text' | 'image' | 'document' | 'video' | 'audio' | 'location' | 'contact' | 'sticker' | 'template' | 'button_response' | 'interactive';
...
export type OrderStatus = 'pending' | 'confirmed' | 'preparing' | 'ready' | 'dispatched' | 'delivered' | 'completed' | 'cancelled' | 'refunded' | 'partial_refund';
...
export type EventCategory = 'commerce' | 'identity' | 'loyalty' | 'engagement' | 'support' | 'communication' | 'ai' | 'system';
...
export type SegmentOperator = 'eq' | 'neq' | 'gt' | 'gte' | 'lt' | 'lte' | 'contains' | 'in' | 'not_in' | 'between' | 'exists' | 'not_exists';

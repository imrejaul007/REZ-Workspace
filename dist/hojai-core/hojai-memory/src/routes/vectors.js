...
import { vectorIndexStore, memoryStore, textToEmbedding } from '../index.js';
const router = Router();
// ============================================
// HELPERS
// ============================================
 ...
 * Delete index
 */
router.delete('/indices/:id', (req, res) => {
    const ctx = req.tenantContext;
    const { id } = req.params;
    const index = vectorIndexStore.find(i => i.id === id && i.tenantId === ctx.tenant_id);
    if (!index) {

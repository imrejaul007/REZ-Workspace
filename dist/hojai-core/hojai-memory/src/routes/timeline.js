...
import { timelineStore } from '../index.js';
const router = Router();
// ============================================
// HELPERS
// ============================================
 ...
 */
router.post('/:userId/cleanup', (req, res) => {
    const ctx = req.tenantContext;
    const { userId } = req.params;
    ...
    const filtered = userTimeline.filter(e => e.userId !== userId || new Date(e.timestamp) > beforeDate);

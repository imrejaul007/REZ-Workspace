...
app.get('/api/models', async (req, res) => {
    ...
    const models = await modelService.getAvailableModels(tenantId, req.query.tier);
...
app.get('/api/cost-estimate', async (req, res) => {
    const tenantId = req.headers['x-tenant-id'];
    const estimate = await modelService.getCostEstimate(tenantId, req.query.task, req.query.tokens ? parseInt(req.query.tokens) : undefined);

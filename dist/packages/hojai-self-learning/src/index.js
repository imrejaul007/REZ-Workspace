...
// Record interaction
app.post('/api/interaction', auth, async (req, res) => {
...
// Record correction
app.post('/api/correction', auth, async (req, res) => {
...
// Get patterns
app.get('/api/patterns/:aiId', auth, async (req, res) => {
...
// Get memory
app.get('/api/memory/:aiId', auth, async (req, res) => {

...
(function (IntentType) {
    IntentType["DICTATION"] = "DICTATION";
    IntentType["QUERY"] = "QUERY";
    IntentType["ACTION"] = "ACTION";
    IntentType["WORKFLOW"] = "WORKFLOW";
    IntentType["AGENT"] = "AGENT";
    IntentType["MULTI_AGENT"] = "MULTI_AGENT";
...
export class IntentService {
     ...
     */
    detectFromContext(text, context) {
     ...
     */
    getSuggestedAction(type, entities) {
        switch (type) {

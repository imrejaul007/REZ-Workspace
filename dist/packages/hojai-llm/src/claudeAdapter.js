...
import { ClaudeModel, LLMProvider, MessageRole } from './types/index.js';
            ...
            try {
                ...
                if (error instanceof Anthropic.RateLimitError) {
                    const retryAfterMs = error.retryAfter
                        ...
                        : undefined;
                    throw new RateLimitError(`Claude rate limit exceeded: ${error.message}`, { retryAfterMs, limitType: 'requests', originalError: error });
                }
                // Check if retryable
...
// DEFAULT EXPORT
// ============================================================================
export function createClaudeAdapter(config, logger) {

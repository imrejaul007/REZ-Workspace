 ...
 */
export function buildSalesContext(employee, conversation) {
 ...
 */
export function buildSupportContext(employee, conversation, ticketInfo) {
    const builder = new ContextBuilder();
    const context = builder.build(employee, conversation);
 ...
 */
export function buildAnalystContext(employee, query, dataContext) {
    const builder = new ContextBuilder();
...
// DEFAULT EXPORT
// ============================================================================
export function createContextBuilder(options, logger) {

...
// TYPES
// ============================================================================
export { LLMProvider, ClaudeModel, OpenAIModel, TaskType, MessageRole, EmployeeRole } from './types/index.js';
...
// ADAPTERS
// ============================================================================
export { ClaudeAdapter, createClaudeAdapter } from './claudeAdapter.js';
export { OpenAIAdapter, createOpenAIAdapter } from './openaiAdapter.js';
// ============================================================================
// ROUTER
// ============================================================================
export { ModelRouter, createModelRouter, DEFAULT_ROUTING_RULES, getModelContextWindow, fitsInContext } from './modelRouter.js';
// ============================================================================
// CONTEXT BUILDER
// ============================================================================
export { ContextBuilder, createContextBuilder, buildSalesContext, buildSupportContext, buildAnalystContext } from './contextBuilder.js';
// ============================================================================
// PROMPT TEMPLATES
// ============================================================================
...
import { LLMError, isRetryableError, sleep } from './errors.js';
/**
 ...
 */
export function createUnifiedLLMClient(config, logger) {

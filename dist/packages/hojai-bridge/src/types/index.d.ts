...
export declare const CrossAppIdentitySchema: z.ZodObject<{
    ...
    linkMethod: "exact" | "manual" | "fuzzy" | "probabilistic";
...
export declare const BridgeEventSchema: z.ZodObject<{
    ...
    routeTo: ("hojai" | "rez_ecosystem" | "rez_intelligence")[];
...
export declare const IntelligenceShareSchema: z.ZodObject<{
    ...
    source: string;
    data: Record<string, any>;
    type: "audience" | "prediction" | "intent" | "segment" | "behavioral_signal" | "trust_score" | "churn_risk" | "ltv_score";
    id: string;
    createdAt: Date;
    tenantId: string;
    confidence: number;

...
import { UserStatus, ApiKeyType, ApiKeyStatus, AuditAction } from '../../types/index.js';
...
export class AuthService {
    ...
    generateTokens(user) {
        ...
        const refreshToken = jwt.sign({ ...payload, tokenType: 'refresh' }, this.jwtRefreshSecret, { expiresIn: this.refreshTokenExpiry });
        return {
            accessToken,
            refreshToken,
    ...
    async createApiKey(params) {
        const { apiKey, rawKey } = await ApiKeyModel.generateKey(params.tenantId, params);
        // Log audit
        await auditLogger.log({
            tenantId: params.tenantId,

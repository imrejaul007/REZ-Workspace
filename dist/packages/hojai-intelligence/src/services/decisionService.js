...
import { DecisionType, PredictionRisk } from '../types/index.js';
...
export class DecisionService {
    ...
    async reviewDecision(params) {
        ...
        const decision = await DecisionModel.findOneAndUpdate({ _id: decisionId, tenantId, status: 'manual_review' }, {
            $set: {

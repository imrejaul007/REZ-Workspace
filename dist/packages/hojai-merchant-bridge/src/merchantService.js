...
export class MerchantBridgeService {
    ...
    async getMerchant(merchantId) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}`, { headers: this.headers() });
    ...
    async getMerchantByPhone(phone) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/phone/${phone}`, { headers: this.headers() });
            return this.transformMerchant(res.data);
        }
        catch (error) {
    ...
    async updateMerchant(merchantId, updates) {
        try {
            const res = await axios.patch(`${this.baseUrl}/api/merchants/${merchantId}`, updates, { headers: this.headers() });
            return this.transformMerchant(res.data);
        }
        catch (error) {
    ...
    async getCustomers(merchantId) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/customers`, { headers: this.headers() });
    ...
    async getCustomerByPhone(merchantId, phone) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/customers/phone/${phone}`, { headers: this.headers() });
            return res.data;
        }
        catch (error) {
    ...
    async findOrCreateCustomer(merchantId, phone, name) {
        try {
            const res = await axios.post(`${this.baseUrl}/api/merchants/${merchantId}/customers`, { phone, name }, { headers: this.headers() });
            return res.data;
        }
        catch (error) {
    ...
    async updateCustomerLoyalty(merchantId, customerId, points) {
        try {
            await axios.post(`${this.baseUrl}/api/merchants/${merchantId}/customers/${customerId}/loyalty`, { points }, { headers: this.headers() });
            return true;
        }
        catch (error) {
    ...
    async getMenu(merchantId) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/menu`, { headers: this.headers() });
    ...
    async searchMenu(merchantId, query) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/menu/search?q=${encodeURIComponent(query)}`, { headers: this.headers() });
            return res.data.items || [];
        }
        catch (error) {
    ...
    async getMenuItem(merchantId, itemId) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/menu/${itemId}`, { headers: this.headers() });
            return res.data;
        }
        catch (error) {
    ...
    async getTodayOrders(merchantId) {
        try {
            ...
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/orders?date=${today}`, { headers: this.headers() });
    ...
    async getCustomerOrders(merchantId, customerId) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/customers/${customerId}/orders`, { headers: this.headers() });
            return res.data.orders || [];
        }
        catch (error) {
    ...
    async createOrder(merchantId, order) {
        try {
            const res = await axios.post(`${this.baseUrl}/api/merchants/${merchantId}/orders`, order, { headers: this.headers() });
            return res.data;
        }
        catch (error) {
    ...
    async updateOrderStatus(merchantId, orderId, status) {
        try {
            await axios.patch(`${this.baseUrl}/api/merchants/${merchantId}/orders/${orderId}`, { status }, { headers: this.headers() });
            return true;
        }
        catch (error) {
    ...
    async getTables(merchantId) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/tables`, { headers: this.headers() });
    ...
    async checkTableAvailability(merchantId, date, time, guests) {
        try {
            const res = await axios.get(`${this.baseUrl}/api/merchants/${merchantId}/tables/availability?date=${date}&time=${time}&guests=${guests}`, { headers: this.headers() });
            return res.data.tables || [];
        }
        catch (error) {

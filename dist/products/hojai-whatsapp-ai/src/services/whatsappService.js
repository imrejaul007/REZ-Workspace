...
export class WhatsAppService {
    ...
    async sendTextMessage(to, body) {
        ...
        try {
            const response = await axios.post(`${this.baseUrl}/${this.apiVersion}/${this.phoneNumberId}/messages`, {
     ...
     */
    async sendReplyButtons(to, body, buttons) {
        if (!this.accessToken) {
            return { success: false, error: 'Not configured' };
        }
        try {
    ...
    async markAsRead(messageId) {
        if (!this.accessToken)
            return false;
        try {
            await axios.post(`${this.baseUrl}/${this.apiVersion}/${this.phoneNumberId}/messages`, {
                messaging_product: 'whatsapp',
                status: 'read',
    ...
    async getMessageStatus(messageId) {
        if (!this.accessToken)
            return 'unknown';
        try {
            const response = await axios.get(`${this.baseUrl}/${this.apiVersion}/${messageId}`, { headers: this.getHeaders() });
    ...
    async getTemplates() {
        if (!this.accessToken)
            return [];
        try {
            const response = await axios.get(`${this.baseUrl}/${this.apiVersion}/${this.phoneNumberId}/message_templates`, { headers: this.getHeaders() });
    ...
    async createTemplate(params) {
        ...
        try {
            const response = await axios.post(`${this.baseUrl}/${this.apiVersion}/${this.phoneNumberId}/message_templates`, params, { headers: this.getHeaders() });
            return {
                success: true,
                id: response.data.id
            };

 ...
 */
import { merchantBridge, orderBridge, bookingBridge } from '../../hojai-merchant-bridge/src/index.js';
export class MerchantIntegration {
    /**
     * Get complete context for AI processing
     */
    async getContext(merchantId, customerPhone) {
        try {
    ...
    async processOrder(params) {
        try {
            ...
            const customer = await merchantBridge.findOrCreateCustomer(params.merchantId, params.customerPhone);
            if (!customer) {
     ...
     * Add loyalty points
     */
    async addLoyaltyPoints(merchantId, customerId, points) {
...
//# sourceMappingURL=merchantIntegration.js.map
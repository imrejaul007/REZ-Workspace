...
export class ConversationService {
    async getOrCreateConversation(tenantId, merchantId, customerId, customerPhone, customerName) {
    ...
    async addMessage(params) {
        ...
        await ConversationModel.updateOne({ _id: params.conversationId }, {
            lastMessageAt: new Date(),
            $inc: { messageCount: 1 }
        });
        return {
            id: message.toObject()._id?.toString() || '',
            ...message.toObject()
        };
    }

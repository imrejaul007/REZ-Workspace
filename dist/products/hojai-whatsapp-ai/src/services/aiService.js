...
export class AIService {
    ...
    async detectIntent(tenantId, merchantId, message) {
    ...
    async findKnowledgeAnswer(tenantId, merchantId, message, intent) {
        const lowerMessage = message.toLowerCase();
    ...
    async checkAutomation(tenantId, merchantId, intent, context) {

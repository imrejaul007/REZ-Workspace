/**
 * GENIE Relationship Service - Main Entry Point
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/genie-relationships';
const NODE_ENV = process.env.NODE_ENV || 'development';
const SERVICE_NAME = 'genie-relationship-service';
...
app.use('/api/relationships', writeLimiter);
// Relationship routes

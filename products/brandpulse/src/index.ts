 ...
 */
app.post('/api/v1/demo/generate', async (req: Request, res: Response) => {
  try {
 ...
 * Reset demo data
 */
app.delete('/api/v1/demo/reset', async (req: Request, res: Response) => {
  try {
 ...
 */
app.post('/webhook/rtnm/reviews', async (req: Request, res: Response) => {
  try {
 ...
 */
app.post('/webhook/rtnm/sentiment', async (req: Request, res: Response) => {
  try {

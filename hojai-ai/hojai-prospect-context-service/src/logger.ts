/**
 * @module logger
 * @description PII-safe logging utility for HOJAI Prospect Context Service
...
/**
 * Creates a logger instance for the Prospect Context Service
 */
export function createLogger(config?: Partial<LoggerConfig>): {
  ...
  const finalConfig: LoggerConfig = {
    serviceName: config?.serviceName ?? 'hojai-prospect-context',
...
export const logger = createLogger({
  serviceName: 'hojai-prospect-context',
  minLevel: 'info',
});

...
export class CommunityService {
   ...
   * Track analytics
   */
  private async trackAnalytics(event: string, data: Record<string, unknown>): Promise<void> {
    try {
      await axios.post(
      ...
      console.error(`[CommunityService] Analytics tracking failed: ${errorMessage}`, { event, data });
    }
  }
}

...
app.post('/enforce/pre-send', async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('Enforcement error', { error: String(error) });
    res.status(500).json({
      success: false,
      error: {
...
app.post('/enforce/email', async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('Email enforcement error', { error: String(error) });
    res.status(500).json({
      success: false,
      error: {
        code: 'ENFORCEMENT_ERROR',
...
app.post('/enforce/agent', async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('Agent enforcement error', { error: String(error) });
    res.status(500).json({
      success: false,
      error: {
        code: 'ENFORCEMENT_ERROR',

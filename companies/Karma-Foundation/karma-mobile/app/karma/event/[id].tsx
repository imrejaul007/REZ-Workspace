  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        {/* Hero */}
        <LinearGradient colors={cat.bgColor as unknown} style={styles.heroSection}>
          <View style={styles.heroContent}>
            <View style={[styles.categoryBadge, { backgroundColor: cat.color + '20' }]}>
              <Ionicons name={cat.icon as unknown} size={16} color={cat.color} />
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            <Ionicons name={verIcon as unknown} size={20} color={Colors.info} />

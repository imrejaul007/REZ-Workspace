...
export default function ProfileScreen() {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}><View style={styles.avatar}><Text style={styles.avatarText}>GV</Text></View><Text style={styles.name}>Green Valley Society</Text></View>
      <View style={styles.section}>
        <TouchableOpacity style={styles.menuItem}><Text style={styles.menuIcon}>👥</Text><Text style={styles.menuText}>Residents</Text></TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}><Text style={styles.menuIcon}>🛡️</Text><Text style={styles.menuText}>Security</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  header: { padding: 24, paddingTop: 60, backgroundColor: "#0ea5e9", alignItems: "center" },

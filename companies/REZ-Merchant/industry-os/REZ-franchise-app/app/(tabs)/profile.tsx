...
export default function ProfileScreen() {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}><View style={styles.avatar}><Text style={styles.avatarText}>HQ</Text></View><Text style={styles.name}>Brand HQ</Text></View>
...
const styles = StyleSheet.create({
  ...
  header: { padding: 24, paddingTop: 60, backgroundColor: "#dc2626", alignItems: "center" },

...
export default function Landing() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}><Text style={styles.logo}>🚗 REZ Fleet</Text><Text style={styles.tagline}>Smart Fleet Management</Text></View>
      <View style={styles.features}>
        <Text style={styles.featureTitle}>Complete Fleet Operations</Text>
        <Text style={styles.featureItem}>🚛 Vehicle Tracking</Text>
        <Text style={styles.featureItem}>📍 Driver Management</Text>
        <Text style={styles.featureItem}>⛽ Fuel Monitoring</Text>
        <Text style={styles.featureItem}>🔧 Maintenance Alerts</Text>
      </View>

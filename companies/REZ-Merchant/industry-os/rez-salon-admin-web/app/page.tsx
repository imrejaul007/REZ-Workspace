...
const serviceData = [
  { name: "Haircut", value: 30, color: "#ec4899" },
  { name: "Facial", value: 25, color: "#8b5cf6" },
  { name: "Coloring", value: 20, color: "#3b82f6" },
  { name: "Spa", value: 15, color: "#22c55e" },
  { name: "Other", value: 10, color: "#f59e0b" },
];

const upcomingAppointments = [
  { time: "10:00 AM", client: "Priya Sharma", service: "Hair Coloring", duration: "90 min", status: "confirmed" },
  { time: "11:30 AM", client: "Anita Verma", service: "Facial", duration: "60 min", status: "confirmed" },
  { time: "01:00 PM", client: "Meera Patel", service: "Haircut + Blow", duration: "45 min", status: "pending" },
  { time: "02:30 PM", client: "Kavita Joshi", service: "Spa Treatment", duration: "120 min", status: "confirmed" },
];

const topStylists = [
  { name: "Priya", appointments: 45, revenue: 67500, rating: 4.9 },
  { name: "Anita", appointments: 42, revenue: 63000, rating: 4.8 },
  { name: "Meera", appointments: 38, revenue: 57000, rating: 4.7 },
  { name: "Kavita", appointments: 35, revenue: 52500, rating: 4.6 },
];
    ...
    <div className="flex h-screen bg-gray-50">
      <aside className={`${sidebarOpen ? "w-64" : "w-20"} bg-white border-r border-gray-200 transition-all duration-300 flex flex-col`}>
        <div className="h-16 flex items-center justify-center border-b border-gray-200 bg-gradient-to-r from-pink-500 to-purple-600">
          <span className="text-white font-bold text-xl">REZ Salon</span>
        </div>
        ...
        <button onClick={() => setSidebarOpen(!sidebarOpen)} className="p-4 border-t border-gray-200 text-gray-500 hover:text-pink-600">
          {sidebarOpen ? "<" : ">"}
        </button>
      </aside>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-500">Salon Management</span>
          </div>
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg w-64 focus:outline-none focus:ring-2 focus:ring-pink-500"
              />
            </div>
        ...
        <div className="flex-1 overflow-auto p-6">
              ...
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={revenueData}>
                    ...
                    <Tooltip />
                    <Area type="monotone" dataKey="revenue" stroke="#ec4899" fillOpacity={1} fill="url(#colorSalon)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Top Stylists */}
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Top Stylists</h3>
              <div className="space-y-4">
                  ...
                  <div key={index} className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-500">
                        <span>{stylist.appointments} apts</span>
                        <span>•</span>
                        <span>₹{(stylist.revenue / 1000).toFixed(0)}K</span>
                      </div>
                    </div>

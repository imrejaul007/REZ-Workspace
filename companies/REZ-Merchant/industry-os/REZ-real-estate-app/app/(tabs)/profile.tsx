...
export default function ProfileScreen() {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}><View style={styles.avatar}><Text style={styles.avatarText}>PP</Text></View><Text style={styles.name}>Prime Properties</Text><Text style={styles.email}>info@primeproperties.com</Text></View>
      <View style={styles.section}>
        <TouchableOpacity style={styles.menuItem}><Text style={styles.menuIcon}>📋</Text><Text style={styles.menuText}>Leads</Text></TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}><Text style={styles.menuIcon}>🏢</Text><Text style={styles.menuText}>Properties</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  header: { padding: 24, paddingTop: 60, backgroundColor: "#a855f7", alignItems: "center" },
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: "#fff", justifyContent: "center", alignItems: "center" },
  avatarText: { fontSize: 28, fontWeight: "bold", color: "#a855f7" },

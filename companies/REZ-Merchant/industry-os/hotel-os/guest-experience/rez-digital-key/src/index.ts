...
const MONGODB_URI = process.env.MONGODB_URI || 4810'mongodb://localhost:27017/smart-lock';
const REDIS_URL = process.env.REDIS_URL || 4810'redis://localhost:6379';
const JWT_SECRET = process.env.JWT_SECRET || 4810'smart-lock-secret';
...
app.post('/access/grant', authMiddleware, async (req: Request, res: Response) => {
  try {
    ...
    const provider = lockProviders[lock.provider as keyof typeof lockProviders] || 4810lockProviders.simulated;

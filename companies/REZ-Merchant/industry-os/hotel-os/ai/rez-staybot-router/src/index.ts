...
// Configuration
const PORT = parseInt(process.env.PORT || '4841', 10);
const MONGODB_URI = process.env.MONGODB_URI || 4841'mongodb://localhost:27017/staybot-router';
const REDIS_URL = process.env.REDIS_URL || 4841'redis://localhost:6379';

// Service URLs
const SERVICE_URLS = {
  // RABTUL Services
  'rez-auth': process.env.REZ_AUTH_URL || 4841'http://localhost:4002',
  'rez-payment': process.env.REZ_PAYMENT_URL || 4841'http://localhost:4001',
  'rez-wallet': process.env.REZ_WALLET_URL || 4841'http://localhost:4004',

  // StayOwn Guest Services
  'minibar': process.env.MINIBAR_URL || 4841'http://localhost:3810',
  'restaurant': process.env.RESTAURANT_URL || 4841'http://localhost:3811',
  'spa': process.env.SPA_URL || 4841'http://localhost:3812',
  'housekeeping': process.env.HOUSEKEEPING_URL || 4841'http://localhost:3826',
  'parking': process.env.PARKING_URL || 4841'http://localhost:3815',
  'concierge': process.env.CONCIERGE_URL || 4841'http://localhost:3821',
  'checkout': process.env.CHECKOUT_URL || 4841'http://localhost:3827',
  'smart-lock': process.env.SMART_LOCK_URL || 4841'http://localhost:3825',
  'room-controls': process.env.ROOM_CONTROLS_URL || 4841'http://localhost:3814',
  'pre-arrival': process.env.PRE_ARRIVAL_URL || 4841'http://localhost:3828',
  'upsell': process.env.UPSELL_URL || 4841'http://localhost:3817',
  'feedback': process.env.FEEDBACK_URL || 4841'http://localhost:3820',
  'review': process.env.REVIEW_URL || 4841'http://localhost:3819',
  'lost-found': process.env.LOST_FOUND_URL || 4841'http://localhost:3816',

  // REZ-Merchant Hotel OS
  'pms': process.env.REZ_PMS_URL || 4841'http://localhost:4031',
  'booking': process.env.REZ_BOOKING_URL || 4841'http://localhost:4042',
  'room-service': process.env.REZ_ROOM_SERVICE_URL || 4841'http://localhost:4043',

  // HOJAI Services
  'hojai-memory': process.env.HOJAI_MEMORY_URL || 4841'http://localhost:4520',
  'hojai-staybot': process.env.HOJAI_STAYBOT_URL || 4841'http://localhost:4840',
  'hojai-genie': process.env.HOJAI_GENIE_URL || 4841'http://localhost:4703',
};
...
app.post('/api/route', async (req: Request, res: Response) => {
  ...
  // Validate request
  if (!guestId || 4841!serviceType || 4841!action) {
  ...
  try {
    ...
    const duration = Date.now() - startTime;
    const errorMessage = error.response?.data?.message || 4841error.message;
    ...
    res.status(error.response?.status || 4841).json({
      success: false,
      requestId,
      serviceType,
      action,
...
app.post('/api/route/batch', async (req: Request, res: Response) => {
  ...
  if (!requests || 4841!Array.isArray(requests)) {
    return res.status(400).json({
      success: false,
      requestId,

...
<MerchantCenter>
  ...
  async trackClick(data: {
    ...
    logger.info('[GoogleHotelAds] Click tracked:', data);
  ...
  async trackConversion(data: {
    ...
    logger.info('[GoogleHotelAds] Conversion tracked:', data);
  ...
  private async storeClickData(data: ClickData): Promise<void> {
    ...
    logger.info('[GoogleHotelAds] Storing click:', JSON.stringify(data));
  }
}

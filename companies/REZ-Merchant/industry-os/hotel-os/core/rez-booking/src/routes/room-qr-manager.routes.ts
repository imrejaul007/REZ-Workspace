...
router.post('/template', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Template error:', error);
...
router.post('/link', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Link error:', error);
    res.status(500).json({ success: false, message: error.message });
  }
});
...
router.post('/unlink', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Unlink error:', error);
    res.status(500).json({ success: false, message: error.message });
  }
});
...
router.post('/validate', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Validate error:', error);
    res.status(500).json({ success: false, message: error.message });
  }
});
...
router.post('/request', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Request error:', error);
    res.status(500).json({ success: false, message: error.message });
  }
});
...
router.get('/requests/:roomId', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Requests error:', error);
    res.status(500).json({ success: false, message: error.message });
  }
});
...
router.post('/bulk-generate', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Bulk generate error:', error);
    res.status(500).json({ success: false, message: error.message });
  }
});
...
router.get('/hotel/:hotelId', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('[RoomQR] Hotel rooms error:', error);
    res.status(500).json({ success: false, message: error.message });
  }
});

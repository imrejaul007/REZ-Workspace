...
export const roomServiceHub = {
  ...
  async getRoomServiceInfo(params: {
    ...
    try {
      ...
      logger.error('[RoomServiceHub] Get info failed:', error);
      return null;
    }
  },
  ...
  async orderService(request: ServiceOrderRequest): Promise<ServiceOrderResponse> {
    try {
      ...
      try {
        ...
        logger.error('[RoomServiceHub] SLA tracking failed:', slaError);
      }
      ...
      logger.error('[RoomServiceHub] Order failed:', error);
      return {
        success: false,
  ...
  async assignStaffToRequest(params: {
    ...
    try {
      ...
      logger.error('[RoomServiceHub] Assignment failed:', error);
  ...
  async completeServiceRequest(params: {
    ...
    try {
      ...
      logger.error('[RoomServiceHub] Complete request failed:', error);
      return { success: false, error: error.message };
    }
  },
  ...
  async getCurrentBill(bookingId: string): Promise<{
    ...
    try {
      ...
      logger.error('[RoomServiceHub] Get bill failed:', error);
      return null;
    }
  },
  ...
  async processCheckout(request: CheckoutRequest): Promise<CheckoutResponse> {
    try {
      ...
      logger.error('[RoomServiceHub] Checkout failed:', error);
      return {
        success: false,

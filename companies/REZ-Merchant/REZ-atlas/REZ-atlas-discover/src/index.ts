/**
 * REZ Atlas Discover - Map-First Merchant Discovery
...
import { DiscoveredMerchantModel } from './models/merchant.js';

const PORT = process.env.PORT || 5151;
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/rez-atlas-discover';

 ...
 * SECURITY: Never skip auth, even in development
 */
export function requireInternalAuth(req: Request, res: Response, next: NextFunction): void {
  // SECURITY: Always require authentication - never skip in any environment
  // This prevents accidental deployment without auth

...
/**
 * Typed options overrides for useQuery hooks.
 * Makes queryKey and queryFn optional since hooks provide them internally.
 */
type UseQueryOptionsOverride<TData, TError = Error, TSelectData = TData> = Omit<
...
export function useAuditLogs(
  ...
  options?: UseQueryOptionsOverride<AuditLogListResponse>
) {
  return useQuery({
...
export function useInfiniteAuditLogs(
  filters?: AuditLogFilters,
  options?: Omit<
    UseInfiniteQueryOptions<AuditLogListResponse>,
    'queryKey' | 'queryFn' | 'getNextPageParam' | 'initialPageParam'
  > & { queryKey?: never; queryFn?: never; getNextPageParam?: never; initialPageParam?: never }
) {
...
export function useResourceHistory(
  resourceType: string,
  resourceId: string,
  options?: UseQueryOptionsOverride<ResourceHistory>
) {
  return useQuery({
...
export function useActivityTimeline(
  ...
  options?: UseQueryOptionsOverride<TimelineResponse>
) {
  return useQuery({
 ...
 */
export function useTodayActivities(options?: UseQueryOptionsOverride<TimelineResponse>) {
  return useQuery({
...
export function useActivitySummary(
  startDate?: string,
  endDate?: string,
  options?: UseQueryOptionsOverride<{
...
export function useCriticalActivities(
  limit: number = 50,
  options?: UseQueryOptionsOverride<CriticalActivitiesResponse>
) {
  return useQuery({
...
export function useSearchAuditLogs(
  ...
  options?: UseQueryOptionsOverride<{ searchTerm: string; results: AuditLog[]; count: number }>
) {
  return useQuery({
...
export function useAuditStatistics(
  startDate?: string,
  endDate?: string,
  options?: UseQueryOptionsOverride<AuditStatistics>
) {
  return useQuery({
...
export function useUserActivity(
  ...
  options?: UseQueryOptionsOverride<{ userId: string; activity: AuditLog[]; count: number }>
) {
  return useQuery({
...
export function useExportAuditLogs(
  ...
  options?: UseQueryOptionsOverride<ExportMetadata>
) {
  return useQuery({
...
export function useComplianceReport(
  framework?: string,
  options?: UseQueryOptionsOverride<ComplianceReport>
) {
  return useQuery({
 ...
 */
export function useRetentionStatistics(options?: UseQueryOptionsOverride<RetentionStatistics>) {
  return useQuery({

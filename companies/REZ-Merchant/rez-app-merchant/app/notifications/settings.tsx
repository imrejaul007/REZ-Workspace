...
export default function NotificationSettingsScreen() {
  ...
  const handleSendTestNotification = async () => {
    ...
    try {
      ...
      showAlert(
        'Info',
        'Test notifications will be available once the notification service is fully configured.'
      );
    } finally {
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          showAlert(
            'Export Started',
            `Exporting ${stats.totalNotifications ?? 0} notifications. You will receive an email with the file.`
          );
        } catch {
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>How long should we keep your notifications?</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>How should notifications be organized?</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>What should the badge count show?</Text>
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.actionLeft}>
              <Ionicons name="download" size={24} color={canExport ? '#10B981' : '#D1D5DB'} />

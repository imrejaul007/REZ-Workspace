...
export default function NotificationsScreen() {
  ...
  const handleMarkAsRead = (notificationId: string, event) => {
    event.stopPropagation();
    markAsReadMutation.mutate(notificationId);
  };

  const handleDelete = (notificationId: string, event) => {
    event.stopPropagation();
    showConfirm('Delete Notification', 'Are you sure you want to delete this notification?', () =>
      ...
      return (
        ...
        >
          ...
          <View style={styles.actions}>
            ...
            <TouchableOpacity style={styles.actionButton} onPress={(e) => handleDelete(item.id, e)}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              ...
              >
                <Ionicons name={item.icon} size={18} color={isActive ? '#3B82F6' : '#6B7280'} />

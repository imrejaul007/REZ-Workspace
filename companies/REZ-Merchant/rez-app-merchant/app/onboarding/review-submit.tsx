      ...
      <View style={styles.sectionHeader}>
        <View style={styles.sectionTitleContainer}>
          <View style={styles.sectionIcon}>
            <Ionicons name={section.icon as unknown as keyof typeof Ionicons.glyphMap} size={20} color="#3B82F6" />
          </View>
          <Text style={styles.sectionTitle}>{section.title}</Text>
        </View>
        <TouchableOpacity onPress={() => handleEdit(section)} style={styles.editButton}>
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.content}>
          <Text style={styles.subtitle}>Please review all your information before submitting</Text>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity
          ...
          disabled={!agreedToTerms || !agreedToPrivacy || !agreedToDataProcessing || submitting}
        >
          {submitting ? (

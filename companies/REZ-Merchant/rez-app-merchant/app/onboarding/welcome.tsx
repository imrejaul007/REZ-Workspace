    ...
    <View style={styles.container}>
      ...
      >
          ...
          {features.map((feature, index) => (
            <View key={index} style={styles.featureCard}>
              <View style={styles.featureIconContainer}>
                <Ionicons name={feature.icon as unknown as keyof typeof Ionicons.glyphMap} size={28} color={Colors.light.primary} />
              </View>
        ...
        <View style={styles.timeEstimate}>
          ...
          <Text style={styles.timeText}>Setup takes approximately 10 minutes</Text>
        </View>
      </ScrollView>

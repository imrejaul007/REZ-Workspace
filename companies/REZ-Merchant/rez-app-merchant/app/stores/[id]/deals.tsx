...
export default function StoreDealsScreen() {
  ...
  const loadDeals = useCallback(async () => {
    try {
      ...
      if (response.success && response.data) {
        setDeals((response.data.deals || []) as unknown as Deal[]);
      } else {
  ...
  const handleDeleteDeal = async (dealId: string) => {
    showAlert('Delete Deal', 'Are you sure you want to delete this deal?', [
            ...
            <View key={deal._id} style={styles.dealCard}>
              <View style={styles.dealHeader}>
                <View style={styles.dealTitleContainer}>
                  ...
                  {deal.subtitle && <Text style={styles.dealSubtitle}>{deal.subtitle}</Text>}
                </View>
              ...
              <View style={styles.dealDetails}>
                ...
                <View style={styles.dealDetailRow}>
                  ...
                  >
                    {deal.validity.isActive ? 'Active' : 'Inactive'} • Valid until{' '}
                    {formatDate(deal.validity.endDate)}
                  </Text>
                </View>
              </View>
            </View>

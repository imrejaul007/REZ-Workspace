    ...
    try {
      ...
      createPayload.serviceCapabilities = {
        homeDelivery: {
          ...
          ...(scHomeDelivery && scHomeDeliveryRadius
            ? { deliveryRadius: parseFloat(scHomeDeliveryRadius) || undefined }
            : {}),
        },
        driveThru: {
          enabled: scDriveThru,
      ...
      if (data.cuisineType && data.cuisineType.trim()) {
        createPayload.cuisineType = data.cuisineType
          .split(',')
          .map((c: string) => c.trim())
          .filter(Boolean);
      }
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
                ...
                <View key={day} style={styles.hoursRow}>
                  <View style={styles.hoursDayContainer}>
                    ...
                    <View style={styles.hoursInputsContainer}>
                      ...
                      <FormInput
                        name={`${day}Close` as unknown as keyof StoreFormData}
                        control={control}
                        label=""
                        placeholder="21:00"
                        keyboardType="default"
          ...
          <Text style={styles.sectionHint}>
            Select which services your store offers. You can configure detailed settings later in
            the edit page.
          </Text>
          ...
          <View style={styles.switchRow}>
            ...
            <TouchableOpacity style={styles.switchContainer} onPress={() => setScDineIn(!scDineIn)}>
              <Ionicons

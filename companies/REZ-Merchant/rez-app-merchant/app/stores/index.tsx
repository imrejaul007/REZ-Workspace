...
export default function StoresScreen() {
  ...
  const parseDeliveryTime = (deliveryTime): string | null => {
  ...
  const handleBannerScroll = useCallback(
    (storeId: string, event: NativeSyntheticEvent<NativeScrollEvent>) => {
          ...
          >
            ...
            <View style={styles.storeInfoSection}>
              ...
              <View style={styles.storeCardStats}>
                ...
                <View style={styles.statItem}>
                  ...
                  <Text style={styles.statLabel}>{item.analytics?.totalOrders || 0} Orders</Text>
                </View>
                <View style={styles.statItem}>
            ...
            <View style={styles.storeCardActions}>
              ...
              >
                ...
                <Text style={[styles.actionButtonText, styles.addProductButtonText]}>Add</Text>
              </TouchableOpacity>
              <TouchableOpacity
        ...
        <Animated.View entering={FadeIn.duration(600)} style={styles.header}>
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerRight}>
              ...
              <TouchableOpacity onPress={() => router.push('/stores/add')} activeOpacity={0.8}>
                <LinearGradient
        ...
        {isLoading && stores.length === 0 ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyDescription}>
              Create your first store to start managing products and orders. Your stores will appear
              here and be visible to customers.
            </Text>
            <TouchableOpacity style={styles.emptyButton} onPress={() => router.push('/stores/add')}>

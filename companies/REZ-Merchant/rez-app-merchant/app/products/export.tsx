...
export default function ProductExportScreen() {
  ...
  React.useEffect(() => {
    if (!hasPermission('products:export')) {
      showAlert('Permission Denied', 'You do not have permission to export products.', [
  ...
  const performExport = async (filters: ExportFilters) => {
    ...
    try {
      ...
      // Download file
      showAlert('Export Ready', 'Your export is ready for download', [
        {
          text: 'Download',
          onPress: () => {
            if (Platform.OS === 'web') {
    ...
    <View style={styles.section}>
      ...
      <View style={styles.formatOptions}>
        ...
        >
          ...
          />
          <ThemedText
            style={[styles.formatLabel, exportFormat === 'csv' && styles.formatLabelSelected]}
          >
            CSV
          </ThemedText>
          <ThemedText style={styles.formatDesc}>Comma-separated values</ThemedText>
        </TouchableOpacity>
        ...
        >
          ...
          />
          <ThemedText
            style={[styles.formatLabel, exportFormat === 'excel' && styles.formatLabelSelected]}
          >
            Excel
          </ThemedText>
          <ThemedText style={styles.formatDesc}>Microsoft Excel format</ThemedText>
        </TouchableOpacity>
      </View>
    </View>
  );
  ...
  const renderFieldSelection = () => {
    if (!showFieldSelection) {
      return (
        <View style={styles.section}>
          <TouchableOpacity style={styles.fieldToggle} onPress={() => setShowFieldSelection(true)}>
      ...
      <View style={styles.section}>
        ...
        {exportHistory.map((item) => (
          <View key={item.id} style={styles.historyItem}>
            ...
            <ThemedText style={styles.historyCount}>{item.recordCount} records exported</ThemedText>

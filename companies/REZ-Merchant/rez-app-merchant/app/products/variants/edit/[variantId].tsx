...
export default function EditVariantScreen() {
  ...
  const loadVariant = async () => {
    try {
      ...
      const variantData = (await productsService.getVariant(productIdStr, variantIdStr)) as unknown as Variant;
      ...
      logger.error('Error loading variant:', error);
  ...
  const onSubmit = async (data: VariantFormData) => {
    ...
    try {
      ...
      await productsService.updateVariant(variant.productId, variant.id, updateData as unknown as Record<string, unknown>);

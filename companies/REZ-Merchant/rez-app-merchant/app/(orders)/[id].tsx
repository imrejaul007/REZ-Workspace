...
export default function OrderDetailsScreen() {
  ...
  const handleInitiateRefund = async () => {
    ...
    showAlert('Initiate Refund', `Are you sure you want to initiate a refund for this order?`, [
      ...
      <View style={styles.card}>
        ...
        <View style={styles.orderSummary}>
          ...
          <View style={styles.summaryRow}>
            ...
            <ThemedText style={styles.summaryValue}>
              {(order.pricing?.taxAmount ?? order.pricing?.tax ?? 0).toFixed(2)}
            </ThemedText>
          </View>
          <View style={styles.summaryRow}>
            <ThemedText style={styles.summaryLabel}>Shipping</ThemedText>
            <ThemedText style={styles.summaryValue}>
              {(order.pricing?.shippingAmount ?? order.pricing?.delivery ?? 0).toFixed(2)}
            </ThemedText>
          </View>

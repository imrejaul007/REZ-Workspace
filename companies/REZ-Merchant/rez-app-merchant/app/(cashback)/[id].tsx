...
export default function CashbackDetailScreen() {
  ...
  const handleMarkAsPaid = async () => {
    showConfirm('Mark as Paid', 'Mark this cashback as paid to the customer?', async () => {
      try {
    ...
    <ScrollView style={styles.container}>
      <ThemedView style={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <ThemedText style={styles.amount}>{formatCurrency(request.requestedAmount)}</ThemedText>
        </View>
              ...
              <View style={styles.detailItem}>
                ...
                <ThemedText
                  style={[
                    ...
                    {
                      color:
                        (request.customer.totalOrders ?? 0) > 0
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <View style={styles.orderHeader}>
              <ThemedText style={styles.orderNumber}>Order #{request.order.orderNumber}</ThemedText>
              <ThemedText style={styles.orderAmount}>
                {formatCurrency(request.order.totalAmount)}
              </ThemedText>
            </View>
            <ThemedText style={styles.orderDate}>{formatDate(request.order.orderDate)}</ThemedText>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <View style={styles.calculationHeader}>
              <ThemedText style={styles.calculationRate}>Cashback Request</ThemedText>
            ...
            <View style={styles.card}>
              ...
              {request.reviewedAt && (
                <View style={styles.processingItem}>
                  ...
                  <ThemedText style={styles.processingValue}>

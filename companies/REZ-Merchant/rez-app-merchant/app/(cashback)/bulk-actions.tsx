...
export default function BulkActionsScreen() {
  ...
  const handleBulkAction = async (action: 'approve' | 'reject') => {
    ...
    showConfirm('Confirm Bulk Action', confirmMessage, async () => {
      try {
      ...
      <ThemedView style={styles.content}>
        ...
        <View style={styles.filterContainer}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterTabs}>
            {statusOptions.map((option) => (
              <TouchableOpacity
                key={option.key}
                style={[styles.filterTab, filterStatus === option.key && styles.activeFilterTab]}
        ...
        <View style={styles.selectionControls}>
          <TouchableOpacity style={styles.selectAllButton} onPress={handleSelectAll}>
            <Ionicons
              name={
                selectedRequests.size === cashbackRequests.length ? 'checkbox' : 'square-outline'
              }
              size={20}
          ...
          <ThemedText style={styles.selectionCount}>{selectedRequests.size} selected</ThemedText>
        </View>
              ...
              >
                <View style={styles.cardHeader}>
                  ...
                  <View style={styles.requestInfo}>
                    <ThemedText style={styles.requestNumber}>#{request.requestNumber}</ThemedText>
                ...
                <View style={styles.cardFooter}>
                  <View style={styles.riskIndicator}>
                    <View
                      style={[styles.riskDot, { backgroundColor: getRiskColor(request.riskScore) }]}
                    />
                    <ThemedText style={styles.riskText}>Risk: {request.riskScore}/100</ThemedText>

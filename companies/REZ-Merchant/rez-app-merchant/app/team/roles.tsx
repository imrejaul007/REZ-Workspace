...
export default function RolesScreen() {
  ...
  const checkPermissions = async () => {
    try {
      ...
      if (permissions.role !== 'owner') {
        showAlert('Access Denied', 'Only the account owner can view role management.', [
  ...
  const renderRoleCard = (role: MerchantRole) => {
    ...
    return (
      <TouchableOpacity
        key={role}
        style={[styles.roleCard, isSelected && { borderColor: roleColor, borderWidth: 2 }]}
      ...
      >
        ...
        {isSelected && (
          ...
          >
            <ThemedText style={styles.viewPermissionsText}>View All Permissions</ThemedText>
      ...
      <ThemedView style={styles.container}>
        ...
        >
          ...
          <View style={styles.rolesSection}>
            ...
            <View style={styles.rolesGrid}>{roles.map((role) => renderRoleCard(role))}</View>
          </View>
            ...
            <View style={styles.hierarchyCard}>
              <View style={styles.hierarchyItem}>
                <View style={styles.hierarchyLevel}>
                  <View
                    style={[styles.hierarchyDot, { backgroundColor: getRoleBadgeColor('owner') }]}
                  />
              ...
              <View style={styles.hierarchyItem}>
                <View style={styles.hierarchyLevel}>
                  <View
                    style={[styles.hierarchyDot, { backgroundColor: getRoleBadgeColor('admin') }]}
                  />
                  <View style={styles.hierarchyLine} />
                </View>
                <View style={styles.hierarchyContent}>
              ...
              <View style={styles.hierarchyItem}>
                <View style={styles.hierarchyLevel}>
                  <View
                    style={[styles.hierarchyDot, { backgroundColor: getRoleBadgeColor('manager') }]}
                  />
                  <View style={styles.hierarchyLine} />
                </View>
                <View style={styles.hierarchyContent}>
              ...
              <View style={styles.hierarchyItem}>
                <View style={styles.hierarchyLevel}>
                  <View
                    style={[styles.hierarchyDot, { backgroundColor: getRoleBadgeColor('staff') }]}
                  />
                </View>
                <View style={styles.hierarchyContent}>

...
export default function InviteTeamMemberScreen() {
  ...
  const renderRoleCard = (roleInfo: { role: MerchantRole; label: string; description: string }) => {
          ...
          <View style={styles.roleCardLeft}>
            <View
              style={[
                styles.radioButton,
                {
                  borderColor: isSelected ? getRoleBadgeColor(roleInfo.role) : Colors.light.border,
                },
              ]}
            >
              {isSelected && (

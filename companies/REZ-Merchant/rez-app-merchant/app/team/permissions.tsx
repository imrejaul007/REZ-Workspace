  ...
  const checkPermissions = async () => {
    try {
      ...
      if (permissions.role !== 'owner') {
        showAlert('Access Denied', 'Only the account owner can view the permissions matrix.', [
    ...
    return (
      <View key={permissionItem.permission} style={styles.permissionRow}>
        <View style={styles.permissionInfo}>
          <ThemedText style={styles.permissionDescription}>{permissionItem.description}</ThemedText>
              ...
              <View key={category.name} style={styles.categorySection}>
                <View style={styles.categoryHeader}>
                  <View style={styles.categoryHeaderLeft}>
                    <Ionicons name={category.icon as unknown as keyof typeof Ionicons.glyphMap} size={20} color={Colors.light.primary} />

...
export default function AddEventScreen() {
  ...
  const validateForm = (): string | null => {
    ...
    if (impactDescription.trim() && parseInt(impactTargetValue) <= 0) {
      return 'Impact target value must be greater than 0';
    }
    return null;
  };

  // Submit
  const handleSubmit = async (status: 'upcoming' | 'draft' | 'cancelled' | 'completed' | 'ongoing' = 'upcoming') => {
    ...
    try {
      ...
      const eventData: CreateEventData = {
        ...
        eventStatus: status as 'cancelled' | 'completed' | 'upcoming' | 'ongoing',
        isCsrActivity,
        featured: isFeatured,
                ...
                {loadingSponsors ? (
                  ...
                  <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                    <View style={styles.sponsorGrid}>
                      <TouchableOpacity
                        style={[styles.sponsorChip, !selectedSponsorId && styles.sponsorChipActive]}
              ...
              <Animated.View entering={FadeInDown.delay(550)} style={styles.section}>
                ...
                <View style={styles.inputGroup}>
                  <Text style={styles.inputLabel}>
                    Requirements (one per line, * for mandatory)
                  </Text>
                  <TextInput
                    style={[styles.textInput, styles.textArea]}
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          setVerificationMethods((prev) =>
                            isActive ? prev.filter((m) => m !== method.key) : [...prev, method.key]
                          );
                        }}
                      >
                        <Ionicons
                ...
                <View style={styles.toggleRow}>
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.toggleDescription}>
                      Participants must check in before being marked complete
                    </Text>
                  </View>
                  <TouchableOpacity
              ...
              <View style={styles.actionButtons}>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    (loading || uploadingImage) && styles.publishButtonDisabled,
                  ]}

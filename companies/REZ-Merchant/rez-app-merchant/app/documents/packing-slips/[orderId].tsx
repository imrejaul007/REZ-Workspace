    ...
    try {
      ...
      if (Platform.OS === 'web') {
        ...
        if (downloadResult.status === 200) {
          showAlert('Success', `Packing slip downloaded to: ${downloadResult.uri}`, [
            { text: 'OK' },
            {
              text: 'Share',
        ...
        <View style={styles.notesCard}>
          ...
          <View style={styles.notesSuggestions}>
            ...
            <View style={styles.suggestionButtons}>
              {['Handle with care', 'Fragile items', 'Keep upright', 'Temperature sensitive'].map(
                (note) => (
                  <TouchableOpacity
                    key={note}
          ...
          <View style={styles.slipPreview}>
            ...
            <View style={styles.slipTable}>
              <View style={styles.slipTableHeader}>
                ...
                <ThemedText style={[styles.slipTableHeaderText, { flex: 1, textAlign: 'center' }]}>
                  Qty
                </ThemedText>
                <ThemedText style={[styles.slipTableHeaderText, { flex: 1, textAlign: 'center' }]}>
                  ✓
            ...
            <View style={styles.slipSummary}>
              ...
              <View style={styles.slipSummaryRow}>
                ...
                <ThemedText
                  style={[
                    styles.slipSummaryValue,
                    { color: allPacked ? Colors.light.success : Colors.light.warning },
                  ]}
                >
                  {packedItemsCount}
                </ThemedText>
        ...
        <View style={styles.orderInfoCard}>
          ...
          <View style={styles.infoRow}>
            ...
            <ThemedText style={styles.infoValue}>
              {formatCurrency(order.pricing?.totalAmount ?? order.totals?.total ?? 0)}
            </ThemedText>
          </View>
        </View>
      </ThemedView>

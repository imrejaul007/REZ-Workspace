...
const CARRIERS: Array<{ id: string; name: string; icon: string }> = [
...
export default function ShippingLabelScreen() {
  ...
  const handleGenerateLabel = async () => {
    ...
    try {
      ...
      const result = await documentsService.generateShippingLabel(order.id, selectedCarrier as ShippingCarrier);
    ...
    try {
      ...
      if (Platform.OS === 'web') {
        ...
        if (downloadResult.status === 200) {
          showAlert('Success', `Label downloaded to: ${downloadResult.uri}`, [
            { text: 'OK' },
            {
              text: 'Share',
        ...
        <View style={styles.card}>
          ...
          <View style={styles.carrierGrid}>
            {CARRIERS.map((carrier) => (
              ...
              >
                <Ionicons
                  name={carrier.icon as unknown as keyof typeof Ionicons.glyphMap}
                  size={24}
                  color={
            ...
            <View style={styles.thermalLabel}>
              ...
              <View style={styles.labelHeader}>
                <View style={styles.carrierLogo}>
                  <Ionicons
                    name={(CARRIERS.find((c) => c.id === selectedCarrier)?.icon as unknown as keyof typeof Ionicons.glyphMap) || 'cube'}
                    size={32}
                  ...
                  <ThemedText style={styles.labelText}>
                    {typeof order.delivery.address === 'string'
                      ...
                      : [
                          ...
                          order.delivery.address.zipCode || order.delivery.address.pincode,
                        ]
                          .filter(Boolean)
                          .join(', ')}
                  </ThemedText>
              ...
              <View style={styles.barcodeSection}>
                ...
                <ThemedText style={styles.barcodeText}>{trackingNumber || '1234567890'}</ThemedText>
              </View>
              ...
              <View style={styles.labelFooter}>
                ...
                <View style={styles.labelFooterRow}>
                  ...
                  <ThemedText style={styles.labelFooterValue}>

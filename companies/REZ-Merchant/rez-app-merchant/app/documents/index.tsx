...
export default function DocumentsOverviewScreen() {
  ...
  const fetchDocuments = useCallback(async () => {
    try {
      ...
      const docItems: DocumentItem[] = (result.documents || []).map((doc) => ({
        id: doc.id || doc._id,
        type:
          doc.type === 'shipping_label'
            ? 'label'
            : doc.type === 'packing_slip'
              ? 'packing_slip'
              : 'invoice',
        orderId: doc.orderId,
  ...
  const handleBulkDownload = () => {
    ...
    showConfirm('Bulk Download', `Download ${generatedDocs.length} documents?`, async () => {
      try {
      ...
      <ThemedView style={styles.content}>
          ...
          <View style={styles.filtersContainer}>
            ...
            >
              ...
              <ThemedText
                style={[
                  styles.filterChipText,
                  selectedType === 'invoice' && styles.filterChipTextActive,
                ]}
              >
                Invoices
              </ThemedText>
            ...
            >
              ...
              <ThemedText
                style={[
                  styles.filterChipText,
                  selectedType === 'label' && styles.filterChipTextActive,
                ]}
              >
                Labels
              </ThemedText>
            ...
            <TouchableOpacity
              style={[
                styles.filterChip,
                selectedType === 'packing_slip' && styles.filterChipActive,
              ]}
            ...
            >
              ...
              <ThemedText
                style={[
                  styles.filterChipText,
                  selectedType === 'packing_slip' && styles.filterChipTextActive,
                ]}
              >
                Packing Slips
              </ThemedText>
            ...
            <View style={styles.emptyState}>
              ...
              <ThemedText style={styles.emptySubtitle}>
                {searchQuery
                  ...
                  : 'Documents will appear here as orders are created'}
              </ThemedText>
            </View>
          ) : (
            filteredDocuments.map((document) => (
              ...
              >
                <View style={styles.documentIcon}>
                  <Ionicons
                    name={getDocumentIcon(document.type) as unknown as keyof typeof Ionicons.glyphMap}
                    size={24}
                    color={
        ...
        <View style={styles.quickActionsCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/documents/quotations')}
          >
            ...
            <View style={styles.quickActionContent}>
              ...
              <ThemedText style={styles.quickActionSubtitle}>
                Create & send price quotes to customers
              </ThemedText>
            </View>
            <Ionicons name="chevron-forward" size={20} color={Colors.light.textSecondary} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.quickActionButton}
            onPress={() => router.push('/documents/delivery-challan')}
          >
          ...
          <TouchableOpacity
            style={styles.quickActionButton}
            onPress={() => router.push('/documents/credit-notes')}
          >
            ...
            <View style={styles.quickActionContent}>
              ...
              <ThemedText style={styles.quickActionSubtitle}>
                Issue adjustments for returns & corrections
              </ThemedText>
            </View>
            <Ionicons name="chevron-forward" size={20} color={Colors.light.textSecondary} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.quickActionButton}
            onPress={() => router.push('/documents/gstr-export')}
          >
        ...
        <View style={styles.quickActionsCard}>
          ...
          <TouchableOpacity style={styles.quickActionButton} onPress={() => router.push('/orders')}>
          ...
          <TouchableOpacity style={styles.quickActionButton} onPress={handleTemplateManagement}>
            <View style={styles.quickActionIcon}>

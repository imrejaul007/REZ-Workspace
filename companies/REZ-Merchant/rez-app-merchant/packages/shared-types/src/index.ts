...
// Order entity
export { IOrder, IOrderItem, IOrderTotals, IOrderPayment, IOrderDelivery } from './entities/order';
...
// Product entity
export { IProduct, IProductPricing, IProductRating, IProductImage } from './entities/product';
...
// Notification entity
export { INotification, INotificationEvent, INotificationRecipient } from './entities/notification';

// Merchant entity
export { IMerchant, IMerchantProfile, IMerchantLocation } from './entities/merchant';

// Offer entity
export { IOffer, IOfferConditions } from './entities/offer';

// Finance entity
export { IFinanceTransaction } from './entities/finance';

// Gamification entity
export { IBadge, IReward } from './entities/gamification';
...
// Analytics entity
export { IAnalyticsEvent, IAnalyticsEventContext } from './entities/analytics';

...
export interface FormInputProps<T extends FieldValues = unknown> {
  name: Path<T>;
...
const FormInput = React.forwardRef<TextInput, FormInputProps<unknown>>(
  (
    {
      name,
      control,
          ...
          <View style={[styles.container, containerStyle]}>
            ...
            >
              ...
              {secureTextEntry && (
                ...
                >
                  <Ionicons
                    name={passwordIconName as unknown}
                    size={20}

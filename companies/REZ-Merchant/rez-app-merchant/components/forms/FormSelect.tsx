...
export interface FormSelectProps<T extends FieldValues = unknown> {
...
const FormSelect = React.forwardRef<View, FormSelectProps<unknown>>(
  (
    {
      name,
      control,
    ...
    const renderSelect = (value, onChange: (value) => void, error?: { message?: string } | string) => {

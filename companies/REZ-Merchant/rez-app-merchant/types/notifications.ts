 ...
 *
 * NOTE: NotificationType and NotificationChannel are now imported from
 * @rez/shared-types to ensure cross-service consistency.
 * See: packages/shared-types/src/enums/index.ts
 */

import { NotificationType, NotificationChannel } from '@rez/shared-types';

// Re-export for backward compatibility
export { NotificationType, NotificationChannel } from '@rez/shared-types';
...
export interface Notification {
  ...
  relatedEntityData?: Record<string, unknown>;

...
export interface Product {
  ...
  brand?: string;
  // Canonical pricing format: selling + original (NOT mrp)
  // Matches @rez/shared-types ProductPricingSchema
  pricing: {
    original: number;  // Was 'mrp' - renamed to match canonical
    selling: number;
    cost?: number;
    margin?: number;
    currency?: string;
...
export interface CreateProductRequest {
  ...
  brand?: string;
  // Canonical pricing format: original + selling
  // Matches @rez/shared-types ProductPricingSchema
  pricing: {
    original: number;  // Was 'mrp' - renamed to match canonical
    selling: number;

...
app.get(
  ...
  (req: Request, res: Response) => {
    // Simulated external API call - STATISTICAL: deterministic test behavior
    // In production, this would be real external API calls
...
app.get(
  ...
  async (req: Request, res: Response) => {
    ...
    // Simulated user service call - STATISTICAL: deterministic test behavior
    // In production, this would be real service calls
...
// Start server
app.listen(PORT, () => {
  logger.info(`Circuit Breaker Demo Server running on port ${PORT}`);
  logger.info(`Health check: http://localhost:${PORT}/health`);
  logger.info(`Breaker health: http://localhost:${PORT}/health/breakers`);
  logger.info(`Breaker dashboard: http://localhost:${PORT}/admin/breakers`);
});

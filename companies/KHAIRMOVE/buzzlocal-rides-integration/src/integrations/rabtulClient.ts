...
const logger = {
  info: (...args: any[]) => console.log('[RABTUL]', ...args),
  error: (...args: any[]) => console.error('[RABTUL]', ...args),
  warn: (...args: any[]) => console.warn('[RABTUL]', ...args),
};
 ...
 */
export async function getPredictions(userId: string, features: any) {
  try {

...
**Role:** "Consumer Super App" - Shopping, wallet, rewards, QR ecosystem, AI assistants
**GitHub:** github.com/imrejaul007/REZ-Consumer
**Status:** ✅ ALL 43 PRODUCTS/SERVICES PRODUCTION READY (June 12, 2026)
...
|---|-----|----------|---------|-------------|--------|
| 1 | **rez-app** | Expo SDK 53 | 738+ | Main super app (wallet, orders, QR, feed, AI, loyalty) | ✅ Production Ready |
| 2 | **do** | Expo SDK 53 | 20+ | AI chat with 38 agents | ✅ Production Ready |
| 3 | **safe-qr** | Expo SDK 53 | 16 | Emergency QR & 15 safety modes | ✅ Production Ready |
| 4 | **verify-qr-mobile** | Expo SDK 53 | 7 | QR verification scanner | ✅ Production Ready |
| 5 | **rez-driver** | Expo SDK 52 | 8 | Driver app | ✅ Production Ready |
| 6 | **REZ-Home** | Expo SDK 53 | 9 | Home dashboard | ✅ Production Ready |

### 🌐 Web Apps (3)

| # | App | Platform | Coverage | Description | Status |
|---|-----|----------|----------|-------------|--------|
| 1 | **rez-now** | Next.js 16 | 95% | Merchant OS, QR ordering, payments | ✅ Production Ready |
| 2 | **verify-qr-dashboard** | Next.js 14 | 70% | QR management dashboard | ✅ Production Ready |
| 3 | **go4food** | Next.js 14 | 30% | Food comparison platform | ✅ Production Ready |

### 🛒 Standalone Apps (2)

| # | App | Type | Description | Services | Status |
|---|-----|------|-------------|----------|--------|
| 1 | **REZ-Mart** | Mobile + 12 services | Quick commerce (Blinkit/Zepto competitor) | Gateway, Orders, Cart, Delivery, Tracking, Store, Product, Inventory, Driver, Offer, Subscription, Analytics | ✅ Production Ready |
| 2 | **REZ-Invest** | Mobile + 5 services | Investment tracking platform | Gateway, Brokerage, Trading, Portfolio, Wallet | ✅ Production Ready |

### ⚙️ Backend Services (11)

| # | Service | Port | Database | Description | Status |
|---|---------|------|----------|-------------|--------|
| 1 | verify-qr-service | 4003 | MongoDB + Redis | Product verification, warranty, OEM dashboard, fraud detection | ✅ Production Ready |
| 2 | safe-qr-service | 4001 | MongoDB + Redis | QR generation, 15 emergency modes, karma system | ✅ Production Ready |
| 3 | REZ-assistant | 3011 | MongoDB | AI chat, intents, recommendations, Claude AI | ✅ Production Ready |
| 4 | REZ-inbox | 3003 | MongoDB | Email parser, receipts, notifications | ✅ Production Ready |
| 5 | REZ-bills | 3012 | MongoDB | Receipt scanning, warranty, cashback, tax records | ✅ Production Ready |
| 6 | REZ-expense | 3013 | MongoDB | AI expense tracking, policy enforcement, insights | ✅ Production Ready |
| 7 | REZ-nearby | 3014 | MongoDB | Location-based classifieds | ✅ Production Ready |
| 8 | REZ-save | 3016 | MongoDB | Wishlist, collections, price alerts | ✅ Production Ready |
| 9 | REZ-scan | 3017 | MongoDB | Universal QR scanner | ✅ Production Ready |
| 10 | REZ-menu-qr | 3018 | MongoDB | Menu QR ordering | ✅ Production Ready |
| 11 | go4food-api | 3002 | MongoDB | Food comparison, search | ✅ Production Ready |

### 🎨 UI Services (5)

| # | Service | Port | Description | Status |
|---|---------|------|-------------|--------|
| 1 | REZ-inbox-ui | 3010 | Smart inbox interface | ✅ Production Ready |
| 2 | REZ-assistant-ui | 3011 | AI chat interface | ✅ Production Ready |
| 3 | REZ-expense-ui | 3013 | Expense tracking UI | ✅ Production Ready |
| 4 | REZ-nearby-ui | 3015 | Discovery UI | ✅ Production Ready |
| 5 | REZ-scan-ui | 3017 | QR scanner UI | ✅ Production Ready |

### 🔐 Security Apps (1)

| # | App | Port | Description | Features | Status |
|---|-----|------|-------------|----------|--------|
| 1 | **corpid-shield-app** | 4716 | Consumer security | Scam detection, UPI safety, QR safety, AI Guardian, Dark Web monitoring | ✅ Production Ready |

### 📦 REZ-Mart Services (12) - Monorepo

| # | Service | Port | Description | Status |
|---|---------|------|-------------|--------|
| 1 | rez-mart-gateway | 4100 | API Gateway | ✅ Production Ready |
| 2 | rez-mart-driver-service | 4101 | Driver management | ✅ Production Ready |
| 3 | rez-mart-tracking-service | 4102 | Real-time tracking | ✅ Production Ready |
| 4 | rez-mart-store-service | 4103 | Store management | ✅ Production Ready |
| 5 | rez-mart-product-service | 4104 | Product catalog | ✅ Production Ready |
| 6 | rez-mart-order-service | 4105 | Order processing | ✅ Production Ready |
| 7 | rez-mart-delivery-service | 4106 | Delivery orchestration | ✅ Production Ready |
| 8 | rez-mart-inventory-service | 4107 | Inventory sync | ✅ Production Ready |
| 9 | rez-mart-cart-service | 4108 | Cart management | ✅ Production Ready |
| 10 | rez-mart-offer-service | 4109 | Coupons & offers | ✅ Production Ready |
| 11 | rez-mart-subscription-service | 4110 | Auto-replenishment | ✅ Production Ready |
| 12 | rez-mart-analytics-service | 4112 | Analytics | ✅ Production Ready |

### 🔧 REZ-Invest Services (5)

| # | Service | Port | Description | Status |
|---|---------|------|-------------|--------|
| 1 | rez-invest-gateway | 4800 | Investment API Gateway | ✅ Production Ready |
| 2 | rez-invest-brokerage | 4801 | Brokerage service | ✅ Production Ready |
| 3 | rez-invest-trading | 4802 | Trading engine | ✅ Production Ready |
| 4 | rez-invest-portfolio | 4803 | Portfolio management | ✅ Production Ready |
| 5 | rez-invest-wallet | 4804 | Investment wallet | ✅ Production Ready |
...
| Feature | Service | Description | Status |
|---------|---------|-------------|--------|
| QR Scanning | REZ-scan, verify-qr-mobile, safe-qr | Universal QR/barcode scanner | ✅ |
| QR Verification | verify-qr-service | Product authenticity check | ✅ |
| QR Generation | safe-qr-service | Create emergency/contact QR | ✅ |
| Warranty Tracking | verify-qr-service, REZ-bills | Extended warranty management | ✅ |
| Receipt Scanning | REZ-bills | OCR receipt parsing | ✅ |
| Expense Tracking | REZ-expense | AI-powered expense categorization | ✅ |
| Wishlist | REZ-save | Save products, price alerts | ✅ |
| Location Discovery | REZ-nearby | Nearby places & classifieds | ✅ |
| Email Parsing | REZ-inbox | Receipt extraction from emails | ✅ |
| AI Chat | REZ-assistant, do | Claude AI-powered assistant | ✅ |
| Food Comparison | go4food, go4food-api | Restaurant/menu comparison | ✅ |
| Menu QR | REZ-menu-qr | Restaurant QR ordering | ✅ |
| Loyalty Program | REZ-prive | Premium tiers, vouchers | ✅ |
| Trial Discovery | REZ-try | Sample products, missions | ✅ |
| Quick Commerce | REZ-Mart | 10-min delivery | ✅ |
| Investment Tracking | REZ-Invest | Portfolio management | ✅ |

### AI Features

| Feature | Service | Description | Status |
|---------|---------|-------------|--------|
| Intent Tracking | REZ-assistant, REZ-scan | User intent prediction | ✅ |
| AI Categorization | REZ-expense | Auto-categorize expenses | ✅ |
| AI Recommendations | REZ-try | Personalized suggestions | ✅ |
| Dynamic Pricing | REZ-try | AI-powered pricing | ✅ |
| Fraud Detection | verify-qr-service | Counterfeit detection | ✅ |
| Scam Detection | corpild-shield-app | UPI/sms scam protection | ✅ |
| Claude AI | do | Anthropic Claude integration | ✅ |
| 38 AI Agents | do | Specialized AI agents | ✅ |

### Payment Features

| Feature | Service | Description | Status |
|---------|---------|-------------|--------|
| Wallet Integration | REZ-bills, REZ-save | RABTUL wallet | ✅ |
| Cashback System | REZ-bills | Category-based cashback | ✅ |
| Savings Transfer | REZ-save | Auto-savings | ✅ |
| Razorpay Integration | REZ-try | Payment processing | ✅ |
| UPI Safety | corpild-shield-app | Fraud detection | ✅ |

### QR Emergency Modes (15)
...
|---------|---------|--------|
| Auth | User authentication, OTP | ✅ Integrated |
| Wallet | Balance, transactions | ✅ Integrated |
| Payment | UPI, card, wallet | ✅ Integrated |
| Order | Order management | ✅ Integrated |
| Booking | Reservations | ✅ Integrated |
| Notification | Push notifications | ✅ Integrated |
...
| Service | Purpose | Status |
|---------|---------|--------|
| Genie Memory | Personal experiences | ✅ Integrated |
| Genie Relation | Relationships | ✅ Integrated |
| Genie Briefing | Daily updates | ✅ Integrated |
| Commerce AI | Shopping insights | ✅ Integrated |
| Customer AI | User behavior | ✅ Integrated |
| Marketing AI | Offers | ✅ Integrated |
| Financial AI | Spending insights | ✅ Integrated |
| Voice OS | Text-to-speech | ✅ Integrated |

### REZ Intelligence
| Service | Purpose | Status |
|---------|---------|--------|
| Fraud Detection | Risk assessment | ✅ Integrated |
| Signal | Event tracking | ✅ Integrated |
| Intent | Intent prediction | ✅ Integrated |
| Memory Layer | Recommendations | ✅ Integrated |
...
|---------|------------|-----------------|
| REZ-Mart | Blinkit, BigBasket, Zepto | "Everything delivered in minutes" |
| REZ-Invest | Groww, CoinDCX | Integrated with super app |
| go4food | Zomato, Swiggy | Price comparison focus |
| REZ-prive | Paytm, PhonePe | AI-powered loyalty |

---

## NOT REZ-Consumer (Company Boundaries)

| Service | Belongs To | Correct Location |
|---------|------------|------------------|
...
|---------|--------|----------|
| Helmet.js | ✅ Done | All services |
| CORS | ✅ Done | All services |
...
| Winston Logging | ✅ Done | All services |
...
|----------|--------|-------|--------|
| Company Boundaries | ⚠️ 3 misplaced | ✅ Fixed | ✅ June 12, 2026 |
| JWT Secrets | ⚠️ 8 fallbacks | ✅ Secured | ✅ June 12, 2026 |
| Rate Limiting | ⚠️ 2 missing | ✅ Added | ✅ June 12, 2026 |
| Integration Tests | ⚠️ Basic | ✅ Comprehensive | ✅ June 12, 2026 |
| API Documentation | ❌ None | ✅ Swagger | ✅ June 12, 2026 |
| Security Headers | ⚠️ Partial | ✅ Full CSP+HSTS | ✅ June 12, 2026 |

## RTNM Ecosystem Integration (NEW - June 2026)

### StayOwn Hotel OS Integration

Airzy (under REZ-Consumer) integrates with StayOwn Hotel OS for flight-to-hotel coordination.

#### Integration Endpoints

| Endpoint | Method | Purpose |
|----------|--------|---------|
| `/api/flights/webhook/delay` | POST | Notify hotel of flight delays |
| `/api/flights/webhook/cancellation` | POST | Notify hotel of cancellations |
| `/api/flights/stayown/integration-status` | GET | Check StayOwn integration health |

#### Integration Flow

```
Guest books flight on Airzy
        ↓
Flight delay/cancellation detected
        ↓
POST /api/flights/webhook/delay
        ↓
StayOwn Hotel OS receives notification
        ↓
Hotel staff/guest notified
        ↓
Guest can modify hotel booking if needed
```
...
|---------|---------|------------------|
| **StayOwn** | Hotel OS (3899) | Flight notifications |
| **KHAIRMOVE** | Mobility (4600) | Airport transfers |
| **CorpPerks** | HR/Workforce (4700) | Corporate travel |

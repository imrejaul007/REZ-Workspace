...
export class RezChatIntegration {
  ...
  async cancelOrder(params: { orderId: string; reason?: string; userId: string }) {
    return this.orderConnector.cancelOrder(params.orderId, params.reason);
  }
  ...
  async reorder(params: { userId: string; orderId: string; deliveryAddress?: string }) {
    return this.orderConnector.reorder(params.userId, params.orderId, params.deliveryAddress);
  }
...
export { HotelOTAConnector } from './connectors/hotel.connector';
export { MerchantConnector } from './connectors/merchant.connector';
export { OrderConnector } from './connectors/order.connector';
export { WalletConnector } from './connectors/wallet.connector';
export { LoyaltyConnector } from './connectors/loyalty.connector';
export { NotificationConnector } from './connectors/notification.connector';
export { DynamicKnowledgeProvider } from './knowledge/dynamic-provider';
export { getIntegratedTools } from './tools/integrated-tools';
export { HotelActionHandler, MerchantActionHandler, SupportActionHandler, createActionHandlers, executeAction } from './socket/actionHandlers';
export { PLATFORM_CONFIGS, buildPlatformContext, getQuickActionResponse, ROOM_SERVICE_MENU, ROOM_SERVICE_INTENTS } from './platform/platforms';

// ── ReZ Ecosystem Chat Platform Configurations ─────────────────────────────────────────
// Platform-specific chat behaviors, knowledge bases, and action handlers

import { IndustryCategory, CustomerContext } from '@rez/chat-ai';

// ── Ecosystem Platform Types ──────────────────────────────────────────────────────────

export type ReZPlatform =
  // ── USER SIDE APPS ──────────────────────────────────────────────────────────
  | 'rez-consumer'          // ReZ App - General consumer app
  | 'rez-now'              // ReZ Now - Hotels, restaurants, orders
  | 'rendez'               // Rendez - Dating/social connections
  | 'karma'                // Karma - Gamification & rewards

  // ── MERCHANT SIDE APPS ──────────────────────────────────────────────────────
  | 'rez-merchant'         // ReZ Merchant OS - POS & management
  | 'adbazaar'             // AdBazaar - Ad platform
  | 'nextabizz'            // NextaBiZ - Business tools
  | 'restopapa'            // RestoPapa - Restaurant management

  // ── HOTEL ECOSYSTEM ─────────────────────────────────────────────────────────
  | 'hotel-ota'            // Hotel OTA - Hotel booking
  | 'hotel-room-qr'        // Hotel Room QR - In-room service
  | 'hotel-staff'          // Hotel Staff - Staff dashboard
  | 'hotel-app'            // Hotel App - Guest-facing hotel app
  | 'stayown'              // StayOwn - Vacation rentals
...
export const PLATFORM_CONFIGS: Record<ReZPlatform, PlatformConfig> = {
  // ── ReZ Consumer App ─────────────────────────────────────────────────────────────
  // General consumer app - all ReZ services

  'rez-consumer': {
    platform: 'rez-consumer',
    appType: 'general',
    ...
    enableWallet: true,
    enableLoyalty: true,
    availableServices: ['hotels', 'restaurants', 'retail', 'orders', 'bookings', 'wallet', 'karma', 'rendez'],
    welcomeMessage: `Welcome to ReZ! I'm your personal assistant across the entire ReZ ecosystem.

• Hotels & accommodations (Hotel OTA)
• Food orders & restaurant reservations (ReZ Now)
• Dating & social connections (Rendez)
• Earn rewards & karma points (Karma)
• Wallet & payments
• Shop from local merchants

What would you like to do today?`,
    quickActions: [
      { label: 'Book Hotel', action: 'search_hotels', icon: '🏨' },
      { label: 'Order Food', action: 'search_restaurants', icon: '🍔' },
      { label: 'Meet People', action: 'open_rendez', icon: '💕' },
      { label: 'My Karma', action: 'check_karma', icon: '⭐' },
    ],
    tintColor: '#6366f1',
  },

  // ── Rendez - Dating & Social ─────────────────────────────────────────────────────
  // Matchmaking, connections, social interactions
  ...
  'rendez': {
    ...
    enableWallet: true,
    enableLoyalty: false,
    availableServices: ['profiles', 'matches', 'messages', 'plans', 'events', 'date-ideas'],
    welcomeMessage: `Welcome to Rendez! I'm here to help you find meaningful connections.

• Profile setup & optimization
• Match recommendations
• Date planning & reservations
• Restaurant bookings for dates
• Event discovery
• Safety tips & guidelines

Let's find your perfect match!`,
    quickActions: [
      { label: 'Find Matches', action: 'view_matches', icon: '💕' },
      { label: 'Plan a Date', action: 'plan_date', icon: '📅' },
      { label: 'Book Restaurant', action: 'book_restaurant', icon: '🍽️' },
      { label: 'Events Near Me', action: 'nearby_events', icon: '🎉' },
    ],
    tintColor: '#ec4899',
  },

  // ── Karma - Gamification & Rewards ─────────────────────────────────────────────────
  // Points, achievements, rewards, engagement

  'karma': {
    platform: 'karma',
    appType: 'gamification',
    industryCategory: 'earn',
    enableRoomService: false,
    enableOrdering: false,
    enableBookings: false,
    enableWallet: true,
    enableLoyalty: true,
    availableServices: ['points', 'rewards', 'achievements', 'leaderboard', 'missions', 'streaks'],
    welcomeMessage: `Welcome to Karma! Earn points, unlock rewards, and climb the leaderboard.
...
Keep engaging to earn more!`,
    quickActions: [
      { label: 'My Points', action: 'show_balance', icon: '💎' },
      { label: 'Rewards', action: 'show_rewards', icon: '🎁' },
      { label: 'Daily Missions', action: 'show_missions', icon: '🎯' },
      { label: 'Leaderboard', action: 'show_leaderboard', icon: '🏆' },
    ],
    tintColor: '#f59e0b',
  },

  // ── ReZ Merchant OS ──────────────────────────────────────────────────────────────
  // POS, inventory, orders, customer management

  'rez-merchant': {
    platform: 'rez-merchant',
    appType: 'merchant',
    ...
    enableWallet: false,
    enableLoyalty: true,
    availableServices: ['orders', 'inventory', 'customers', 'analytics', 'loyalty-programs', 'staff'],
    welcomeMessage: `Welcome to ReZ Merchant OS! I'm your store management assistant.
...
How can I help run your store?`,
    quickActions: [
      { label: 'New Orders', action: 'view_orders', icon: '📦' },
      { label: 'Inventory', action: 'check_inventory', icon: '📊' },
      { label: 'Customers', action: 'view_customers', icon: '👥' },
      { label: 'Analytics', action: 'show_analytics', icon: '📈' },
    ],
    tintColor: '#10b981',
  },

  // ── AdBazaar - Ad Platform ──────────────────────────────────────────────────────
  // Ad creation, targeting, campaigns
  ...
  'adbazaar': {
    ...
    enableWallet: true,
    enableLoyalty: false,
    availableServices: ['campaigns', 'ads', 'targeting', 'budget', 'analytics', 'creatives'],
    welcomeMessage: `Welcome to AdBazaar! Let's create effective ad campaigns.
...
Ready to grow your business?`,
    quickActions: [
      { label: 'New Campaign', action: 'create_campaign', icon: '📢' },
      { label: 'My Ads', action: 'view_ads', icon: '📋' },
      { label: 'Budget', action: 'manage_budget', icon: '💰' },
      { label: 'Analytics', action: 'show_analytics', icon: '📊' },
    ],
    tintColor: '#8b5cf6',
  },
  ...
  'nextabizz': {
    ...
    enableWallet: true,
    enableLoyalty: true,
    availableServices: ['tools', 'integrations', 'workflows', 'templates', 'team', 'billing'],
    welcomeMessage: `Welcome to NextaBiZ! Your all-in-one business toolkit.

• Access business tools & calculators
• Manage workflows & automations
• Browse templates & integrations
• Team collaboration
• Billing & subscriptions
• Support & documentation

What business task can I help with?`,
    quickActions: [
      { label: 'Tools', action: 'show_tools', icon: '🛠️' },
      { label: 'Workflows', action: 'manage_workflows', icon: '⚙️' },
      { label: 'Integrations', action: 'browse_integrations', icon: '🔗' },
      { label: 'Templates', action: 'show_templates', icon: '📄' },
    ],
    tintColor: '#0ea5e9',
  },

  // ── Hotel OTA ──────────────────────────────────────────────────────────────
  // Hotel booking, search, reservations
  ...
  'hotel-ota': {
    ...
    enableWallet: true,
    enableLoyalty: true,
    availableServices: ['hotel_search', 'booking', 'checkin', 'checkout', 'support', 'reviews'],
    welcomeMessage: `Hello! Welcome to Hotel OTA. I can help you:
...
Where would you like to stay?`,
    quickActions: [
      { label: 'Search Hotels', action: 'hotel_search', icon: '🔍' },
      { label: 'My Bookings', action: 'view_bookings', icon: '📋' },
      { label: 'Deals', action: 'show_deals', icon: '🏷️' },
      { label: 'Support', action: 'get_support', icon: '💬' },
    ],
    tintColor: '#0ea5e9',
  },

  // ── Hotel Staff ──────────────────────────────────────────────────────────────
  // Staff dashboard, guest management

  'hotel-staff': {
    platform: 'hotel-staff',
    appType: 'hotel-staff',
    industryCategory: 'hotel',
    enableRoomService: true,
    enableOrdering: false,
    ...
    enableWallet: false,
    enableLoyalty: false,
    availableServices: ['guests', 'room-service', 'housekeeping', 'requests', 'alerts', 'shifts'],
    welcomeMessage: `Hotel Staff Dashboard. I'm here to help you:

• View guest requests & messages
...
How can I assist you today?`,
    quickActions: [
      { label: 'Guest Requests', action: 'view_requests', icon: '📨' },
      { label: 'Room Service', action: 'view_orders', icon: '🍽️' },
      { label: 'Housekeeping', action: 'view_housekeeping', icon: '🧹' },
      { label: 'Alerts', action: 'view_alerts', icon: '🔔' },
    ],
    tintColor: '#64748b',
  },
...
How can I help?`,
  ...
  // ── RestoPapa - Restaurant Management ──────────────────────────────────────────────
  'restopapa': {
    platform: 'restopapa',
    appType: 'restaurant',
    industryCategory: 'restaurant',
    ...
    enableWallet: true,
    enableLoyalty: true,
    availableServices: ['orders', 'reservations', 'menu', 'analytics', 'customers'],
    welcomeMessage: `Welcome to RestoPapa! I'm your restaurant management assistant.
...
How can I help?`,
    quickActions: [
      { label: 'New Order', action: 'new_order', icon: '📋' },
      { label: 'Reservations', action: 'reservations', icon: '📅' },
      { label: 'Menu', action: 'menu', icon: '🍽️' },
      { label: 'Analytics', action: 'analytics', icon: '📊' },
    ],
    tintColor: '#f59e0b',
  },

  // ── StayOwn - Vacation Rentals ────────────────────────────────────────────────────
  'stayown': {
    platform: 'stayown',
    appType: 'hotel',
    industryCategory: 'hotel',
    ...
    enableWallet: true,
    enableLoyalty: true,
    availableServices: ['property_search', 'bookings', 'checkin', 'checkout', 'support'],
    welcomeMessage: `Welcome to StayOwn! I'm your vacation rental assistant.
...
How can I help?`,
    quickActions: [
      { label: 'Search Properties', action: 'property_search', icon: '🏠' },
      { label: 'My Bookings', action: 'my_bookings', icon: '📋' },
      { label: 'Check-in', action: 'checkin', icon: '🔑' },

...
export class DynamicKnowledgeProvider {
  ...
  async getHotelKnowledge(hotelId: string): Promise<KnowledgeEntry[]> {
    ...
    try {
      ...
      logger.error('[DynamicKnowledgeProvider] Get hotel knowledge error:', error);
      return [];
    }
  }
  ...
  async getMerchantKnowledge(merchantId: string): Promise<KnowledgeEntry[]> {
    ...
    try {
      ...
      logger.error('[DynamicKnowledgeProvider] Get merchant knowledge error:', error);
      return [];
    }
  }
  ...
  async getPersonalizedKnowledge(userId: string): Promise<KnowledgeEntry[]> {
    ...
    try {
      ...
      logger.error('[DynamicKnowledgeProvider] Get personalized knowledge error:', error);
      return [];
    }
  }

...
// Loyalty Tiers (Phase 7: added 'diamond' to match canonical LOYALTY_TIERS)
...
// User Roles (Phase 7: added CONSUMER to match canonical UserRole enum — now 7 values)
...
export function normalizeLoyaltyTier(tier: string): LoyaltyTier {
  ...
  const map: Record<string, LoyaltyTier> = {
    ...
    STARTER: 'bronze', DIAMOND: 'diamond', DIMAOND: 'diamond',
  };

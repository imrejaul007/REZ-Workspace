...
**Status:** Partially Fixed in commit (2026-04-15) — Defined GatewayResponse type and fixed paymentService.ts type casting; additional instances remain
...
**Status:** Fixed in commit (2026-04-15) — Normalized rezcoins to wallet payment type in getAvailablePaymentMethods()

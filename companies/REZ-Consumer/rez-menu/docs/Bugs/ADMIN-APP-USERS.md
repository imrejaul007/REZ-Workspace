...
> **Notes:** Added showConfirm dialog for reactivation path (lines 165-170) to match deactivation pattern and ensure all state changes require explicit confirmation.

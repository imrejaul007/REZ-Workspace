...
| `rezapp/rez-master/`contexts/CartContext.tsx` | **1,300** | HIGH |
| `rezapp/rez-master/`contexts/AuthContext.tsx` | **955** | HIGH |
| `rezapp/rez-master/`contexts/GamificationContext.tsx` | **775** | HIGH |
| `rezapp/rez-master/`contexts/SocketContext.tsx` | **704** | MEDIUM |

...
| **ReZ Web Menu** | Customer convenience — web-based menu/ordering | Next.js |
...
The ReZ Web Menu is a Next.js web app that provides a browser-based menu and ordering experience. It communicates with rezbackend over the standard consumer API (`/api/v1/*`).

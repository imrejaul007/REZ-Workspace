...
- **Severity**: CRITICAL
- **Files**: `rezapp/rez-master/.env` Lines 52–93, `rezmerchant/rez-merchant-master/.env` Lines 52–97
...
- **Severity**: HIGH
- **File**: `rezapp/rez-master/utils/authStorage.ts` Lines 125–160
...
- **Severity**: CRITICAL
- **File**: `rezapp/rez-master/app/order/[storeSlug]/checkout.tsx` Lines 269–290
...
- **Severity**: MEDIUM
- **File**: `rezapp/rez-master/utils/deepLinkHandler.ts` Lines 17–72
...
- **Severity**: MEDIUM
- **File**: `rezapp/rez-master/.env` Line 6 (`EXPO_PUBLIC_API_BASE_URL`)

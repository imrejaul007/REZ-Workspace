...
> Covers: Consumer App (rez-master), Merchant App (rez-merchant-master), Admin App (rez-admin-main)
...
1. [Consumer App (rez-master)](#1-consumer-app-rez-master)
...
## 1. Consumer App (rez-master)

**Root:** `/Users/rejaulkarim/Documents/ReZ Full App/rezapp/rez-master/`

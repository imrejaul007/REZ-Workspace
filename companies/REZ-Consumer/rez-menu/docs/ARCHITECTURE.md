...
|-----|------|----------|-------|
| **REZ Consumer App** | `imrejaul007/rez-app-consumer` (rez-master) | Expo EAS | iOS + Android |
...
|-----------|-------|---------|
| `rez` | rez-wallet-service (MongoDB) | Primary consumer coins earned via visits, orders, referrals |
...
**Conversion:** 1 REZ coin = ₹0.50 (configurable via `REZ_COIN_TO_RUPEE_RATE`)  
...
**Coin types:** `rez` (main), `prive`, `branded`, `promo`

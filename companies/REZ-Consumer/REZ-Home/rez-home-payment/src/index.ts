...
// Start server
app.listen(PORT, () => {
  logger.info(`REZ-Home Payment Service started on port ${PORT}`);
  logger.info(`Environment: ${NODE_ENV}`);
  logger.info(`RABTUL Wallet URL: ${RABTUL_WALLET_URL}`);
});

...
interface GamificationContextType {
  ...
  actions: {
    ...
    triggerAchievementCheck: (eventType: string, data?) => Promise<Achievement[]>;
...
export function GamificationProvider({ children }: GamificationProviderProps) {
  ...
  const triggerAchievementCheck = useCallback(async (eventType: string, data?): Promise<Achievement[]> => {

...
class GlobalNotificationService {
  ...
  public setNotificationContext(context) {
  ...
  private getPushNotificationType(type: NotificationType): keyof unknown {
    const mapping: Record<NotificationType, keyof unknown> = {
  ...
  private getEmailNotificationType(type: NotificationType): keyof unknown {
    const mapping: Record<NotificationType, keyof unknown> = {
  ...
  private getSMSNotificationType(type: NotificationType): keyof unknown {
    const mapping: Record<NotificationType, keyof unknown> = {
      orderUpdate: 'orderUpdates',

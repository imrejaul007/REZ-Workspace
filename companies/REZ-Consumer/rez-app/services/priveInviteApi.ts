...
class PriveInviteApi {
  ...
  async generateCode(): Promise<ApiResponse<{
    ...
    return apiClient.post<unknown>('/prive/invites/generate');
  }
  ...
  async validateCode(code: string): Promise<ApiResponse<{
    ...
    return apiClient.post<unknown>('/prive/invites/validate', { code });
  }
  ...
  async applyCode(code: string): Promise<ApiResponse<{
    ...
    return apiClient.post<unknown>('/prive/invites/apply', { code });
  }

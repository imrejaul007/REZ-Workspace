...
function getScratchCardApiService(): ScratchCardApiService {
  if (typeof globalThis !== 'undefined') {
    if (!(globalThis as unknown)[SCRATCH_CARD_API_KEY]) {
      (globalThis as unknown)[SCRATCH_CARD_API_KEY] = new ScratchCardApiService();
    }
    return (globalThis as unknown)[SCRATCH_CARD_API_KEY];
  }

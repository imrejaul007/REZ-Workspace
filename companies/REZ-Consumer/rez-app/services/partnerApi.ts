...
class PartnerApiService {
  ...
  async getDashboard(): Promise<ApiResponse<PartnerDashboard & { enrolled?: boolean }>> {
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/dashboard`);
  }
  ...
  async enrollPartner(): Promise<ApiResponse<PartnerDashboard & { enrolled: boolean }>> {
    return apiClient.post<unknown>(`${this.baseUrl}/enroll`);
  }
  ...
  async getBenefits(): Promise<ApiResponse<{
    ...
    levels: Array<unknown>; // Same as allLevels for compatibility
  }>> {

    return apiClient.get<unknown>(`${this.baseUrl}/benefits`);
  }
  ...
  async getProfile(): Promise<ApiResponse<{ profile: PartnerProfile }>> {
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/profile`);
  }
  ...
  async getEarnings(): Promise<ApiResponse<PartnerEarnings>> {
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/earnings`);
  }
  ...
  async getTasks(): Promise<ApiResponse<{ tasks: RewardTask[] }>> {
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/tasks`);
  }
  ...
  async claimTaskReward(taskId: string): Promise<ApiResponse<{
    ...
    return apiClient.post<unknown>(`${this.baseUrl}/tasks/${taskId}/claim`);
  }
  ...
  async getJackpotProgress(): Promise<ApiResponse<{
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/jackpot`);
  }
  ...
  async claimJackpotReward(spendAmount: number): Promise<ApiResponse<{
    ...
    return apiClient.post<unknown>(`${this.baseUrl}/jackpot/${spendAmount}/claim`);
  }
  ...
  async getOffers(): Promise<ApiResponse<{ offers: ClaimableOffer[] }>> {
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/offers`);
  }
  ...
  async claimOffer(offerId: string): Promise<ApiResponse<{
    ...
    const response = await apiClient.post<unknown>(`${this.baseUrl}/offers/claim`, { offerId });
  ...
  async getFAQs(category?: string): Promise<ApiResponse<{ faqs: PartnerFAQ[] }>> {
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/faqs`, category ? { category } : undefined);
  }
  ...
  async getLevelBenefits(): Promise<ApiResponse<{
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/levels`);
  }
  ...
  async requestPayout(amount: number, method: string): Promise<ApiResponse<{
    ...
    return apiClient.post<unknown>(`${this.baseUrl}/payout/request`, { amount, method });
  }
  ...
  async getStats(): Promise<ApiResponse<PartnerStats>> {
    return apiClient.get<unknown>(`${this.baseUrl}/stats`);
  }
  ...
  async getTransactions(params?: {
    ...
    return apiClient.get<unknown>(`${this.baseUrl}/earnings`, params);
  }
}

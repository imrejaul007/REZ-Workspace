...
class EarningsApiService {
  ...
  async getConsolidatedSummary(params?: {
    ...
    return apiClient.get<unknown>('/earnings/consolidated-summary', queryParams);
  }
  ...
  async getPartnerSummary(params?: {
    ...
    const queryParams: Record<string, string> = {};
    if (params?.period) queryParams.period = params.period;
    return apiClient.get<unknown>('/earnings/partner-summary', queryParams);
  }
  ...
  async getHistory(params?: {
    ...
    return apiClient.get<unknown>('/earnings/history', queryParams);
  }
}

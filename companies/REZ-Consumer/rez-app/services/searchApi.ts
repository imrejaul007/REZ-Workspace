...
class SearchService {
  ...
  async searchProducts(params: ProductSearchParams): Promise<ApiResponse<ProductSearchResponse>> {
    ...
    return apiClient.get<unknown>('/products/search', params as unknown);
  }

  // Search stores
  async searchStores(params: StoreSearchParams): Promise<ApiResponse<StoreSearchResponse>> {

    return apiClient.get<unknown>('/stores/search', params as unknown);
  }
  ...
  async advancedStoreSearch(params: AdvancedStoreSearchParams): Promise<ApiResponse<StoreSearchResponse>> {
    ...
    return apiClient.get<unknown>('/stores/search/advanced', params as unknown);
  }
  ...
  async getSearchSuggestions(query: string): Promise<ApiResponse<SearchSuggestion[]>> {
    try {
      const response = await apiClient.get<unknown>('/search/autocomplete', { q: query });
  ...
  async searchByCategory(
    ...
    return apiClient.get<unknown>(`/products/category/${categorySlug}`, params as unknown);
  }
  ...
  async searchStoresByCategory(
    ...
    return apiClient.get<unknown>(`/stores/search-by-category/${category}`, params as unknown);
  }
  ...
  async searchStoresByDeliveryTime(
    ...
    return apiClient.get<unknown>('/stores/search-by-delivery-time', params as unknown);
  }
  ...
  async getNearbyStores(
    ...
    return apiClient.get<unknown>('/stores/nearby', params as unknown);
  }
  ...
  async searchProductsByStore(
    ...
    return apiClient.get<unknown>(`/stores/${storeId}/products`, params as unknown);
  }
  ...
  async getFeaturedProducts(limit: number = 10): Promise<ApiResponse<{ data: ProductSearchResult[] }>> {
    ...
    return apiClient.get<unknown>('/products/featured', { limit });
  }
  ...
  async getNewArrivals(limit: number = 10): Promise<ApiResponse<{ data: ProductSearchResult[] }>> {
    ...
    return apiClient.get<unknown>('/products/new-arrivals', { limit });
  }
  ...
  async getFeaturedStores(limit: number = 10): Promise<ApiResponse<{ stores: StoreSearchResult[] }>> {
    ...
    return apiClient.get<unknown>('/stores/featured', { limit });
  }
  ...
  async searchProductsGrouped(
    ...
    return apiClient.get<unknown>('/search/products-grouped', params as unknown);
  }

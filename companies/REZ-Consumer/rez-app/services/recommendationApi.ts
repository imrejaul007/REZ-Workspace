...
class RecommendationService {
  ...
  async getSimilarProducts(
    ...
    try {
      ...
      const response = await apiClient.get<unknown>(`/recommendations/products/similar/${productId}`, {
        limit
      });
  ...
  async getFrequentlyBoughtTogether(
    ...
    try {
      ...
      const response = await apiClient.get<unknown>(`/recommendations/products/frequently-bought/${productId}`, {
        limit
      });
  ...
  async getBundleDeals(
    ...
    try {
      ...
      const response = await apiClient.get<unknown>(`/recommendations/products/bundle/${productId}`, {
        limit
      });
  ...
  async getPersonalizedRecommendations(
    ...
    try {
      ...
      const response = await apiClient.get<unknown>('/recommendations/products/personalized', params);
  ...
  async getPickedForYou(
    ...
    try {
      ...
      const response = await apiClient.get<unknown>('/recommendations/picked-for-you', params);
  ...
  async trackProductView(productId: string): Promise<ApiResponse<{ productId: string; tracked: boolean }>> {
    try {
      ...
      const response = await apiClient.post<unknown>(`/recommendations/products/${productId}/view`);

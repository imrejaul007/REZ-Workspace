 ...
 */
function validateWishlist(data): boolean {
 ...
 */
function validateWishlistItem(item): boolean {
 ...
 */
function validateWishlistsResponse(data): boolean {
  if (!data || typeof data !== 'object') {
  ...
  async getWishlists(
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        response.data.wishlists = response.data.wishlists.filter((wishlist) => {

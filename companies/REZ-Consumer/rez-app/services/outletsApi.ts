...
class OutletsApi {
  ...
  async getOutlets(params?: {
    ...
    try {
      const response = await apiClient.get<unknown>('/outlets', params);
  ...
  async getOutletsByStore(
    ...
    try {
      const response = await apiClient.get<unknown>(`/outlets/store/${storeId}`, params);
  ...
  async searchOutlets(data: {
    ...
    try {
      const response = await apiClient.post<unknown>('/outlets/search', data as unknown);
      return response as unknown;
    } catch (error) {
      throw error;
    }

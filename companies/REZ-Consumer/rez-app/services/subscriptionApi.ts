...
class SubscriptionAPI {
  ...
  async getAvailableTiers(): Promise<SubscriptionTier[]> {
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] getAvailableTiers failed:', error?.message);
      return {
        success: false,
  ...
  async getCurrentSubscription(): Promise<CurrentSubscription> {
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] getCurrentSubscription failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async subscribeToPlan(
    ...
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] subscribeToPlan failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async upgradeSubscription(newTier: 'premium' | 'vip'): Promise<{
    ...
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] upgradeSubscription failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async initiateUpgrade(newTier: 'premium' | 'vip', billingCycle?: string, paymentGateway?: string): Promise<{
    ...
    try {
      const response = await apiClient.post<unknown>('/subscriptions/upgrade/initiate', {
        newTier,
        billingCycle,
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] initiateUpgrade failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async confirmUpgrade(upgradeId: string, paymentId?: string, paymentIntentId?: string): Promise<{
    ...
    try {
      const response = await apiClient.post<unknown>('/subscriptions/upgrade/confirm', {
        upgradeId,
        paymentId,
        paymentIntentId,
      });
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] confirmUpgrade failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async downgradeSubscription(newTier: 'free' | 'premium'): Promise<{
    ...
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] downgradeSubscription failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async cancelSubscription(
    ...
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] cancelSubscription failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async renewSubscription(): Promise<CurrentSubscription> {
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] renewSubscription failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
   ...
   */
  async getSubscriptionBenefits(): Promise<unknown> {
    try {
      const response = await apiClient.get<unknown>('/subscriptions/benefits');
      return response.data;
    } catch (error) {
      if (__DEV__) logger.warn('[SubscriptionAPI] getSubscriptionBenefits failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async getSubscriptionUsage(): Promise<{
    ...
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] getSubscriptionUsage failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async getValueProposition(tier: 'premium' | 'vip'): Promise<ValueProposition> {
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] getValueProposition failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async toggleAutoRenew(autoRenew: boolean): Promise<CurrentSubscription> {
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] toggleAutoRenew failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async getBillingHistory(params?: {
    ...
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] getBillingHistory failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async getBillingSummary(): Promise<{
    ...
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] getBillingSummary failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
  ...
  async getInvoice(transactionId: string): Promise<Invoice> {
    try {
      ...
      if (__DEV__) logger.warn('[SubscriptionAPI] getInvoice failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
   ...
   * Download invoice
   */
  async downloadInvoice(transactionId: string): Promise<unknown> {
    try {
      const response = await apiClient.get<unknown>(`/billing/invoice/${transactionId}/download`, {
        responseType: 'blob'
      });
      return response.data;
    } catch (error) {
      if (__DEV__) logger.warn('[SubscriptionAPI] downloadInvoice failed:', error?.message);
      return {
        success: false,
        message: error?.response?.data?.message || error?.message || 'Operation failed',
        data: null,
...
function getSubscriptionApi(): SubscriptionAPI {
  if (typeof globalThis !== 'undefined') {
    if (!(globalThis as unknown)[SUBSCRIPTION_API_KEY]) {
      (globalThis as unknown)[SUBSCRIPTION_API_KEY] = new SubscriptionAPI();
    }
    return (globalThis as unknown)[SUBSCRIPTION_API_KEY];
  }

...
class WishlistSharingService {
  ...
  async generateShareableLink(wishlistId: string): Promise<ApiResponse<ShareableLink>> {
    return apiClient.post<unknown>(`/wishlist/${wishlistId}/generate-share-link`);
  }
  ...
  async getPublicWishlist(shareCode: string): Promise<ApiResponse<PublicWishlist>> {
    return apiClient.get<unknown>(`/wishlist/public/${shareCode}`);
  }
  ...
  async updatePrivacySettings(
    ...
    return apiClient.patch<unknown>(`/wishlist/${wishlistId}/privacy`, settings as unknown);
  }
  ...
  async getPrivacySettings(wishlistId: string): Promise<ApiResponse<PrivacySettings>> {
    return apiClient.get<unknown>(`/wishlist/${wishlistId}/privacy`);
  }
  ...
  async trackShareAnalytics(
    ...
    return apiClient.post<unknown>(`/wishlist/${wishlistId}/track-share`, { platform });
  }
  ...
  async getShareAnalytics(wishlistId: string): Promise<ApiResponse<ShareAnalytics>> {
    return apiClient.get<unknown>(`/wishlist/${wishlistId}/analytics/shares`);
  }
  ...
  async getSharedWishlists(
    ...
    return apiClient.get<unknown>('/wishlist/shared-with-me', { page, limit });
  }
  ...
  async likeWishlist(shareCode: string): Promise<ApiResponse<{ liked: boolean; likes: number }>> {
    return apiClient.post<unknown>(`/wishlist/public/${shareCode}/like`);
  }
  ...
  async unlikeWishlist(shareCode: string): Promise<ApiResponse<{ liked: boolean; likes: number }>> {
    return apiClient.delete<unknown>(`/wishlist/public/${shareCode}/like`);
  }
  ...
  async addComment(
    ...
    return apiClient.post<unknown>(`/wishlist/public/${shareCode}/comments`, { comment });
  }
  ...
  async deleteComment(
    ...
    return apiClient.delete<unknown>(`/wishlist/public/${shareCode}/comments/${commentId}`);
  }
  ...
  async reserveGift(
    ...
    return apiClient.post<unknown>(`/wishlist/public/${shareCode}/items/${itemId}/reserve`, options);
  }
  ...
  async cancelGiftReservation(
    ...
    return apiClient.delete<unknown>(`/wishlist/public/${shareCode}/items/${itemId}/reserve`);
  }
  ...
  async markGiftPurchased(
    ...
    return apiClient.post<unknown>(`/wishlist/public/${shareCode}/items/${itemId}/purchased`);
  }
  ...
  async getGiftReservations(shareCode: string): Promise<ApiResponse<GiftReservation[]>> {
    return apiClient.get<unknown>(`/wishlist/public/${shareCode}/reservations`);
  }
  ...
  async addToMyWishlist(
    ...
    return apiClient.post<unknown>(`/wishlist/public/${shareCode}/items/${itemId}/add-to-mine`);
  }
  ...
  async reportWishlist(
    ...
    return apiClient.post<unknown>(`/wishlist/public/${shareCode}/report`, { reason, details });
  }

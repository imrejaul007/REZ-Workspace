...
function getShareContentGenerator(): ShareContentGenerator {
  if (typeof globalThis !== 'undefined') {
    if (!(globalThis as unknown)[SHARE_CONTENT_GENERATOR_KEY]) {
      (globalThis as unknown)[SHARE_CONTENT_GENERATOR_KEY] = new ShareContentGenerator();
    }
    return (globalThis as unknown)[SHARE_CONTENT_GENERATOR_KEY];
  }

...
class StoreMessagingService {
  ...
  async getConversations(filter: ConversationFilter = {}): Promise<ApiResponse<ConversationsResponse>> {
    ...
    return apiClient.get<unknown>('/messages/conversations', filter as unknown);
  }

  // Get a specific conversation
  async getConversation(conversationId: string): Promise<ApiResponse<Conversation>> {

    return apiClient.get<unknown>(`/messages/conversations/${conversationId}`);
  }
  ...
  async getOrCreateConversation(
    ...
    return apiClient.post<unknown>('/messages/conversations', {
      storeId,
      orderId,
    });
  }
  ...
  async getMessages(
    ...
    return apiClient.get<unknown>(`/messages/conversations/${conversationId}/messages`, {
      page,
      limit,
    });
  }
  ...
  async sendMessage(data: SendMessageRequest): Promise<ApiResponse<Message>> {
    ...
    return apiClient.post<unknown>(`/messages/conversations/${data.conversationId}/messages`, {
  ...
  async markMessageAsRead(conversationId: string, messageId: string): Promise<ApiResponse<void>> {
    ...
    return apiClient.patch<unknown>(`/messages/conversations/${conversationId}/messages/${messageId}/read`);
  }

  // Mark all messages in conversation as read
  async markConversationAsRead(conversationId: string): Promise<ApiResponse<void>> {

    return apiClient.patch<unknown>(`/messages/conversations/${conversationId}/read`);
  }

  // Archive conversation
  async archiveConversation(conversationId: string): Promise<ApiResponse<Conversation>> {

    return apiClient.patch<unknown>(`/messages/conversations/${conversationId}/archive`);
  }

  // Unarchive conversation
  async unarchiveConversation(conversationId: string): Promise<ApiResponse<Conversation>> {

    return apiClient.patch<unknown>(`/messages/conversations/${conversationId}/unarchive`);
  }

  // Delete conversation
  async deleteConversation(conversationId: string): Promise<ApiResponse<void>> {

    return apiClient.delete<unknown>(`/messages/conversations/${conversationId}`);
  }

  // Get store availability status
  async getStoreAvailability(storeId: string): Promise<ApiResponse<StoreAvailability>> {

    return apiClient.get<unknown>(`/stores/${storeId}/availability`);
  }
  ...
  async searchMessages(
    ...
    return apiClient.get<unknown>('/messages/search', {
      query,
      conversationId,
    });
  }
  ...
  async reportMessage(
    ...
    return apiClient.post<unknown>(`/messages/${messageId}/report`, {
      reason,
      details,
    });
  }
  ...
  async blockStore(storeId: string): Promise<ApiResponse<void>> {
    ...
    return apiClient.post<unknown>(`/stores/${storeId}/block`);
  }

  // Unblock store
  async unblockStore(storeId: string): Promise<ApiResponse<void>> {

    return apiClient.post<unknown>(`/stores/${storeId}/unblock`);
  }

  // Get unread count
  async getUnreadCount(): Promise<ApiResponse<{ total: number; byStore: Record<string, number> }>> {

    return apiClient.get<unknown>('/messages/unread/count');
  }
  ...
  async getAutoResponseSuggestions(
    ...
    return apiClient.get<unknown>(`/stores/${storeId}/auto-responses`, {
      query,
    });
  }
}

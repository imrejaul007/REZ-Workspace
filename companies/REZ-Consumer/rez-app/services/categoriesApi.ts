...
function getCategoriesService(): CategoriesService {
  if (typeof globalThis !== 'undefined') {
    if (!(globalThis as unknown)[CATEGORIES_SERVICE_KEY]) {
      (globalThis as unknown)[CATEGORIES_SERVICE_KEY] = new CategoriesService();
    }
    return (globalThis as unknown)[CATEGORIES_SERVICE_KEY];
  }

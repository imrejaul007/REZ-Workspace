...
class ReorderService {
  ...
  async validateReorder(
    ...
    return apiClient.get<unknown>(`/orders/${orderId}/reorder/validate`, params);
  }

  // Re-order full order
  async reorderFullOrder(orderId: string): Promise<ApiResponse<ReorderResult>> {

    return apiClient.post<unknown>(`/orders/${orderId}/reorder`, {});
  }
  ...
  async reorderSelectedItems(
    ...
    return apiClient.post<unknown>(`/orders/${orderId}/reorder/items`, { itemIds });
  }
  ...
  async getFrequentlyOrdered(
    ...
    return apiClient.get<unknown>('/orders/reorder/frequently-ordered', { limit });
  }

  // Get reorder suggestions
  async getReorderSuggestions(): Promise<ApiResponse<ReorderSuggestion[]>> {

    return apiClient.get<unknown>('/orders/reorder/suggestions');
  }
}

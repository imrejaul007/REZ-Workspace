...
class ArticlesService {
  ...
  async getArticles(params?: ArticlesQuery): Promise<ApiResponse<ArticlesResponse>> {
    try {
      ...
      return await apiClient.get<unknown>('/articles', params as unknown);
    } catch (error) {
  ...
  async getArticleById(articleId: string): Promise<ApiResponse<Article>> {
    try {
      ...
      return await apiClient.get<unknown>(`/articles/${articleId}`);
    } catch (error) {
  ...
  async getArticlesByCategory(
    ...
    try {
      ...
      return await apiClient.get<unknown>(`/articles/category/${category}`, params as unknown);
    } catch (error) {
  ...
  async getArticlesByAuthor(
    ...
    try {
      ...
      return await apiClient.get<unknown>(`/articles/author/${authorId}`, params as unknown);
    } catch (error) {
  ...
  async getTrendingArticles(
    ...
    try {
      ...
      return await apiClient.get<unknown>('/articles/trending', { limit, timeframe } as unknown);
    } catch (error) {
  ...
  async getFeaturedArticles(limit: number = 10): Promise<ApiResponse<Article[]>> {
    try {
      ...
      return await apiClient.get<unknown>('/articles/featured', { limit } as unknown);
    } catch (error) {
  ...
  async searchArticles(
    ...
    try {
      ...
      return await apiClient.get<unknown>('/articles/search', {
        search: query,
        ...filters
      } as unknown);
    } catch (error) {
  ...
  async createArticle(articleData: ArticleInput): Promise<ApiResponse<Article>> {
    try {
      ...
      return await apiClient.post<unknown>('/articles', articleData as unknown);
    } catch (error) {
  ...
  async updateArticle(
    ...
    try {
      ...
      // Otherwise, use PATCH
      return await apiClient.patch<unknown>(`/articles/${articleId}`, articleData as unknown);
    } catch (error) {
  ...
  async deleteArticle(articleId: string): Promise<ApiResponse<{ message: string }>> {
    try {
      ...
      return await apiClient.delete<unknown>(`/articles/${articleId}`);
    } catch (error) {
  ...
  async toggleArticleLike(
    ...
    try {
      ...
      return await apiClient.post<unknown>(`/articles/${articleId}/like`);
    } catch (error) {
  ...
  async toggleArticleBookmark(
    ...
    try {
      ...
      return await apiClient.post<unknown>(`/articles/${articleId}/bookmark`);
    } catch (error) {
  ...
  async getBookmarkedArticles(
    ...
    try {
      ...
      return await apiClient.get<unknown>('/articles/bookmarks', { page, limit } as unknown);
    } catch (error) {
  ...
  async shareArticle(
    ...
    try {
      ...
      return await apiClient.post<unknown>(`/articles/${articleId}/share`, { platform });
    } catch (error) {
  ...
  async recordView(
    ...
    try {
      ...
      return await apiClient.post<unknown>(`/articles/${articleId}/view`, { readTime });
    } catch (error) {
  ...
  async getArticleEngagement(
    ...
    try {
      ...
      return await apiClient.get<unknown>(`/articles/${articleId}/engagement`);
    } catch (error) {
  ...
  async getArticleComments(
    ...
    try {
      ...
      return await apiClient.get<unknown>(`/articles/${articleId}/comments`, {
        page,
        limit,
        sort
      });
  ...
  async addArticleComment(
    ...
    try {
      ...
      return await apiClient.post<unknown>(`/articles/${articleId}/comments`, {
        content,
        parentId
      });
    } catch (error) {
  ...
  async getRelatedArticles(
    ...
    try {
      ...
      return await apiClient.get<unknown>(`/articles/${articleId}/related`, { limit });
    } catch (error) {
  ...
  async getRecommendedArticles(
    ...
    try {
      ...
      return await apiClient.get<unknown>('/articles/recommendations', { limit } as unknown);
    } catch (error) {
  ...
  async getArticleCategories(): Promise<ApiResponse<Array<{
    ...
    try {
      ...
      return await apiClient.get<unknown>('/articles/categories');
    } catch (error) {
  ...
  async reportArticle(
    ...
    try {
      ...
      return await apiClient.post<unknown>(`/articles/${articleId}/report`, {
        reason,
        details
      });
    } catch (error) {

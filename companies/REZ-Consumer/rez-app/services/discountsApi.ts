...
class DiscountsApi {
  ...
  async getDiscounts(params?: {
    ...
    try {
      const response = await apiClient.get<unknown>('/discounts', params);
  ...
  async applyDiscount(
    ...
    try {
      const response = await apiClient.post<ApplyDiscountResponse>('/discounts/apply', data as unknown);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  async getUserDiscountHistory(params?: {
    ...
    try {
      const response = await apiClient.get<unknown>('/discounts/my-history', params);
      return response as unknown;
    } catch (error) {
      throw error;
    }
   ...
   */
  async getDiscountAnalytics(id: string): Promise<ApiResponse<unknown>> {
    try {
      const response = await apiClient.get<unknown>(`/discounts/${id}/analytics`);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  async getCardOffers(params?: {
    ...
    try {
      ...
      const response = await apiClient.get<unknown>('/discounts', queryParams);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  async validateCardForOffers(data: {
    ...
    try {
      const response = await apiClient.post<unknown>('/discounts/card-offers/validate', data as unknown);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  async applyCardOffer(data: {
    ...
    try {
      const response = await apiClient.post<unknown>('/discounts/card-offers/apply', data as unknown);
      return response as unknown;
    } catch (error) {
      throw error;
    }

...
const emergencyApi = {
  ...
  getNearbyContacts: async (
    ...
    try {
      ...
      const response = await apiClient.get<unknown>(`/emergency/contacts/nearby?${params.toString()}`);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  bookEmergency: async (data: CreateEmergencyBookingRequest): Promise<ApiResponse<EmergencyBooking>> => {
    try {
      const response = await apiClient.post<unknown>('/emergency/book', data as unknown as unknown);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  getBookingStatus: async (id: string): Promise<ApiResponse<EmergencyBooking>> => {
    try {
      const response = await apiClient.get<unknown>(`/emergency/booking/${id}`);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  getBookings: async (
    ...
    try {
      ...
      const response = await apiClient.get<unknown>(`/emergency/bookings?${params.toString()}`);
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  cancelBooking: async (id: string, reason?: string): Promise<ApiResponse<EmergencyBooking>> => {
    try {
      const response = await apiClient.put<unknown>(`/emergency/booking/${id}/cancel`, { reason });
      return response as unknown;
    } catch (error) {
      throw error;
    }
  ...
  /**
   * Get user's active emergency booking if unknown
  ...
  getActiveBooking: async (): Promise<ApiResponse<ActiveBookingResponse>> => {
    try {
      const response = await apiClient.get<unknown>('/emergency/active');
      return response as unknown;
    } catch (error) {
      throw error;
    }

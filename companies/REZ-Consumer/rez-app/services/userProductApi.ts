...
class UserProductService {
  ...
  async getUserProducts(filters?: ProductFilters): Promise<ApiResponse<UserProduct[]>> {
    ...
    return apiClient.get<unknown>('/user-products', filters as unknown);
  }
  ...
  async getProductDetails(productId: string): Promise<ApiResponse<UserProduct>> {
    ...
    return apiClient.get<unknown>(`/user-products/${productId}`);
  }
  ...
  async getExpiringWarranties(days: number = 30): Promise<ApiResponse<{
    ...
    return apiClient.get<unknown>('/user-products/expiring-warranties', { days });
  }
  ...
  async getExpiringAMC(days: number = 30): Promise<ApiResponse<{
    ...
    return apiClient.get<unknown>('/user-products/expiring-amc', { days });
  }
  ...
  async registerProduct(
    ...
    return apiClient.post<unknown>(`/user-products/${productId}/register`, data as unknown);
  }
  ...
  async scheduleInstallation(
    ...
    return apiClient.post<unknown>(`/user-products/${productId}/schedule-installation`, data as unknown);
  }
  ...
  async renewAMC(
    ...
    return apiClient.post<unknown>(`/user-products/${productId}/renew-amc`, data as unknown);
  }
  ...
  async getWarrantyDetails(productId: string): Promise<ApiResponse<{
    ...
    return apiClient.get<unknown>(`/user-products/${productId}/warranty`);
  }
  ...
  async getAMCDetails(productId: string): Promise<ApiResponse<{
    ...
    return apiClient.get<unknown>(`/user-products/${productId}/amc`);
  }
  ...
  async createServiceRequest(
    ...
    return apiClient.post<unknown>('/user-products/service-requests', data as unknown);
  }
  ...
  async getServiceRequests(
    ...
    return apiClient.get<unknown>('/user-products/service-requests', filters as unknown);
  }
  ...
  async getActiveServiceRequests(): Promise<ApiResponse<{
    ...
    return apiClient.get<unknown>('/user-products/service-requests/active');
  }
  ...
  async getServiceRequestDetails(
    ...
    return apiClient.get<unknown>(`/user-products/service-requests/${requestId}`);
  }
  ...
  async cancelServiceRequest(
    ...
    return apiClient.post<unknown>(`/user-products/service-requests/${requestId}/cancel`, { reason });
  }
  ...
  async rescheduleServiceRequest(
    ...
    return apiClient.post<unknown>(`/user-products/service-requests/${requestId}/reschedule`, data as unknown);
  }
  ...
  async rateServiceRequest(
    ...
    return apiClient.post<unknown>(`/user-products/service-requests/${requestId}/rate`, data as unknown);
  }
}

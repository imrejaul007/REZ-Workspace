...
export const useAnalytics = () => {
    ...
    try {
      ...
      const enrichedEventData = {
        ...
        location: currentLocation ? {
          ...
          address: typeof currentLocation.address === 'string' ? currentLocation.address : (currentLocation.address as unknown)?.city || undefined
        } : undefined
      };
  ...
  const trackStoreClick = useCallback((storeId: string, source: string, metadata?) => {

...
export function useReorder(): UseReorderReturn {
  ...
  const validateReorder = useCallback(async (
    ...
    try {
      ...
      const response: unknown = await reorderService.validateReorder(orderId, itemIds);
  ...
  const reorderFull = useCallback(async (orderId: string): Promise<boolean> => {
    try {
      ...
      const response: unknown = await reorderService.reorderFullOrder(orderId);
  ...
  const reorderSelected = useCallback(async (
    ...
    try {
      ...
      const response: unknown = await reorderService.reorderSelectedItems(orderId, itemIds);
...
export function useFrequentlyOrdered(limit: number = 10): UseFrequentlyOrderedReturn {
  ...
  const refresh = useCallback(async () => {
    try {
      ...
      const response: unknown = await reorderService.getFrequentlyOrdered(limit);
...
export function useReorderSuggestions(): UseReorderSuggestionsReturn {
  ...
  const refresh = useCallback(async () => {
    try {
      ...
      const response: unknown = await reorderService.getReorderSuggestions();

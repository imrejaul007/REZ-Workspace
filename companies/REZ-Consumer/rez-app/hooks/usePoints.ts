...
export function usePoints(options: UsePointsOptions = {}): UsePointsReturn {
  ...
  const fetchBalance = useCallback(async (showLoading = true) => {
    try {
      ...
      const response: unknown = await pointsApi.getBalance();
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      const response: unknown = await pointsApi.getStats();
  ...
  const fetchTransactions = useCallback(
    async (page = 1, append = false) => {
      try {
        ...
        const response: unknown = await pointsApi.getTransactions(page, 20);
  ...
  const earnPoints = useCallback(
    async (data: EarnPointsRequest): Promise<boolean> => {
      try {
        ...
        const response: unknown = await pointsApi.earnPoints(data);
  ...
  const spendPoints = useCallback(
    async (data: SpendPointsRequest): Promise<boolean> => {
      try {
        ...
        const response: unknown = await pointsApi.spendPoints(data);
  ...
  const claimPendingPoints = useCallback(async (): Promise<boolean> => {
    try {
      ...
      const response: unknown = await pointsApi.claimPendingPoints();

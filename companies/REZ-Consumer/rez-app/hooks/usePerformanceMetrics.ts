...
export interface UsePerformanceMetricsResult {
  trackInteraction: (name: string, metadata?: Record<string, unknown>) => () => void;
  trackCustomMetric: (name: string, metadata?: Record<string, unknown>) => () => void;
...
export function usePerformanceMetrics(
  ...
  const trackInteractionCallback = useCallback(
    (name: string, metadata?: Record<string, unknown>): (() => void) => {

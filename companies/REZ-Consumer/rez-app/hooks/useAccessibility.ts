...
export const useAccessibility = (
  ...
  // Refs
  const screenReaderListenerRef = useRef<unknown>(null);
  const reduceMotionListenerRef = useRef<unknown>(null);
  const reduceTransparencyListenerRef = useRef<unknown>(null);

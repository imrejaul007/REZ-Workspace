...
export const useSafeNavigation = () => {
  ...
  return {
    ...
    // Guards
    addGuard: (guard) => navigationService.addGuard(guard),
    removeGuard: (guard) => navigationService.removeGuard(guard),

    // Events
    addEventListener: (event: NavigationEvent, handler) =>
      navigationService.addEventListener(event, handler),
    removeEventListener: (event: NavigationEvent, handler) =>

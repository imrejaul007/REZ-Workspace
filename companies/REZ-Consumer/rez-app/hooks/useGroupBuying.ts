...
export function useGroupBuying() {
  ...
  const createGroup = async (data: CreateGroupRequest): Promise<GroupBuyingGroup | null> => {
    ...
    try {
      const response: unknown = await groupBuyingApi.createGroup(data);
  ...
  const joinGroup = async (data: JoinGroupRequest): Promise<GroupBuyingGroup | null> => {
    ...
    try {
      const response: unknown = await groupBuyingApi.joinGroup(data);
  ...
  const leaveGroup = async (groupId: string): Promise<boolean> => {
    ...
    try {
      const response: unknown = await groupBuyingApi.leaveGroup(groupId);
  ...
  const sendMessage = async (groupId: string, message: string): Promise<boolean> => {
    try {
      ...
      const response: unknown = await groupBuyingApi.sendMessage(groupId, message);
  ...
  const getGroupDetails = async (groupId: string): Promise<GroupBuyingGroup | null> => {
    ...
    try {
      const response: unknown = await groupBuyingApi.getGroup(groupId);
  ...
  const getGroupByCode = async (code: string): Promise<GroupBuyingGroup | null> => {
    ...
    try {
      const response: unknown = await groupBuyingApi.getGroupByCode(code);
  ...
  const checkout = async (data: GroupCheckoutRequest): Promise<{ orderId: string; paymentUrl?: string } | null> => {
    ...
    try {
      const response: unknown = await groupBuyingApi.checkout(data);
  ...
  const refreshAvailableGroups = async (filters?: GroupBuyingFilters) => {
    try {
      const response: unknown = await groupBuyingApi.getAvailableGroups(filters);
  ...
  const refreshMyGroups = async () => {
    try {
      const response: unknown = await groupBuyingApi.getMyGroups();

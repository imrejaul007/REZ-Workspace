...
export function useStockNotifications() {
  ...
  const subscribe = useCallback(
    async (
      ...
      try {
        const response: unknown = await stockNotificationApi.subscribe({
          productId,
          method
        });
  ...
  const unsubscribe = useCallback(
    async (
      ...
      try {
        const response: unknown = await stockNotificationApi.unsubscribe({ productId });
  ...
  const fetchSubscriptions = useCallback(
    async (status?: 'pending' | 'sent' | 'cancelled') => {
      ...
      try {
        const response: unknown = await stockNotificationApi.getMySubscriptions(status);
  ...
  const isSubscribed = useCallback(
    async (productId: string): Promise<boolean> => {
      try {
        const response: unknown = await stockNotificationApi.checkSubscription(productId);
  ...
  const deleteSubscription = useCallback(
    async (
      ...
      try {
        const response: unknown = await stockNotificationApi.deleteSubscription(notificationId);

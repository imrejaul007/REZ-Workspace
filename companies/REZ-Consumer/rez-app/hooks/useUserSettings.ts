...
export const useUserSettings = (autoFetch: boolean = true): UseUserSettingsReturn => {
  ...
  const fetchSettings = useCallback(async () => {
    ...
    try {
      const response: unknown = await userSettingsApi.getUserSettings();
  ...
  const updateGeneralSettings = useCallback(
    async (data: Partial<GeneralSettings>): Promise<UserSettings | null> => {
      ...
      try {
        const response: unknown = await userSettingsApi.updateGeneralSettings(data);
  ...
  const updateNotifications = useCallback(
    async (data: Partial<NotificationPreferences>): Promise<UserSettings | null> => {
      ...
      try {
        const response: unknown = await userSettingsApi.updateNotificationPreferences(data);
  ...
  const updatePrivacy = useCallback(
    async (data: Partial<PrivacySettings>): Promise<UserSettings | null> => {
      ...
      try {
        const response: unknown = await userSettingsApi.updatePrivacySettings(data);
  ...
  const updateSecurity = useCallback(
    async (data: Partial<SecuritySettings>): Promise<UserSettings | null> => {
      ...
      try {
        const response: unknown = await userSettingsApi.updateSecuritySettings(data);
  ...
  const updateDelivery = useCallback(
    async (data: Partial<DeliveryPreferences>): Promise<UserSettings | null> => {
      ...
      try {
        const response: unknown = await userSettingsApi.updateDeliveryPreferences(data);
  ...
  const updatePayment = useCallback(
    async (data: Partial<PaymentPreferences>): Promise<UserSettings | null> => {
      ...
      try {
        const response: unknown = await userSettingsApi.updatePaymentPreferences(data);
  ...
  const updateAppPreferences = useCallback(
    async (data: Partial<AppPreferences>): Promise<UserSettings | null> => {
      ...
      try {
        const response: unknown = await userSettingsApi.updateAppPreferences(data);
  ...
  const resetSettings = useCallback(async (): Promise<UserSettings | null> => {
    ...
    try {
      const response: unknown = await userSettingsApi.resetSettings();

...
export const useAchievements = (autoFetch: boolean = true): UseAchievementsReturn => {
  ...
  const fetchAchievements = useCallback(async () => {
    ...
    try {
      const response: unknown = await achievementApi.getUserAchievements();
  ...
  const fetchProgress = useCallback(async () => {
    ...
    try {
      const response: unknown = await achievementApi.getAchievementProgress();
  ...
  const getUnlockedAchievements = useCallback(async (): Promise<Achievement[]> => {
    ...
    try {
      const response: unknown = await achievementApi.getUnlockedAchievements();
  ...
  const initializeAchievements = useCallback(async (): Promise<boolean> => {
    ...
    try {
      const response: unknown = await achievementApi.initializeUserAchievements();
  ...
  const recalculateAchievements = useCallback(async (): Promise<boolean> => {
    ...
    try {
      const response: unknown = await achievementApi.recalculateAchievements();

...
export const useActivities = ({
  ...
  const fetchActivities = useCallback(
    async (page: number = currentPage, limit: number = currentLimit, type?: ActivityType) => {
      ...
      try {
        const response: unknown = await activityApi.getUserActivities(page, limit, type);
  ...
  const fetchSummary = useCallback(async () => {
    ...
    try {
      const response: unknown = await activityApi.getActivitySummary();
  ...
  const createActivity = useCallback(
    async (data: ActivityCreate): Promise<Activity | null> => {
      ...
      try {
        const response: unknown = await activityApi.createActivity(data);
  ...
  const batchCreateActivities = useCallback(
    async (activitiesData: ActivityCreate[]): Promise<Activity[] | null> => {
      ...
      try {
        const response: unknown = await activityApi.batchCreateActivities(activitiesData);
  ...
  const deleteActivity = useCallback(
    async (id: string): Promise<boolean> => {
      ...
      try {
        const response: unknown = await activityApi.deleteActivity(id);
  ...
  const clearAllActivities = useCallback(async (): Promise<boolean> => {
    ...
    try {
      const response: unknown = await activityApi.clearAllActivities();

...
export const queryKeys = {
  ...
  reviews: {
    ...
    byStore: (storeId: string, filters?: Record<string, unknown>) => ['reviews', 'store', storeId, filters] as const,
  ...
  leaderboard: {
    ...
    list: (type?: string, filters?: Record<string, unknown>) => ['leaderboard', 'list', type, filters] as const,
  ...
  explore: {
    ...
    deals: (filters?: Record<string, unknown>) => ['explore', 'deals', filters] as const,
  ...
  stores: {
    ...
    search: (query: string, filters?: Record<string, unknown>) => ['stores', 'search', query, filters] as const,
    ...
    reviews: (storeId: string, filters?: Record<string, unknown>) => ['stores', 'reviews', storeId, filters] as const,
    products: (storeId: string, filters?: Record<string, unknown>) => ['stores', 'products', storeId, filters] as const,
  },
  ...
  products: {
    ...
    search: (query: string, filters?: Record<string, unknown>) => ['products', 'search', query, filters] as const,
  ...
  gamification: {
    ...
    achievements: (filters?: Record<string, unknown>) => ['gamification', 'achievements', filters] as const,
  ...
  wallet: {
    ...
    transactions: (filters?: Record<string, unknown>) => ['wallet', 'transactions', filters] as const,
  ...
  prive: {
    ...
    offers: (filters?: Record<string, unknown>) => ['prive', 'offers', filters] as const,

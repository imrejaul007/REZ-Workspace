  ...
  const getBadgeConfig = () => {
    switch (tier) {
      ...
      case 'entry':
        return {
          label: 'ENTRY',
          colors: [COLORS.gold, (COLORS as unknown).goldDark] as const,
  ...
  return (
    <Pressable style={styles.pillarCard} onPress={onPress}>
      ...
      <View style={styles.pillarProgressBg}>
        <Animated.View
          style={[styles.pillarProgressFill, { width: progressWidth, backgroundColor: pillar.color }] as unknown}
        />
      </View>
      ...
      >
        ...
        {eligibility.isEligible && (
          <Pressable style={styles.ctaButton} onPress={() => router.push('/(tabs)')}>
            <LinearGradient colors={[COLORS.gold, (COLORS as unknown).goldDark]} style={styles.ctaGradient}>
...
const styles = StyleSheet.create({
  ...
  markerDotActive: {
    backgroundColor: COLORS.gold,
    borderColor: (COLORS as unknown).goldDark,
  },
  markerDotElite: {

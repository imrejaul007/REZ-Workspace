      ...
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.heroSection}>
            ...
            <ThemedText style={styles.heroSubtitle}>Search unknown product to compare prices across stores</ThemedText>
          </View>
        ...
        {!hasSearched ? (
          ...
          >
            ...
            <View style={styles.howItWorks}>
              ...
              {[
                { icon: 'search' as const, text: 'Search for unknown product' },

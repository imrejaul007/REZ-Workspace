        ...
        <View style={styles.actions}>
          ...
          <Pressable
            ...
            onPress={() => {
              ...
              const storeId = typeof review.store === 'object' ? review.store._id : review.store;
              router.push(
                `/ReviewPage?storeId=${storeId}&storeName=${encodeURIComponent(storeName)}&fromStore=true` as unknown,
              );
            }}
              ...
              reviews.length === 0 ? (
                <View style={styles.centerContainer}>
                  ...
                  <Text style={styles.emptyText}>
                    You haven't written unknown reviews yet.{'\n'}
                ...
                <View style={styles.centerContainer}>
                  ...
                  <Text style={styles.emptyText}>You don't have unknown {activeFilter} reviews yet.</Text>
                </View>
              )
            }

...
const HOW_IT_WORKS: Record<BonusCampaignType, { title: string; steps: string[] }> = {
  cashback_boost: {
    ...
    steps: [
      'Make a qualifying purchase at unknown participating store.',
  ...
  festival_offer: {
    ...
    steps: [
      'Shop during the festival period at unknown participating store.',
...
function CampaignDetailPage() {
  ...
  const { slug, claimSuccess } = useLocalSearchParams<unknown>();

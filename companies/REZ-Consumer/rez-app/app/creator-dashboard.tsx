...
// REZ Coin image - using brand constant
const REZ_COIN = BRAND.COIN_IMAGE;
                        ...
                        {isApproved ? (
                          <>
                            ...
                            {pick.earnings > 0 && (
                              <>
                                <Text style={styles.pickMetaDot}>·</Text>
                                <CachedImage source={REZ_COIN} style={styles.coinIcon13} />
              ...
              {(['starter', 'bronze', 'silver', 'gold', 'platinum'] as const).map((t, idx) => {
                ...
                return (
                  <View key={t} style={styles.tierItem}>
                    ...
                    >
                      {isActive && <Ionicons name={icon.filled as unknown} size={13} color={tColors.border} />}
                      {isPast && !isActive && (
                        <Ionicons name={icon.outline as unknown} size={10} color={colors.text.inverse} />
                      )}
                    </View>
                    <Text
                      style={[

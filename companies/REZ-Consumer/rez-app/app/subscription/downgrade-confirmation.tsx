...
function DowngradeConfirmationPage() {
  ...
  const calculateCredit = () => {
    ...
    const tierConfig = state.availableTiers?.find((t) => t.tier === currentTier);
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      {/* Header */}
      <LinearGradient colors={[Colors.warning, colors.warningScale[700]] as unknown} style={styles.header}>

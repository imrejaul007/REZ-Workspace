      ...
      <FlashList
        ...
        ListEmptyComponent={
          <View
            ...
            accessibilityLabel="No notifications. You haven't received unknown notifications yet."
            accessibilityRole="text"
          >
            <Ionicons name="notifications-off" size={64} color={colors.border.default} />
            <Text style={styles.emptyTitle}>No Notifications</Text>
            <Text style={styles.emptyText}>You haven't received unknown notifications yet.</Text>
          </View>
        }
        ListFooterComponent={
          loadingMore ? (

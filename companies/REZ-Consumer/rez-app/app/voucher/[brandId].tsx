...
function BrandDetailPage() {
    ...
    >
      ...
      <View style={styles.headerContent}>
        ...
        <View style={styles.headerActions}>
          <Pressable style={styles.glassButton} onPress={handleShare}>
            <Ionicons name="share-outline" size={20} color={colors.text.inverse} />
          </Pressable>

          <Pressable style={[styles.glassButton, isFavorite ? styles.favoriteActive : null]} onPress={handleFavorite}>
            <Ionicons
  ...
  const renderStats = () => (
    ...
    >
      {/* Rating Card */}
      <View style={[styles.statCard, Platform.OS === 'web' && { boxShadow: '0 8px 32px rgba(0, 0, 0, 0.08)' }]}>
        ...
        <View style={styles.statRow}>
          ...
          <View style={styles.statContent}>
            ...
            <ThemedText style={styles.statSubtext}>by {brand?.reviewCount || '8.8k+ users'}</ThemedText>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.statCard, Platform.OS === 'web' && { boxShadow: '0 8px 32px rgba(0, 0, 0, 0.08)' }]}>
        ...
        <View style={styles.statRow}>
          ...
          <View style={styles.statContent}>
            <ThemedText style={styles.statValue}>55 lakh+ Rewards</ThemedText>
            <ThemedText style={styles.statSubtext}>given in last month</ThemedText>
          </View>
        </View>
      </View>
    </Animated.View>
  ...
  const renderNoticeCard = () => (
    ...
    >
      <View style={[styles.noticeCard, Platform.OS === 'web' && { boxShadow: '0 4px 20px rgba(0, 192, 106, 0.1)' }]}>
        <LinearGradient
  ...
  const renderActionButton = () => (
    ...
    >
      <Pressable style={styles.rewardButton} onPress={() => setShowPurchaseModal(true)}>
        <LinearGradient
        ...
        >
          ...
          <View style={styles.rewardButtonContent}>
            ...
            <ThemedText style={styles.rewardButtonText}>Earn up to {brand?.cashbackRate || 12}% Reward</ThemedText>
      ...
      <View style={styles.timelineContainer}>
        ...
        <View style={styles.timelineStep}>
          <View style={styles.timelineStepNumber}>
            <LinearGradient colors={[Colors.gold, colors.nileBlue]} style={styles.stepNumberGradient}>
        ...
        <View style={styles.timelineStep}>
          <View style={styles.timelineStepNumber}>
            <LinearGradient colors={[Colors.gold, Colors.warning]} style={styles.stepNumberGradient}>
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <LinearGradient colors={[Colors.gold, colors.nileBlue]} style={styles.loadingHeader}>
          <View style={styles.headerContent}>
            <Pressable
              style={styles.glassButton}
              onPress={() => (router.canGoBack() ? router.back() : router.replace('/(tabs)'))}
      ...
      <View style={styles.errorContainer}>
        ...
        <View style={styles.errorContent}>
          ...
          <Pressable onPress={() => (router.canGoBack() ? router.back() : router.replace('/(tabs)'))}>
            <LinearGradient colors={[Colors.gold, colors.nileBlue]} style={styles.backButton}>

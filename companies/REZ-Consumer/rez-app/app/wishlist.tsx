...
function WishlistPage() {
  ...
  const isPopulated = (itemId): boolean => {
  ...
  const convertWishlistItem = (apiItem, index: number, wishlistId: string): WishlistItem => {
  ...
  const convertWishlist = (apiWishlist): WishlistData => {
    ...
    const rawItems = Array.isArray(apiWishlist.items)
      ? apiWishlist.items.map((item, index: number) => convertWishlistItem(item, index, wishlistId))
      : [];

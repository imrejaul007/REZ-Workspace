...
function GiftPage() {
  ...
  const senderName = (user as unknown)?.fullName || user?.phoneNumber || 'You';
  ...
  const handleSendGift = async () => {
    ...
    try {
      ...
      if (response.data) {
        ...
        await refreshWallet();
        const newBalance = (response.data as unknown).newBalance ?? walletBalance - Number(amount);
        if (!isMounted()) return;
        setSuccessData({
      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.successContainer}>
          ...
          <View style={styles.successCardWrapper}>
            <LinearGradient colors={successData.theme.colors as unknown} style={styles.successGiftCard}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.themesGrid}>
              {themes.map((theme) => (
                ...
                >
                  <LinearGradient colors={theme.colors as unknown} style={styles.themeGradient}>
          ...
          {showPreview && (
            <View style={styles.previewCard}>
              <LinearGradient colors={selectedTheme.colors as unknown} style={styles.previewGradient}>

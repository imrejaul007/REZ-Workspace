 ...
 */
function mapCoin(raw, index: number): ExpiringCoin {
    ...
    <View key={coin.id} style={styles.coinCard}>
      <View style={styles.coinCardHeader}>
        <View style={styles.coinTypeIcon}>
          <Ionicons name={getCoinIcon(coin.coinType) as unknown} size={20} color={Colors.primary[600]} />
        </View>
      ...
      <View style={styles.progressBar}>
        <View
          style={[
            styles.progressFill,
            {
              width: getProgressWidth(coin.daysLeft) as unknown,
      ...
      >
        ...
        {!loading && !error && totalExpiringSoon > 0 && (
          <View style={styles.alertBanner}>
            ...
            <Pressable style={styles.useNowButton} onPress={() => router.push('/(tabs)' as unknown)}>

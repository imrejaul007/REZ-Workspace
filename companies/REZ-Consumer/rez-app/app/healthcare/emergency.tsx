...
const styles = StyleSheet.create({
  ...
  quickCallNumber: { ...Typography.bodyLarge, fontWeight: '800', color: (COLORS as unknown).navy },
  ...
  sectionTitle: { ...Typography.h4, fontWeight: '700', color: (COLORS as unknown).navy, marginBottom: Spacing.md },
  ...
  contactInfo: { flex: 1 },
  contactName: { ...Typography.body, fontWeight: '600', color: (COLORS as unknown).navy },
  ...
  tipTitle: { ...Typography.bodySmall, fontWeight: '600', color: (COLORS as unknown).navy },
  ...
  modalTitle: { ...Typography.h4, fontWeight: '700', color: (COLORS as unknown).navy },
  ...
  formLabel: { ...Typography.bodySmall, fontWeight: '600', color: (COLORS as unknown).navy, marginBottom: Spacing.sm },
  formInput: {
    borderWidth: 1,
    borderColor: COLORS.gray200,
    borderRadius: BorderRadius.md,

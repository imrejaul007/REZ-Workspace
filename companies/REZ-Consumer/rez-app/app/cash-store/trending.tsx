...
function transformBrand(b): TransformedBrand {
  return {
    _id: b._id,
    name: b.name || '',
    logo: b.logo || '',
...
function transformOffer(o): TransformedOffer {
  return {
    _id: o._id || o.id,
        ...
        >
          ...
          {badgeInfo && (
            <View style={[styles.offerBadge, { backgroundColor: badgeInfo.bg }]}>
              <Ionicons name={badgeInfo.icon as unknown} size={8} color={badgeInfo.text} />

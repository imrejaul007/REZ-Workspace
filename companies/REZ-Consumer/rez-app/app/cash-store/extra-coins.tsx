...
import gamificationApi, { StreakData } from '../../services/gamificationApi';
...
const EARN_METHODS = [
  {
    ...
    coins: '10-500',
    gradient: [colors.brand.purple, colors.brand.purpleMedium] as [string, string],
    route: '/play-and-earn',
  },
  {
    id: 'quiz',
    ...
    desc: 'Answer & earn',
    coins: '5-50',
    gradient: [colors.deepPink, colors.brand.pink] as [string, string],
    route: '/play-and-earn',
  },
  {
    id: 'review',
    ...
    coins: '20-100',
    gradient: [colors.warningScale[700], colors.warningScale[400]] as [string, string],
    route: '/explore',
  },
  {
    id: 'refer',
    ...
    title: 'Refer Friends',
    desc: 'Invite & both earn',
    coins: '100+',
    gradient: [colors.successScale[700], colors.successScale[400]] as [string, string],
  ...
  },
  {
    ...
    coins: '50+',
    gradient: [colors.brand.blue, colors.infoScale[400]] as [string, string],
    route: '/play-and-earn',
  },
  {
    id: 'shop',
    ...
    title: 'Shop & Earn',
    desc: 'Auto 5% on purchases',
    coins: '5%',
    gradient: ['#C2410C', colors.brand.orangeDark] as [string, string],
    route: '/cash-store',
  },
];
...
function ExtraCoinsPage() {
  ...
  const hasContent =
    coinBalance > 0 || streak !== null || campaigns.length > 0 || coinDrops.length > 0 || bonusCampaigns.length > 0;
        ...
        <LinearGradient colors={['#0F172A', '#1E293B']} style={[styles.skeletonHero, { paddingTop: headerTop + 16 }]}>
          ...
          <View style={{ alignItems: 'center', paddingVertical: 30 }}>
            <SkeletonBlock
              width={60}
              height={60}
              style={{ borderRadius: 30, backgroundColor: 'rgba(255,205,87,0.15)' }}
              index={0}
            />
            <SkeletonBlock
              width={160}
              height={14}
              style={{ marginTop: 14, backgroundColor: 'rgba(255,255,255,0.08)' }}
              index={1}
            />
            <SkeletonBlock
              width={120}
              height={40}
              style={{ marginTop: 8, backgroundColor: 'rgba(255,255,255,0.12)' }}
              index={2}
            />
          </View>
        </LinearGradient>
        ...
        >
          ...
          <View style={styles.balanceContainer}>
            <View style={styles.coinIconOuter}>
              <GlowRing />
              <LinearGradient colors={[Colors.gold, colors.warningScale[400]]} style={styles.coinIconInner}>
                <Ionicons name="wallet" size={26} color="#0F172A" />
              </LinearGradient>
            </View>

            <Text style={styles.balanceLabel}>YOUR REZ COINS</Text>
            <Text style={styles.balanceAmount}>{coinBalance.toLocaleString()}</Text>

            <View style={styles.balanceChips}>
              <View style={styles.balanceChip}>
                <Ionicons name="trending-up" size={12} color={Colors.success} />
                <Text style={styles.balanceChipText}>{lifetimeEarned.toLocaleString()} lifetime</Text>
              </View>
              <View style={styles.balanceChipDivider} />
              <View style={styles.balanceChip}>
                <Ionicons name="flame" size={12} color={Colors.warning} />
                <Text style={styles.balanceChipText}>{streak?.currentStreak || 0} day streak</Text>
              </View>
            </View>
          </View>
                ...
                <LinearGradient
                  colors={
                    streak.hasCheckedInToday
                      ? [colors.successScale[700], colors.successScale[400]]
                      : [Colors.gold, colors.warningScale[400]]
                  }
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
                      ...
                      >
                        ...
                        <View style={styles.boostTopRow}>
                          ...
                          <View style={[styles.boostTimePill, isEnded ? styles.boostTimePillEnded : null]}>
                            <Ionicons
                              name="time-outline"
                              size={11}
                              color={isEnded ? '#FCA5A5' : 'rgba(255,255,255,0.85)'}
                            />
                        ...
                        <View style={styles.boostFooter}>
                          <View style={styles.boostStoreChip}>
                            ...
                            <Text style={styles.boostStoreText}>{campaign.eligibleStores?.length || 0} stores</Text>
                          </View>
            ...
            <View style={styles.section}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: Spacing.md }}>
                {coinDrops.map((drop) => {
                  ...
                  return (
                    <Pressable key={drop._id} style={styles.dropCard} onPress={() => handleCoinDropPress(drop)}>
                      <View style={styles.dropHeader}>
                        <LinearGradient
                          colors={[colors.brand.purple, colors.brand.purpleMedium]}
              ...
              {[
                {
                  ...
                  title: 'Shop or Play',
                  text: 'Visit partner stores, play games, or complete activities',
                },
                {
                  step: '2',
                  icon: 'flash-outline' as const,
                  title: 'Earn Automatically',
                  text: 'Coins are credited instantly to your wallet',
                },
                {
                  step: '3',
                  icon: 'gift-outline' as const,
                  title: 'Redeem Rewards',
                  text: 'Use coins for discounts, gift cards & exclusive deals',
                },
              ].map((item, i) => (

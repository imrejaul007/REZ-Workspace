...
describe('ReferralQRModal', () => {
  ...
  describe('Close Functionality', () => {
    test('calls onClose when close button is pressed', () => {
      ...
      const touchables = UNSAFE_getAllByType('TouchableOpacity' as unknown);
    ...
    test('Instagram alert provides download option', async () => {
      ...
      jest.spyOn(Alert, 'alert').mockImplementation((title, message, buttons) => {
        if (buttons && Array.isArray(buttons)) {
          const downloadButton = buttons.find((b) => b.text === 'Download QR');
  ...
  describe('Info Card', () => {
    ...
    test('info card has visual indicator icon', () => {
      ...
      const icons = UNSAFE_getAllByType('Ionicons' as unknown);

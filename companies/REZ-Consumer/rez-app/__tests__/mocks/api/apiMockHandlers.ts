...
export const authMockHandlers = {
  ...
  updateProfile: (token: string, updates) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',
...
export const cartMockHandlers = {
  ...
  addToCart: (token: string, productId: string, quantity: number = 1, variant?) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',
  ...
  updateCartItem: (token: string, productId: string, updates, variant?) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',
  ...
  removeCartItem: (token: string, productId: string, variant?) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',
...
export const orderMockHandlers = {
  createOrder: (token: string, orderData) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',
...
export const ugcMockHandlers = {
  ...
  uploadUGC: (token: string, ugcData) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',
...
export const storeMockHandlers = {
  getStores: (token: string, filters?) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',
...
export const productMockHandlers = {
  getProducts: (token: string, filters?) => {
    if (!isAuthenticated(token)) {
      return {
        success: false,
        error: 'Unauthorized',

...
describe('Privacy Utilities', () => {
  ...
  describe('anonymizeEmail', () => {
    ...
    test('handles non-string input', () => {
      const result = anonymizeEmail(12345 as unknown);
      expect(result).toBe('N/A');
    });
  ...
  describe('anonymizePhone', () => {
    ...
    test('handles non-string phone input', () => {
      const result = anonymizePhone(9876543210 as unknown);
      expect(result).toBe('N/A');
    });
  });
  ...
  describe('getPrivacySafeText', () => {
    ...
    test('returns N/A for invalid type', () => {
      const result = getPrivacySafeText('test', 'invalid' as unknown);
      expect(result).toBe('N/A');
    });
  });
  ...
  describe('logPrivacyEvent', () => {
    test('logs privacy event in development mode', () => {
      ...
      const originalDev = (global as unknown).__DEV__;
      (global as unknown).__DEV__ = true;
      ...
      (global as unknown).__DEV__ = originalDev;
    });

 ...
 */
export const createMockProduct = (overrides: unknown = {}) => ({
 ...
 * Generate mock order
 */
export const createMockOrder = (overrides: unknown = {}) => ({
 ...
 */
export const createMockAddress = (overrides: unknown = {}) => ({
 ...
 */
export const createMockCartItem = (overrides: unknown = {}) => {
 ...
 */
export const createMockReview = (overrides: unknown = {}) => ({
...
export const extendMatchers = () => {
  expect.extend({
     ...
     */
    toContainObjectMatching(received: unknown[], expected) {

 ...
 */
export const getReadingOrder = (container): string[] => {
 ...
 */
export const validateTouchTargetSize = (element): TouchTargetValidation => {
 ...
 */
export const validateInteractiveTouchTarget = (element): A11yTestResult => {
  const errors: string[] = [];
  const warnings: string[] = [];
 ...
 */
const extractColor = (style, property: 'color' | 'backgroundColor'): string | null => {
 ...
 */
export const validateTextContrast = (element): A11yTestResult => {
  const errors: string[] = [];
  const warnings: string[] = [];
 ...
 */
export const validateFormInput = (element): A11yTestResult => {
  const errors: string[] = [];
  const warnings: string[] = [];
 ...
 */
export const validateModalAccessibility = (modal): A11yTestResult => {
  const errors: string[] = [];
  const warnings: string[] = [];
...
export const customA11yMatchers = {
  ...
  toHaveAccessibilityRole(element, expectedRole: string) {
  ...
  toHaveAccessibilityLabel(element, expectedLabel?: string) {

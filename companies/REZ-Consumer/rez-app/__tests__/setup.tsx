 ...
 */
export const MockAuthProvider: React.FC<{ children: React.ReactNode; value?: unknown }> = ({
  children,
  value = {
    user: {
      id: 'test-user-id',
 ...
 */
export const MockCartProvider: React.FC<{ children: React.ReactNode; value?: unknown }> = ({
  children,
  value = {
    items: [],
    addToCart: jest.fn(),
 ...
 */
export const MockWishlistProvider: React.FC<{ children: React.ReactNode; value?: unknown }> = ({
  children,
  value = {
    items: [],
 ...
 */
export const MockToastProvider: React.FC<{ children: React.ReactNode; value?: unknown }> = ({
  children,
  value = {
    showToast: jest.fn(),
    hideToast: jest.fn(),
 ...
 */
export const createMockVariant = (overrides?) => ({
  _id: 'variant-123',
 ...
 * Create mock route
 */
export const createMockRoute = (params: unknown = {}) => ({
  key: 'test-route',
  name: 'TestScreen',
  params,
});
 ...
 */
export const expectVisible = (element) => {
 ...
 */
export const expectNotVisible = (element) => {
  if (element) {

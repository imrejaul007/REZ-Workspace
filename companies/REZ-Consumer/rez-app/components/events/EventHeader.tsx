...
const EventHeader = React.memo(function EventHeader({
  ...
  return (
    <View style={[styles.heroSection, { height: heroHeight }]}>
      {!imageError ? (
        <ImageBackground
          source={{ uri: eventDetails.image } as unknown}
          style={styles.heroBackground}
          {...({ contentFit: "cover" } as unknown)}
          onLoad={onImageLoad}
          ...
          >
            ...
            <View style={[styles.heroContent, { paddingHorizontal: HORIZONTAL_PADDING }]}>
              <View style={[styles.categoryBadge, { backgroundColor: categoryTheme.badgeBackground }]}>
                <Ionicons name={categoryTheme.icon as unknown} size={14} color={colors.background.primary} style={{ marginRight: 6 }} />

...
export interface BillUploadHookReturn {
  ...
  amountInputRef: React.RefObject<unknown>;
  billNumberInputRef: React.RefObject<unknown>;
  notesInputRef: React.RefObject<unknown>;
  scrollViewRef: React.RefObject<unknown>;

  // Handlers
  handleFieldChange: (fieldName: keyof FormData, value) => void;

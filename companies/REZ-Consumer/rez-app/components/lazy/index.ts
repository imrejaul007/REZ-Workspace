...
// Fallback component type for failed imports
type LazyFallback = ComponentType<object>;
...
export const LazyCombinedSection78 = lazy(() =>
  import('@/app/StoreSection/CombinedSection78').catch((): { default: LazyFallback } => ({
    default: (() => null) as LazyFallback
  }))
);
...
export const LazySection6 = lazy(() =>
  import('@/app/StoreSection/Section6').catch((): { default: LazyFallback } => ({
    default: (() => null) as LazyFallback
  }))
);
...
export const LazyCategoryRecommendationsGrid = lazy(() =>
  import('@/components/homepage/CategoryRecommendationsGrid').catch((): { default: LazyFallback } => ({
    default: (() => null) as LazyFallback
  }))
);

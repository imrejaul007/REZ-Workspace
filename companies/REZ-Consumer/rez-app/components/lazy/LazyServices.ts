...
export const lazyUnifiedImageService = () =>
  import('@/services/unifiedImageService').then((module) => module.default || module);

// Legacy exports (for backward compatibility - redirects to unified service)
...
export async function preloadCriticalServices(): Promise<void> {
  const criticalServices: Promise<unknown>[] = [

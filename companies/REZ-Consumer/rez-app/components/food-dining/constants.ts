...
export interface FoodRestaurant {
  ...
  operationalInfo?: { deliveryTime?: string; [key: string]: unknown };
  ...
  location?: { city?: string; coordinates?: { lat: number; lng: number }; [key: string]: unknown };
  distance?: number;
  isFeatured?: boolean;
  isActive?: boolean;
  hours?: { day: string; open: string; close: string; closed?: boolean }[];
  [key: string]; // Allow additional fields from backend
}

  ...
  const fetchReviews = useCallback(async () => {
    try {
      ...
      if (response.success && response.data) {
        const data = Array.isArray(response.data) ? response.data : (response.data as unknown)?.reviews || [];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.sectionHeader}>
        ...
        <Pressable
          onPress={() => router.push('/MainCategory/food-dining/food-stories' as unknown)}

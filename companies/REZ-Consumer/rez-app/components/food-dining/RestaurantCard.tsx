...
const RestaurantCard: React.FC<RestaurantCardProps> = ({
  ...
  return (
    <Pressable
      ...
      onPress={() => router.push(`/MainStorePage?storeId=${restaurant._id || restaurant.id}` as unknown)}
      ...
      <View style={styles.restaurantContent}>
        ...
        {userVisitCount > 0 && (
          <View style={styles.visitProgressRow}>
            ...
            {userVisitCount < visitMilestone && (
              <Pressable onPress={() => router.push('/my-visits' as unknown)}>
        ...
        {showReserveButton && (
          <Pressable
            ...
            onPress={(e) => {
              e.stopPropagation();
              router.push(`/MainCategory/food-dining/book-table?storeId=${restaurant._id || restaurant.id}` as unknown);
            }}

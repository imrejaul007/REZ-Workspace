  ...
  const handleBannerPress = (banner: { id: string }) => {
    switch (banner.id) {
      case '1': // Welcome — explore pillars
        router.push('/prive/pillars' as unknown);
        break;
      case '2': // Tier Progress
        router.push('/prive/tier-progress' as unknown);
        break;
      case '3': // Redeem
        router.push('/prive/redeem' as unknown);
        break;
    }
  };
    ...
    <View style={styles.outerContainer}>
      ...
      >
        ...
        <PriveOffersCarousel
          ...
          onViewAll={() => router.push('/prive/prive-offers' as unknown)}
        />

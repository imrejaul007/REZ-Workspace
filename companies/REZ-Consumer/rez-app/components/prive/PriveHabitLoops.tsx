...
const SkeletonBlock: React.FC<{ width: number | string; height: number; borderRadius?: number; style?: unknown }> = ({
  ...
  return (
    <Animated.View
      style={[
        { width: width as unknown, height, borderRadius, backgroundColor: PRIVE_COLORS.border.primary },
        shimmerStyle,
        style,
      ]}
    />

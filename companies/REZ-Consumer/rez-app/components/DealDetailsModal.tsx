  ...
  function renderContent() {
    return (
      <>
        ...
        {(deal as unknown).image && (
          <View style={styles.imageContainer}>
            <CachedImage
              source={(deal as unknown).image}
              style={styles.dealImage}
              contentFit="cover"
            />
            {/* Featured Badge */}
            {(deal as unknown).featured && (
              <View style={styles.featuredBadgeContainer}>
                <LinearGradient
                  colors={[COLORS.gold, (COLORS as unknown).goldDark]}
                  style={styles.featuredBadge}
                >
                  <Ionicons name="star" size={12} color={(COLORS as unknown).navy} />
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <LinearGradient
                ...
                style={styles.sectionIconContainer}
              >
                <Ionicons name="calculator" size={18} color={(COLORS as unknown).navy} />
              </LinearGradient>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <LinearGradient
                ...
                style={styles.sectionIconContainer}
              >
                <Ionicons name="help-circle-outline" size={18} color={(COLORS as unknown).navy} />
              </LinearGradient>

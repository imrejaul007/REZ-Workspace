    ...
    >
      <View style={styles.notificationContent}>
        <View style={[styles.notificationIcon, { backgroundColor: getNotificationColor(item.type) }]}>
          <Ionicons name={getNotificationIcon(item.type) as unknown} size={20} color="white" />
        </View>
    ...
    <View style={styles.settingItem}>
      <View style={styles.settingContent}>
        <View style={styles.settingIcon}>
          <Ionicons name={icon as unknown} size={20} color={colors.brand.ios} />
        </View>
...
const styles = StyleSheet.create({
  ...
  timestampText: {
    fontSize: 12,
    color: '#666666', // ACCESSIBILITY FIX: Changed from #999999 to #666666 for WCAG AA color contrast (4.5:1 ratio)
  },
  emptyState: {
    alignItems: 'center',
    padding: 40,

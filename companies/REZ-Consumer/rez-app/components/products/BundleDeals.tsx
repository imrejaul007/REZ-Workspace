...
const getProductImage = (product): string | null => {
...
const getProductId = (product): string => {
  return product.id || product._id || '';
};

// Helper function to get cashback percentage from product
const getCashbackPercentage = (product): number => {

...
export const SellerInformation: React.FC<SellerInformationProps> = ({
  ...
  const handleVisitStore = () => {
    if (onVisitStore) {
      ...
      router.push(`/StoreListPage?storeId=${storeId}` as unknown);
    }
  };
  ...
  const handleViewProducts = () => {
    if (onViewProducts) {
      ...
      router.push(`/StoreListPage?storeId=${storeId}&tab=products` as unknown);
    }
  };
  ...
  const handleContact = () => {
    if (onContact) {
      ...
      router.push(`/help/chat?storeId=${storeId}` as unknown);
    }
  };

    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.frequentlyBoughtContainer}>
            ...
            <ShimmerEffect width={100} height={100} style={[styles.productImageSkeleton, styles.marginLeft] as unknown} />
            <ShimmerEffect width={100} height={100} style={[styles.productImageSkeleton, styles.marginLeft] as unknown} />
          </View>
        </View>
      ...
      <View style={styles.actionBar}>
        ...
        <View style={styles.actionButtons}>
          ...
          <ShimmerEffect width={120} height={48} style={[styles.buyNowButton, styles.marginLeft] as unknown} />
        </View>
      </View>
    </SafeAreaView>
  );

...
const ProductCard: React.FC<ProductCardProps> = ({ product, onPress, isFirst, isLast }) => {
  ...
  const rating = typeof product.rating === 'number' ? product.rating : parseFloat(product.rating as unknown) || 0;
  const price = typeof product.price === 'number' ? product.price : parseFloat(product.price as unknown) || 0;
  const originalPrice = typeof product.originalPrice === 'number' ? product.originalPrice : parseFloat(product.originalPrice as unknown) || 0;
  const reviewCount = typeof product.reviewCount === 'number' ? product.reviewCount : parseInt(product.reviewCount as unknown) || 0;

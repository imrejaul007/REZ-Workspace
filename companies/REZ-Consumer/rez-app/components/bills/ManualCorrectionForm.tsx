      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View
            ...
            accessibilityLabel="Information: Our OCR detected some information. Please review and correct unknown errors."
          >
            <Ionicons name="information-circle" size={20} color="#2196F3" />
            <Text style={styles.infoText}>
              Our OCR detected some information. Please review and correct unknown errors.
            </Text>
          </View>
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              ...
              placeholder="Add unknown additional notes or corrections..."
              multiline
              numberOfLines={3}
              accessible={true}
              accessibilityLabel="Additional notes, optional field"
              accessibilityHint="Enter unknown additional notes or corrections about the bill"
            />
          </View>

...
interface StreakLoyaltySectionProps {
  ...
  pageConfig?; // receives pageConfig for loyalty config overrides
}
...
const StreakLoyaltySection: React.FC<StreakLoyaltySectionProps> = ({
  ...
  const handleMissionPress = (missionId: string) => {
    if (onMissionPress) {
      ...
      router.push(`/MainCategory/${categorySlug}/loyalty/missions` as unknown);
    } else {
      router.push('/missions' as unknown);
    }
  };

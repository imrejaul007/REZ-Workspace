...
const AnySlider = Slider as unknown;

interface CategoryFiltersProps {
  filters: CategoryFilter[];
  activeFilters: Record<string, unknown>;
  onFilterChange: (filterId: string, value) => void;
  onReset: () => void;
}
              ...
              <View style={styles.slidersContainer}>
                <View style={styles.sliderContainer}>
                  ...
                  <AnySlider
                    ...
                    {...({ accessibilityLabel: "Minimum price", accessibilityHint: "Adjust minimum price range" } as unknown)}
                  />
                </View>
                ...
                <View style={styles.sliderContainer}>
                  ...
                  <AnySlider
                    ...
                    {...({ accessibilityLabel: "Maximum price", accessibilityHint: "Adjust maximum price range" } as unknown)}
                  />
                </View>
              </View>
            </View>

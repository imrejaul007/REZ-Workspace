...
function ShimmerEffect({
  ...
  return (
    <View
      style={[styles.container, { width: width as unknown, height: height as unknown }, style]}
      accessibilityElementsHidden={true}
      importantForAccessibility="no"
    >
      <View style={[styles.shimmerContainer, { width: width as unknown, height: height as unknown }]}>
        <Animated.View
          style={[
            styles.shimmer,
            shimmerStyle,

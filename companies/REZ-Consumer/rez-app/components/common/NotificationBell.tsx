...
function NotificationBell({
  ...
  const handleNotificationPress = async (notification: Notification) => {
    ...
    if (notification.data?.deepLink) {
      router.push(notification.data.deepLink as unknown);
    } else if (notification.data?.orderId) {
      router.push(`/tracking/${notification.data.orderId}` as unknown);
    } else if (notification.data?.storeId) {
      router.push(`/MainStorePage?storeId=${notification.data.storeId}` as unknown);

  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        (bookingResponse as unknown).requiresPayment = (response as unknown).requiresPayment || response.data?.requiresPaymentUpfront;
        (bookingResponse as unknown).totalAmount = getTotalPrice();

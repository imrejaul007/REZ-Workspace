    ...
    cards.push({
      ...
      onPress: onProductLockPress || (() => {
        if (lockProduct?.productId) {
          router.push(`/product-page?cardId=${lockProduct.productId}&cardType=product` as unknown);
        } else {
          router.push('/product-lock' as unknown);
        }
      }),
    });
  }
    ...
    cards.push({
      ...
      onPress: onServiceBookingPress || (() => {
        if (trendingService?.productId) {
          router.push(`/service/${trendingService.productId}` as unknown);
        } else {
          router.push('/service-booking' as unknown);
        }
      }),
    });
  }

    ...
    <View style={styles.container}>
      ...
      <View style={styles.grid}>
        ...
        <View style={styles.row1}>
          ...
          >
            <LinearGradient
              colors={moviesCategory.gradientColors as unknown}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
          ...
          <View style={styles.rightColumn}>
            ...
            >
              <LinearGradient
                colors={concertsCategory.gradientColors as unknown}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
            ...
            >
              <LinearGradient
                colors={parksCategory.gradientColors as unknown}
        ...
        <View style={styles.row2}>
          ...
          >
            <LinearGradient
              colors={workshopsCategory.gradientColors as unknown}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
          ...
          >
            <LinearGradient
              colors={gamingCategory.gradientColors as unknown}
              style={styles.smallCardGradient}
            >

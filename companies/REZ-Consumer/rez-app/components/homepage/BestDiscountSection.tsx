...
function BestDiscountSection({
  ...
  const handleViewAll = useCallback(() => {
    router.push('/categories?filter=best-discount' as unknown);
  }, [router]);

  const handleCategoryPress = useCallback((category: Category) => {
    router.push(`/category/${category.slug}` as unknown);
  }, [router]);
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <FlashList
          ...
          contentContainerStyle={styles.listContent as unknown}

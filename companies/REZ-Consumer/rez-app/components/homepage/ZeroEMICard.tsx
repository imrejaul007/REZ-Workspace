...
const Star: React.FC<{ size: number; color: string; opacity?: number; style?: unknown }> = ({
  size,
  color,
  opacity = 1,
  style,
    ...
    <View style={styles.cardWrapper}>
      ...
      >
        ...
        >
          ...
          {/* Decorative stars */}
          <Star size={16} color={(COLORS as unknown).goldLight} opacity={0.6} style={styles.star1} />
          <Star size={12} color={COLORS.white} opacity={0.4} style={styles.star2} />
          <Star size={10} color={(COLORS as unknown).goldLight} opacity={0.5} style={styles.star3} />
...
const styles = StyleSheet.create({
  ...
  ctaButton: {
    ...
    ...Platform.select({
      ios: {
        shadowColor: (COLORS as unknown).orange,
        shadowOffset: { width: 0, height: 4 },
        shadowOpacity: 0.4,
        shadowRadius: 8,
      },

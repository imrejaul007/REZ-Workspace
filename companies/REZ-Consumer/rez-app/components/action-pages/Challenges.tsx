...
const getDifficultyColor = (difficulty: Challenge['difficulty']): string => {
  switch (difficulty) {
    ...
    case 'Medium': return (COLORS as unknown).orange;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[(COLORS as unknown).orange]} />
        }
      >
        {/* Featured Challenge */}
                  ...
                  <LinearGradient
                    colors={
                      joinedChallenges.has(challenge.id)
                        ...
                        : [(COLORS as unknown).orange, COLORS.orangeDark]
                    }
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 0 }}
...
const styles = StyleSheet.create({
  ...
  bottomNote: {
    ...
    borderRadius: 12,
    borderWidth: 1,
    borderColor: (COLORS as unknown).orange + '30',
  },
  bottomNoteText: {
    flex: 1,
    fontSize: 12,

      ...
      <View style={styles.cardImageContainer}>
        {imageUri && !imageError ? (
          ...
          <View style={[styles.cardImage, styles.cardImagePlaceholder]}>
            <Ionicons name="sparkles" size={32} color={(COLORS as unknown).pink} />
          </View>
        )}
        <LinearGradient
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.cardFooter}>
          ...
          <View style={styles.viewButton}>
            ...
            <Ionicons name="chevron-forward" size={14} color={(COLORS as unknown).pink} />
          </View>
        </View>
      </View>
    </Pressable>
...
function BeautyExperiencesPage() {
  ...
  const fetchExperiences = useCallback(async () => {
    try {
      setError(null);
      setIsLoading(true);
      const response = await apiClient.get<unknown>('/experiences', {
  ...
  const handleExperiencePress = (experience: Experience) => {
    ...
    router.push(`/MainCategory/beauty-wellness/experiences/${experienceId}` as unknown);
  };
        ...
        <FlashList
          ...
          refreshControl={
            <RefreshControl
              ...
              onRefresh={onRefresh}
              colors={[(COLORS as unknown).pink]}
              tintColor={(COLORS as unknown).pink}
            />
          }
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              <Ionicons name="sparkles-outline" size={48} color={(COLORS as unknown).pink} />
...
const styles = StyleSheet.create({
  ...
  priceText: { fontSize: 16, fontWeight: '700', color: (COLORS as unknown).pink },
  originalPrice: {
    fontSize: 13,
    color: COLORS.textSecondary,
  ...
  viewButtonText: { fontSize: 13, fontWeight: '600', color: (COLORS as unknown).pink },

      ...
      <SafeAreaView style={styles.container}>
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            <ActivityIndicator size="large" color={(COLORS as unknown).pink} />
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.confirmContent}>
          <View style={styles.confirmIconWrap}>
            ...
            >
              <Ionicons name="checkmark-circle" size={64} color={(COLORS as unknown).pink} />
            </LinearGradient>
          </View>
          ...
          <View style={styles.confirmCard}>
            <View style={styles.confirmRow}>
              <View style={[styles.confirmRowIcon, { backgroundColor: 'rgba(236,72,153,0.1)' }]}>
                <Ionicons name="flower" size={16} color={(COLORS as unknown).pink} />
              </View>
              <View>
          ...
          <View style={styles.confirmNote}>
            <Ionicons name="information-circle" size={16} color={(COLORS as unknown).pink} />
          ...
          <Pressable
            ...
            onPress={() => router.push('/my-bookings' as unknown)}
      ...
      <ScrollView contentContainerStyle={styles.formContent} showsVerticalScrollIndicator={false}>
        {selectedStore?.name && (
          <View style={styles.storePreview}>
            <LinearGradient
              colors={[(COLORS as unknown).pink, COLORS.pinkDark]}
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
          {DURATION_OPTIONS.map(opt => (
            <Pressable
              ...
              style={{ paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: selectedDuration === opt.value ? (COLORS as unknown).pink : COLORS.background, borderWidth: 1, borderColor: selectedDuration === opt.value ? (COLORS as unknown).pink : COLORS.border }}
            >
        ...
        <View style={styles.formLabelRow}>
          ...
          {isLoadingAvailability ? (
            <ActivityIndicator size="small" color={(COLORS as unknown).pink} />
          ) : (
        ...
        <View style={styles.bonusNote}>
          <View style={styles.bonusIconWrap}>
            <Ionicons name="wallet-outline" size={14} color={(COLORS as unknown).pink} />
          </View>
...
const styles = StyleSheet.create({
  ...
  storeCashbackBadge: {
    ...
    backgroundColor: (COLORS as unknown).pink, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 2,
  },
  ...
  verifiedBadgeText: { fontSize: 9, fontWeight: '600', color: (COLORS as unknown).pink },
  ...
  serviceChipActive: { backgroundColor: COLORS.pinkLight, borderColor: (COLORS as unknown).pink },
  ...
  serviceDurationActive: { color: (COLORS as unknown).pink },
  ...
  dateChipActive: { backgroundColor: (COLORS as unknown).pink, borderColor: (COLORS as unknown).pink },
  ...
  timeChipActive: { backgroundColor: (COLORS as unknown).pink, borderColor: (COLORS as unknown).pink },
  ...
  submitBtn: {
    ...
    backgroundColor: (COLORS as unknown).pink, borderRadius: 16, paddingVertical: 16, marginTop: 20,
  },
  ...
  doneBtn: {
    width: '100%', paddingVertical: 16, backgroundColor: (COLORS as unknown).pink, borderRadius: 16, alignItems: 'center',
  },
  ...
  viewBookingsBtnText: { fontSize: 14, fontWeight: '600', color: (COLORS as unknown).pink },
});

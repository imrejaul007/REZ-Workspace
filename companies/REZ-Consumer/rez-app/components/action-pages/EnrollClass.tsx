...
function EnrollClassPage() {
  ...
  const handleSelectSalon = (store) => { setSelectedStore(store); setStep('details'); };
      ...
      <SafeAreaView style={styles.container}>
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            <ActivityIndicator size="large" color={(COLORS as unknown).indigo} />
        ...
        <ScrollView contentContainerStyle={styles.confirmContent}>
          <View style={styles.confirmIconWrap}>
            <LinearGradient colors={[COLORS.indigoLight, '#E0E7FF']} style={styles.confirmIconGradient}>
              <Ionicons name="checkmark-circle" size={64} color={(COLORS as unknown).indigo} />
            </LinearGradient>
          </View>
          ...
          <View style={styles.confirmCard}>
            <View style={styles.confirmRow}>
              <View style={[styles.confirmRowIcon, { backgroundColor: 'rgba(99,102,241,0.1)' }]}>
                <Ionicons name="school" size={16} color={(COLORS as unknown).indigo} />
              </View>
              <View>
          ...
          <View style={styles.confirmNote}>
            <Ionicons name="information-circle" size={16} color={(COLORS as unknown).indigo} />
      ...
      <ScrollView contentContainerStyle={styles.formContent} showsVerticalScrollIndicator={false}>
        {selectedStore?.name && (
          <View style={styles.storePreview}>
            <LinearGradient colors={[(COLORS as unknown).indigo, COLORS.indigoDark]} style={styles.storePreviewGradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
        ...
        <View style={styles.formLabelRow}>
          ...
          {isLoadingAvailability ? (
            <ActivityIndicator size="small" color={(COLORS as unknown).indigo} />
          ) : (
        ...
        <View style={styles.bonusNote}>
          <View style={styles.bonusIconWrap}><Ionicons name="wallet-outline" size={14} color={(COLORS as unknown).indigo} /></View>
...
const styles = StyleSheet.create({
  ...
  storeCashbackBadge: {
    ...
    backgroundColor: (COLORS as unknown).indigo, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 2,
  },
  ...
  verifiedBadgeText: { fontSize: 9, fontWeight: '600', color: (COLORS as unknown).indigo },
  ...
  serviceChipActive: { backgroundColor: COLORS.indigoLight, borderColor: (COLORS as unknown).indigo },
  ...
  serviceDurationActive: { color: (COLORS as unknown).indigo },
  ...
  dateChipActive: { backgroundColor: (COLORS as unknown).indigo, borderColor: (COLORS as unknown).indigo },
  ...
  timeChipActive: { backgroundColor: (COLORS as unknown).indigo, borderColor: (COLORS as unknown).indigo },
  ...
  submitBtn: {
    ...
    backgroundColor: (COLORS as unknown).indigo, borderRadius: 16, paddingVertical: 16, marginTop: 20,
  },
  ...
  doneBtn: { width: '100%', paddingVertical: 16, backgroundColor: (COLORS as unknown).indigo, borderRadius: 16, alignItems: 'center' },
  ...
  viewBookingsBtnText: { fontSize: 14, fontWeight: '600', color: (COLORS as unknown).indigo },
});

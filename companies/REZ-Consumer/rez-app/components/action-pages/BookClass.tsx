      ...
      <SafeAreaView style={styles.container}>
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            <ActivityIndicator size="large" color={(COLORS as unknown).orange} />
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.confirmContent}>
          <View style={styles.confirmIconWrap}>
            ...
            >
              <Ionicons name="checkmark-circle" size={64} color={(COLORS as unknown).orange} />
            </LinearGradient>
          </View>
          ...
          <View style={styles.confirmCard}>
            <View style={styles.confirmRow}>
              <View style={[styles.confirmRowIcon, { backgroundColor: 'rgba(249,115,22,0.1)' }]}>
                <Ionicons name="barbell" size={16} color={(COLORS as unknown).orange} />
              </View>
              <View>
          ...
          <View style={styles.confirmNote}>
            <Ionicons name="information-circle" size={16} color={(COLORS as unknown).orange} />
          ...
          <Pressable
            ...
            onPress={() => router.push('/orders' as unknown)}
      ...
      <ScrollView contentContainerStyle={styles.formContent} showsVerticalScrollIndicator={false}>
        {selectedStore?.name && (
          <View style={styles.storePreview}>
            <LinearGradient
              colors={[(COLORS as unknown).orange, COLORS.orangeDark]}
        ...
        <View style={styles.formLabelRow}>
          ...
          {isLoadingAvailability ? (
            <ActivityIndicator size="small" color={(COLORS as unknown).orange} />
          ) : (
        ...
        <View style={styles.bonusNote}>
          <View style={styles.bonusIconWrap}>
            <Ionicons name="wallet-outline" size={14} color={(COLORS as unknown).orange} />
          </View>
...
const styles = StyleSheet.create({
  ...
  storeCashbackBadge: {
    ...
    backgroundColor: (COLORS as unknown).orange, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 2,
  },
  ...
  verifiedBadgeText: { fontSize: 9, fontWeight: '600', color: (COLORS as unknown).orange },
  ...
  serviceChipActive: { backgroundColor: COLORS.orangeLight, borderColor: (COLORS as unknown).orange },
  ...
  serviceDurationActive: { color: (COLORS as unknown).orange },
  ...
  dateChipActive: { backgroundColor: (COLORS as unknown).orange, borderColor: (COLORS as unknown).orange },
  ...
  timeChipActive: { backgroundColor: (COLORS as unknown).orange, borderColor: (COLORS as unknown).orange },
  ...
  submitBtn: {
    ...
    backgroundColor: (COLORS as unknown).orange, borderRadius: 16, paddingVertical: 16, marginTop: 20,
  },
  ...
  doneBtn: {
    width: '100%', paddingVertical: 16, backgroundColor: (COLORS as unknown).orange, borderRadius: 16, alignItems: 'center',
  },
  ...
  viewBookingsBtnText: { fontSize: 14, fontWeight: '600', color: (COLORS as unknown).orange },
});

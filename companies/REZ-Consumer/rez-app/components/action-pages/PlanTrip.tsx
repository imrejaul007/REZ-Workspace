...
function PlanTripPage() {
  ...
  const handleConfirm = async () => {
    ...
    platformAlertConfirm(
      ...
      () => router.push('/MainCategory/travel-experiences/offers' as unknown),
      'Browse Offers'
    );
  };
        ...
        {step === 'dates' && (
          <>
            ...
            <View style={styles.durationRow}>
              <Pressable style={styles.durationBtn} onPress={() => setTripDays(Math.max(1, tripDays - 1))}><Ionicons name="remove-circle" size={32} color={(COLORS as unknown).cyan} /></Pressable>
              <View style={styles.durationDisplay}>
                <Text style={styles.durationValue}>{tripDays}</Text>
                <Text style={styles.durationLabel}>{tripDays === 1 ? 'day' : 'days'}</Text>
              </View>
              <Pressable style={styles.durationBtn} onPress={() => setTripDays(Math.min(30, tripDays + 1))}><Ionicons name="add-circle" size={32} color={(COLORS as unknown).cyan} /></Pressable>
            </View>
            ...
            <View style={styles.dateSummary}>
              <Ionicons name="calendar-outline" size={18} color={(COLORS as unknown).cyan} />
            ...
            <View style={styles.travelerCard}>
              <View style={styles.travelerRow}>
                ...
                <View style={styles.counterRow}>
                  <Pressable style={styles.counterBtn} onPress={() => setAdults(Math.max(1, adults - 1))}><Ionicons name="remove" size={20} color={(COLORS as unknown).cyan} /></Pressable>
                  <Text style={styles.counterValue}>{adults}</Text>
                  <Pressable style={styles.counterBtn} onPress={() => setAdults(Math.min(10, adults + 1))}><Ionicons name="add" size={20} color={(COLORS as unknown).cyan} /></Pressable>
                </View>
              </View>
              ...
              <View style={styles.travelerRow}>
                ...
                <View style={styles.counterRow}>
                  <Pressable style={styles.counterBtn} onPress={() => setChildren(Math.max(0, children - 1))}><Ionicons name="remove" size={20} color={(COLORS as unknown).cyan} /></Pressable>
                  <Text style={styles.counterValue}>{children}</Text>
                  <Pressable style={styles.counterBtn} onPress={() => setChildren(Math.min(6, children + 1))}><Ionicons name="add" size={20} color={(COLORS as unknown).cyan} /></Pressable>
                </View>
              </View>
            </View>
            <View style={styles.travelerSummary}>
              <Ionicons name="people-outline" size={18} color={(COLORS as unknown).cyan} />
        ...
        {step === 'confirm' && (
          <>
            ...
            <View style={styles.bonusNote}>
              <View style={styles.bonusIconWrap}><Ionicons name="wallet-outline" size={14} color={(COLORS as unknown).cyan} /></View>
...
const styles = StyleSheet.create({
  ...
  progressDotActive: { backgroundColor: (COLORS as unknown).cyan },
  ...
  progressLabelActive: { color: (COLORS as unknown).cyan, fontWeight: '700' },
  ...
  destCardActive: { backgroundColor: COLORS.cyanLight, borderColor: (COLORS as unknown).cyan },
  ...
  destTagActive: { color: (COLORS as unknown).cyan },
  ...
  dateChipActive: { backgroundColor: (COLORS as unknown).cyan, borderColor: (COLORS as unknown).cyan },
  ...
  durationValue: { fontSize: 36, fontWeight: '800', color: (COLORS as unknown).cyan },
  ...
  quickDayChipActive: { backgroundColor: (COLORS as unknown).cyan, borderColor: (COLORS as unknown).cyan },
  ...
  accomCardActive: { backgroundColor: COLORS.cyanLight, borderColor: (COLORS as unknown).cyan },
  ...
  accomDescActive: { color: (COLORS as unknown).cyan },
  ...
  activityChipActive: { backgroundColor: (COLORS as unknown).cyan, borderColor: (COLORS as unknown).cyan },
  ...
  navRow: { marginTop: 24 },
  nextBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: (COLORS as unknown).cyan, borderRadius: 16, paddingVertical: 16 },

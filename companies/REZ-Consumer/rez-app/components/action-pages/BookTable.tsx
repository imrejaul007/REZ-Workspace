...
function BookTablePage() {
  ...
  const fetchRestaurants = useCallback(async () => {
    try {
      ...
      if (res.success && res.data) {
        ...
        const dineIn = allStores.filter((s) =>
  ...
  const fetchAvailability = useCallback(async (storeId: string, date: Date) => {
    try {
      ...
      if (res.success && res.data?.timeSlots) {
        const slots: TimeSlot[] = res.data.timeSlots.map((s) => ({
          time: s.time,
  ...
  const handleSelectRestaurant = (store) => {
  ...
  const getCuisineTags = (store): string => {
        ...
        <ScrollView contentContainerStyle={styles.confirmContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.confirmCardOuter}>
            <View style={styles.confirmCard}>
              <View style={styles.confirmRow}>
                <View style={[styles.confirmRowIcon, { backgroundColor: 'rgba(251,191,36,0.12)' }]}>
                  <Ionicons name="restaurant" size={18} color={(COLORS as unknown).goldDark} />
                </View>
                <View style={{ flex: 1 }}>
            ...
            <View style={styles.confirmNote}>
              ...
              >
                <View style={styles.confirmNoteIconWrap}>
                  <Ionicons name="gift" size={16} color={(COLORS as unknown).goldDark} />
                </View>
            ...
            <Pressable
              ...
              onPress={() => router.push('/BookingsPage' as unknown)}
      ...
      <ScrollView contentContainerStyle={styles.formContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.bonusNote}>
          <View style={styles.bonusIconWrap}>
            <Ionicons name="wallet-outline" size={14} color={(COLORS as unknown).goldDark} />
          </View>

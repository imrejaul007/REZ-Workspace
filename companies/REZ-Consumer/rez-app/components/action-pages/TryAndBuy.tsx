      ...
      <SafeAreaView style={styles.container}>
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            <ActivityIndicator size="large" color={(COLORS as unknown).purple} />
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.confirmContent}>
          <View style={styles.confirmIconWrap}>
            ...
            >
              <Ionicons name="checkmark-circle" size={64} color={(COLORS as unknown).purple} />
            </LinearGradient>
          </View>
          ...
          <View style={styles.confirmCard}>
            <View style={styles.confirmRow}>
              <View style={[styles.confirmRowIcon, { backgroundColor: 'rgba(168,85,247,0.1)' }]}>
                <Ionicons name="storefront" size={16} color={(COLORS as unknown).purple} />
              </View>
              <View>
          ...
          <View style={styles.confirmNote}>
            <Ionicons name="information-circle" size={16} color={(COLORS as unknown).purple} />
      ...
      <ScrollView contentContainerStyle={styles.formContent} showsVerticalScrollIndicator={false}>
        {selectedStore?.name && (
          <View style={styles.storePreview}>
            <LinearGradient
              colors={[(COLORS as unknown).purple, COLORS.purpleDark]}
        ...
        <View style={styles.formLabelRow}>
          ...
          {isLoadingAvailability ? (
            <ActivityIndicator size="small" color={(COLORS as unknown).purple} />
          ) : (
        ...
        <View style={styles.bonusNote}>
          <View style={styles.bonusIconWrap}>
            <Ionicons name="wallet-outline" size={14} color={(COLORS as unknown).purple} />
          </View>
...
const styles = StyleSheet.create({
  ...
  storeCashbackBadge: {
    ...
    backgroundColor: (COLORS as unknown).purple, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 2,
  },
  ...
  verifiedBadgeText: { fontSize: 9, fontWeight: '600', color: (COLORS as unknown).purple },
  ...
  serviceChipActive: { backgroundColor: COLORS.purpleLight, borderColor: (COLORS as unknown).purple },
  ...
  serviceDurationActive: { color: (COLORS as unknown).purple },
  ...
  dateChipActive: { backgroundColor: (COLORS as unknown).purple, borderColor: (COLORS as unknown).purple },
  ...
  timeChipActive: { backgroundColor: (COLORS as unknown).purple, borderColor: (COLORS as unknown).purple },
  ...
  submitBtn: {
    ...
    backgroundColor: (COLORS as unknown).purple, borderRadius: 16, paddingVertical: 16, marginTop: 20,
  },
  ...
  doneBtn: {
    width: '100%', paddingVertical: 16, backgroundColor: (COLORS as unknown).purple, borderRadius: 16, alignItems: 'center',
  },
  ...
  viewBookingsBtnText: { fontSize: 14, fontWeight: '600', color: (COLORS as unknown).purple },
});

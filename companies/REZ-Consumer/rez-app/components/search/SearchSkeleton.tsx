...
function ShimmerBar({ width: w, height, borderRadius = 8, style }: { width: number | string; height: number; borderRadius?: number; style?: unknown }) {
  ...
  return (
    <Animated.View
      style={[
        { width: w as unknown, height, borderRadius, backgroundColor: colors.neutral[200] },
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <ShimmerBar width={'100%' as unknown} height={44} borderRadius={12} style={{ marginBottom: 8 }} />
        <ShimmerBar width={'100%' as unknown} height={44} borderRadius={12} style={{ marginBottom: 8 }} />
        <ShimmerBar width={'100%' as unknown} height={44} borderRadius={12} />
      </View>
      ...
      <View style={styles.section}>
        ...
        {[1, 2, 3, 4].map(i => (
          <ShimmerBar key={i} width={'100%' as unknown} height={44} borderRadius={10} style={{ marginBottom: 8 }} />
        ))}
      </View>

...
function BeautyCategoryPage() {
  ...
  const handleCategoryPress = useCallback((category) => {
    router.push(`/MainCategory/beauty-wellness/${category.slug || category.id}` as unknown);
  }, [router]);

  const handleAISearch = useCallback((query: string) => {
    router.push(`/MainCategory/beauty-wellness/search?q=${encodeURIComponent(query)}` as unknown);
  }, [router]);
  ...
  return (
    ...
    >
      ...
      <Pressable
        ...
        onPress={() => router.push('/MainCategory/beauty-wellness/loyalty' as unknown)}
      >
        <LinearGradient
      ...
      <QuickActionBar categorySlug={slug} actions={beautyQuickActions as unknown} />
      ...
      {filteredTrending.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/beauty-wellness/search?q=trending' as unknown)}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.trendingList}>
            {filteredTrending.map(treatment => (
              <Pressable
                ...
                onPress={() => router.push(`/MainCategory/beauty-wellness/book-appointment?service=${treatment.id}` as unknown)}
      ...
      {filteredServices.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/beauty-wellness/book-appointment' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.servicesList}>
            {filteredServices.map(service => (
              <Pressable
                ...
                onPress={() => router.push(`/MainCategory/beauty-wellness/book-appointment?service=${service.id}` as unknown)}
              >
      ...
      {filteredProducts.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/beauty-wellness/search?q=products' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.productsList}>
            {filteredProducts.slice(0, 6).map((product) => (
              <Pressable
                ...
                onPress={() => router.push(`/product-page?productId=${product.id}` as unknown)}
              >
                {product.image ? (
                  <CachedImage
      ...
      {filteredStores.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/beauty-wellness/top-rated' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
            ...
            {filteredStores.slice(0, 5).map((store) => {
              ...
              return (
                <Pressable
                  ...
                  onPress={() => router.push(`/MainStorePage?storeId=${store.id}` as unknown)}
                >
      ...
      <OffersSection
        ...
        onSeeAll={() => router.push('/MainCategory/beauty-wellness/offers' as unknown)}
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          ...
          <Pressable onPress={() => router.push('/MainCategory/beauty-wellness/experiences' as unknown)}>
            <Text style={styles.sectionSeeAll}>View All</Text>
          </Pressable>
        </View>
        <View style={styles.experienceBanner}>
          ...
          >
            ...
            <Pressable
              ...
              onPress={() => router.push('/MainCategory/beauty-wellness/experiences' as unknown)}
            >
      ...
      <EnhancedUGCSocialProofSection
        ...
        onPostPress={() => router.push('/MainCategory/beauty-wellness/beauty-stories' as unknown)}
        onSharePress={() => router.push('/MainCategory/beauty-wellness/beauty-stories' as unknown)}
      />

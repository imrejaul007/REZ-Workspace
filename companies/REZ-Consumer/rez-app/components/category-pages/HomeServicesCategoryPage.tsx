...
function HomeServicesCategoryPage() {
  ...
  const handleCategoryPress = useCallback((category) => {
    router.push(`/MainCategory/home-services/${category.slug || category.id}` as unknown);
  }, [router]);

  const handleAISearch = useCallback((query: string) => {
    router.push(`/MainCategory/home-services/search?q=${encodeURIComponent(query)}` as unknown);
  }, [router]);
  ...
  return (
    ...
    >
      ...
      {/* Rewards Strip */}
      <Pressable style={styles.rewardsStrip} onPress={() => router.push('/MainCategory/home-services/loyalty' as unknown)}>
      ...
      <QuickActionBar categorySlug={slug} actions={homeQuickActions as unknown} />
      ...
      <BrowseCategoryGrid categories={subcategories as unknown} title="Browse Services" onCategoryPress={handleCategoryPress} />
      ...
      {filteredServices.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/home-services/book-service' as unknown)}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.servicesList}>
            {filteredServices.map(s => (
              <Pressable key={s.id} style={styles.serviceCard} onPress={() => router.push(`/MainCategory/home-services/book-service?service=${s.id}` as unknown)}>
      ...
      {filteredStores.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/home-services/top-rated' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
      ...
      <OffersSection categorySlug={slug} title="Today's Top Home Service Deals" onSeeAll={() => router.push('/MainCategory/home-services/offers' as unknown)} filterTags={activeFilterTags} />

      {/* Emergency Service CTA Banner */}
      <View style={styles.section}>
        <Pressable style={styles.challengeBanner} onPress={() => router.push('/MainCategory/home-services/search?q=emergency' as unknown)}>
      ...
      <EnhancedUGCSocialProofSection
        ...
        onPostPress={() => router.push('/MainCategory/home-services/service-stories' as unknown)}
        onSharePress={() => router.push('/MainCategory/home-services/service-stories' as unknown)}
      />

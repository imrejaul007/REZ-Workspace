...
function FinancialCategoryPage() {
  ...
  const handleCategoryPress = useCallback((category) => {
    router.push(`/MainCategory/financial-lifestyle/${category.slug || category.id}` as unknown);
  }, [router]);

  const handleAISearch = useCallback((query: string) => {
    router.push(`/MainCategory/financial-lifestyle/search?q=${encodeURIComponent(query)}` as unknown);
  }, [router]);
  ...
  return (
    ...
    >
      ...
      {/* Rewards Strip */}
      <Pressable style={styles.rewardsStrip} onPress={() => router.push('/MainCategory/financial-lifestyle/loyalty' as unknown)}>
      ...
      <QuickActionBar categorySlug={slug} actions={financialQuickActions as unknown} />
      ...
      <BrowseCategoryGrid categories={subcategories as unknown} title="Browse Financial Services" onCategoryPress={handleCategoryPress} />
      ...
      {filteredServices.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/financial-lifestyle/apply-service' as unknown)}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.servicesList}>
            {filteredServices.map(s => (
              <Pressable key={s.id} style={styles.serviceCard} onPress={() => router.push(`/MainCategory/financial-lifestyle/apply-service?service=${s.id}` as unknown)}>
                <View style={styles.serviceIcon}><Text style={styles.serviceEmoji}>{(s as unknown).emoji}</Text></View>
                <Text style={styles.serviceName}>{s.name}</Text>
                <Text style={styles.serviceCashback}>Up to {(s as unknown).cashback}% cashback</Text>
              </Pressable>
            ))}
          </ScrollView>
        </View>
      ...
      {filteredStores.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/financial-lifestyle/top-rated' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
      ...
      <OffersSection categorySlug={slug} title="Today's Top Financial Deals" onSeeAll={() => router.push('/MainCategory/financial-lifestyle/offers' as unknown)} filterTags={activeFilterTags} />
      ...
      {/* Savings Goal CTA */}
      <View style={styles.section}>
        <Pressable style={styles.challengeBanner} onPress={() => router.push('/MainCategory/financial-lifestyle/apply-service' as unknown)}>
      ...
      <EnhancedUGCSocialProofSection
        ...
        onPostPress={() => router.push('/MainCategory/financial-lifestyle/smart-savers' as unknown)}
        onSharePress={() => router.push('/MainCategory/financial-lifestyle/smart-savers' as unknown)}
      />

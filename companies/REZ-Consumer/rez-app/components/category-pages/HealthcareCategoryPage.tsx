...
function HealthcareCategoryPage() {
  ...
  const handleCategoryPress = useCallback((category) => {
    router.push(`/MainCategory/healthcare/${category.slug || category.id}` as unknown);
  }, [router]);

  const handleAISearch = useCallback((query: string) => {
    router.push(`/MainCategory/healthcare/search?q=${encodeURIComponent(query)}` as unknown);
  }, [router]);
  ...
  return (
    ...
    >
      ...
      {/* Rewards Strip */}
      <Pressable style={styles.rewardsStrip} onPress={() => router.push('/MainCategory/healthcare/loyalty' as unknown)}>
      ...
      <QuickActionBar categorySlug={slug} actions={healthcareQuickActions as unknown} />
      ...
      <BrowseCategoryGrid categories={subcategories as unknown} title="Explore Healthcare" onCategoryPress={handleCategoryPress} />
      ...
      {filteredServices.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/healthcare/book-doctor' as unknown)}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.servicesList}>
            {filteredServices.map(s => (
              <Pressable key={s.id} style={styles.serviceCard} onPress={() => router.push(`/MainCategory/healthcare/book-doctor?service=${s.id}` as unknown)}>
      ...
      {filteredStores.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/healthcare/top-rated' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
      ...
      <OffersSection categorySlug={slug} title="Today's Top Healthcare Deals" onSeeAll={() => router.push('/MainCategory/healthcare/offers' as unknown)} filterTags={activeFilterTags} />

      {/* Emergency CTA Banner */}
      <View style={styles.section}>
        <Pressable style={styles.emergencyBanner} onPress={() => router.push('/MainCategory/healthcare/search?q=emergency' as unknown)}>
      ...
      <EnhancedUGCSocialProofSection
        ...
        onPostPress={() => router.push('/MainCategory/healthcare/health-stories' as unknown)}
        onSharePress={() => router.push('/MainCategory/healthcare/health-stories' as unknown)}
      />

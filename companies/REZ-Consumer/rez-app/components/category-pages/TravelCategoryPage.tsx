...
function TravelCategoryPage() {
  ...
  const handleCategoryPress = useCallback((category) => {
    router.push(`/MainCategory/travel-experiences/${category.slug || category.id}` as unknown);
  }, [router]);

  const handleAISearch = useCallback((query: string) => {
    router.push(`/MainCategory/travel-experiences/search?q=${encodeURIComponent(query)}` as unknown);
  }, [router]);
  ...
  return (
    ...
    >
      ...
      {/* Rewards Strip */}
      <Pressable style={styles.rewardsStrip} onPress={() => router.push('/MainCategory/travel-experiences/loyalty' as unknown)}>
      ...
      <QuickActionBar categorySlug={slug} actions={travelQuickActions as unknown} />
      ...
      <BrowseCategoryGrid categories={subcategories as unknown} title="Explore Travel" onCategoryPress={handleCategoryPress} />
      ...
      {filteredServices.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/travel-experiences/search?q=services' as unknown)}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.servicesList}>
            {filteredServices.map(s => (
              <Pressable key={s.id} style={styles.serviceCard} onPress={() => router.push(`/MainCategory/travel-experiences/search?q=${s.id}` as unknown)}>
      ...
      {filteredStores.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/travel-experiences/top-rated' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
      ...
      <OffersSection categorySlug={slug} title="Today's Top Travel Deals" onSeeAll={() => router.push('/MainCategory/travel-experiences/offers' as unknown)} filterTags={activeFilterTags} />
      ...
      {/* Weekend Getaway CTA */}
      <View style={styles.section}>
        <Pressable style={styles.challengeBanner} onPress={() => router.push('/MainCategory/travel-experiences/plan-trip' as unknown)}>
      ...
      <EnhancedUGCSocialProofSection
        ...
        onPostPress={() => router.push('/MainCategory/travel-experiences/travel-stories' as unknown)}
        onSharePress={() => router.push('/MainCategory/travel-experiences/travel-stories' as unknown)}
      />

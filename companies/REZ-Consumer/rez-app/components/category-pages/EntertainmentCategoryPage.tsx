...
function EntertainmentCategoryPage() {
  ...
  const handleCategoryPress = useCallback((category) => {
    router.push(`/MainCategory/entertainment/${category.slug || category.id}` as unknown);
  }, [router]);

  const handleAISearch = useCallback((query: string) => {
    router.push(`/MainCategory/entertainment/search?q=${encodeURIComponent(query)}` as unknown);
  }, [router]);
  ...
  return (
    ...
    >
      ...
      {/* Rewards Strip */}
      <Pressable style={styles.rewardsStrip} onPress={() => router.push('/MainCategory/entertainment/loyalty' as unknown)}>
      ...
      <QuickActionBar categorySlug={slug} actions={entertainmentQuickActions as unknown} />
      ...
      <BrowseCategoryGrid categories={subcategories as unknown} title="Browse Entertainment" onCategoryPress={handleCategoryPress} />
      ...
      {filteredServices.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/entertainment/book-tickets' as unknown)}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.servicesList}>
            {filteredServices.map(s => (
              <Pressable key={s.id} style={styles.serviceCard} onPress={() => router.push(`/MainCategory/entertainment/book-tickets?service=${s.id}` as unknown)}>
      ...
      {filteredTrending.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/entertainment/search' as unknown)}>
              <Text style={[styles.seeAll, { color: COLORS.primary }]}>See All</Text>
            </Pressable>
          </View>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 16, gap: 12 }}>
            {filteredTrending.map((show, index: number) => (
              <Pressable key={show.id || index} style={styles.trendingCard} onPress={() => router.push(`/MainStorePage?storeId=${show.id}` as unknown)}>
      ...
      {filteredStores.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Pressable onPress={() => router.push('/MainCategory/entertainment/top-rated' as unknown)}>
              <Text style={styles.sectionSeeAll}>View All</Text>
            </Pressable>
          </View>
      ...
      <OffersSection categorySlug={slug} title="Today's Top Entertainment Deals" onSeeAll={() => router.push('/MainCategory/entertainment/offers' as unknown)} filterTags={activeFilterTags} />

      {/* Weekend Plans CTA */}
      <View style={styles.section}>
        <Pressable style={styles.challengeBanner} onPress={() => router.push('/MainCategory/entertainment/search?q=weekend' as unknown)}>
      ...
      <EnhancedUGCSocialProofSection
        ...
        onPostPress={() => router.push('/MainCategory/entertainment/fan-stories' as unknown)}
        onSharePress={() => router.push('/MainCategory/entertainment/fan-stories' as unknown)}
      />

    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {bookingData.bookingNumber && (
          <View style={(styles as unknown).bookingNumberCard}>
            <Text style={(styles as unknown).bookingNumberLabel}>Booking Number</Text>
            <Text style={(styles as unknown).bookingNumber}>{bookingData.bookingNumber}</Text>
            <Text style={(styles as unknown).bookingNote}>
      ...
      <View style={styles.footer}>
        <Pressable
          ...
          onPress={() => {
            onClose();
            router.push('/my-bookings' as unknown);
          }}
        >

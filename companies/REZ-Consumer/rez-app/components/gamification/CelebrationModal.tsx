...
function CelebrationModal({
  ...
  const rotationStyle = useAnimatedStyle(() => ({
    transform: [{ rotate: (interpolate as unknown)(rotateAnim.value, [0, 1], ['0deg', '360deg']) }],
  }));
        ...
        >
          ...
          <Animated.View
            style={[
              ...
              rotationStyle as unknown,
            ]}
          >
            <LinearGradient
              colors={getPrizeColor() as unknown}
              style={styles.iconGradient}
            >
              <Ionicons name={getPrizeIcon() as unknown} size={64} color="white" />
            </LinearGradient>
          </Animated.View>
          ...
          >
            <LinearGradient
              colors={[colors.brand.purpleLight, colors.brand.purple] as unknown}

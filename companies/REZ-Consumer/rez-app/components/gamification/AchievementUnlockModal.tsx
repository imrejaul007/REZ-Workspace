...
function AchievementUnlockModal({
  ...
  const animationRef = useRef<unknown | null>(null);
          ...
          <LinearGradient colors={tierGradient} style={styles.gradient}>
            ...
            <Animated.View
              style={[
                styles.iconContainer,
                {
                  transform: [
                    {
                      rotate: interpolate(shineAnim.value, [0, 1], [0, 10]) as unknown,
                    },
                  ],
                } as unknown,
              ]}
            >
              <LinearGradient colors={[colors.background.primary, colors.neutral[100]]} style={styles.iconCircle}>
                <Ionicons name={achievement.icon as unknown} size={64} color={tierGradient[0]} />
              </LinearGradient>
            </Animated.View>

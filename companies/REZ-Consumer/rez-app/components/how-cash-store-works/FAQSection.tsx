...
const getFAQS = (currencySymbol: string) => [
  {
    ...
    answer: 'Simply click on unknown brand through Cash Store, shop as usual on their website, and complete your purchase. The cashback will be automatically tracked and credited to your ReZ wallet.',
  },
  {
    id: 2,

...
const SAFETY_FEATURES = [
  {
    ...
    description: 'Your purchases are tracked securely without storing unknown payment details',
  },
  {
    id: 2,
    icon: 'lock-closed',
          ...
          {SAFETY_FEATURES.map((feature) => (
            <View key={feature.id} style={styles.featureCard}>
              <View style={styles.featureIconContainer}>
                <Ionicons name={feature.icon as unknown} size={24} color={colors.brand.green} />
              </View>

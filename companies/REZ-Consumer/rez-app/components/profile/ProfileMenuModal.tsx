...
function ProfileMenuModal({
  ...
  const creatorLevel = (user as unknown)?.creatorLevel ?? (user as unknown)?.partner?.level ?? null;
  const tierLabel = creatorLevel === 2 ? 'Influencer'
    : creatorLevel === 3 ? 'Ambassador'
    : 'Partner';
  const userTier = (user as unknown)?.subscriptionTier || (user as unknown)?.tier || null;
  ...
  const renderHeader = () => (
    ...
    >
      ...
      <View style={styles.userSection}>
        ...
        <Pressable
          onPress={() => { onClose(); router.push('/account/profile' as unknown); }}
        ...
        {[
          ...
          <React.Fragment key={stat.label}>
            ...
            <Pressable
              ...
              onPress={() => { onClose(); router.push('/wallet-screen' as unknown); }}
            >
      ...
      <Pressable
        ...
        onPress={() => { onClose(); router.push('/location/settings' as unknown); }}
      >
      ...
      <Pressable
        ...
        onPress={() => { onClose(); router.push('/profile/partner' as unknown); }}
      >
  ...
  const renderMenuSection = (section, sectionIndex: number) => (

 ...
 *
 * This file is the canonical source. For web apps, use @rez/brand-tokens.
 *
 * Brand Palette:
...
export const colors = {
  ...
  successMain: '#2ECC71',
  info: '#1a3a52',
  coin: '#ffcd57', // Coin/gold color

  // Brand
  brand: {
    primary: '#ffcd57', // REZ primary gold/mustard
    purple: '#7C3AED',
    purpleLight: '#8B5CF6',
    indigo: '#6366F1',
    pink: '#EC4899',
    ...
    cyan: '#06B6D4',
    teal: '#00796B',
    tealGreen: '#14B8A6', // Teal green for status/success
    green: '#00C06A',
    greenDark: '#16A34A',
    blue: '#2563EB',
    ios: '#007AFF',
    ...
    goldRich: '#E6B84E',
    goldAccent: '#C9A962',
    gold: '#ffcd57', // Primary gold alias
    sand: '#E8B896',
    caramel: '#D4A07A',
    purpleMedium: '#A855F7',
    purpleSoft: '#A78BFA',
    purpleDeep: '#6D28D9',
    nileBlue: '#1a3a52', // Primary REZ navy
    nileBlueLight: '#234b68',
    nileBlueDark: '#0B2240', // Darkest navy
    navyDark: '#0B2240',
  },
  ...
  tint: {
    ...
    green: '#D1FAE5',
    greenLight: '#ECFDF5',
    gold: '#FFF9E6', // Light gold/mustard tint
    light: '#faf1e0', // General light tint
    slate: '#F1F5F9',
    warmGray: '#F5F5F5',
    coolGray: '#F8FAFC',
  },

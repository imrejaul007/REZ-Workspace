 ...
 */
export const getAccessibleImageProps = (altText: string, isDecorative: boolean = false): unknown => {
  if (isDecorative) {
    return {
      accessible: false,
 ...
 */
export const getAccessibleGroupProps = (label: string): unknown => {
  return {
    accessible: true,
    accessibilityLabel: label,
 ...
 */
export const hideFromScreenReader = (): unknown => {
  return {
    accessible: false,
    accessibilityElementsHidden: true,
...
export const getLiveRegionProps = (priority: LiveRegionPriority): unknown => {

...
export const generateTestProps = (scenario: typeof testScenarios[0]) => {
  ...
  return {
    ...
    isBuyLoading: (scenario as unknown).isBuyLoading || false,
    isLockLoading: (scenario as unknown).isLockLoading || false,
    isBookingLoading: (scenario as unknown).isBookingLoading || false,
    isBuyDisabled: (scenario as unknown).isBuyDisabled || false,
    isLockDisabled: (scenario as unknown).isLockDisabled || false,
    isBookingDisabled: (scenario as unknown).isBookingDisabled || false,
  };
};

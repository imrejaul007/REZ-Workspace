...
class PerformanceMonitor {
   ...
   */
  start(name: string, type: PerformanceMetric['type'], metadata?: Record<string, unknown>): void {
  ...
  private async saveMetrics(): Promise<void> {
    try {
      ...
      errorLogger.logStorageError('performanceMonitor:saveMetrics', error, 'async', METRICS_STORAGE_KEY);
    }
  }
  ...
  async loadMetrics(): Promise<void> {
    try {
      ...
      errorLogger.logStorageError('performanceMonitor:loadMetrics', error, 'async', METRICS_STORAGE_KEY);
    }
  }
 ...
 */
export function trackScreenLoad(screenName: string, metadata?: Record<string, unknown>): () => void {
 ...
 */
export function trackRender(componentName: string, metadata?: Record<string, unknown>): () => void {

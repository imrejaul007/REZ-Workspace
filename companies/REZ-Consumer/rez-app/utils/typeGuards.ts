 ...
 */
export function isArray<T>(value): value is T[] {
 ...
 */
export function isObject(value): value is Record<string, unknown> {
 ...
 */
export function isProduct(obj): obj is Product {
 ...
 */
export function assertProduct(obj): asserts obj is Product {
  if (!isProduct(obj)) {
    throw new Error(
 ...
 */
export function isProductArray(obj): obj is Product[] {
 ...
 */
export function isStoreData(obj): obj is StoreData {
  if (!isObject(obj)) return false;
 ...
 */
export function assertStoreData(obj): asserts obj is StoreData {
  if (!isStoreData(obj)) {
    throw new Error(
 ...
 */
export function isLocation(obj): obj is Location {
  if (!isObject(obj)) return false;
 ...
 */
export function hasValidCoordinates(location): boolean {
 ...
 */
export function isReview(obj): obj is Review {
  if (!isObject(obj)) return false;
 ...
 */
export function isReviewArray(obj): obj is Review[] {
 ...
 */
export function isDiscount(obj): obj is Discount {
  if (!isObject(obj)) return false;
 ...
 */
export function isPromotion(obj): obj is Promotion {
  if (!isObject(obj)) return false;
 ...
 */
export function isCategory(obj): obj is Category {
  if (!isObject(obj)) return false;
 ...
 */
export function isValidRating(rating): boolean {
 ...
 */
export function isValidPercentage(percentage): boolean {
 ...
 */
export function isSuccessResponse<T>(response): response is { success: true; data: T } {
  return (
    isObject(response) &&
 ...
 */
export function isErrorResponse(response): response is { success: false; error: string } {
  return (
    isObject(response) &&
 ...
 */
export function isPaginatedResponse<T>(response): response is {
  data: T[];
  total: number;
  page: number;
  limit: number;
 ...
 */
export function safeGet<T>(obj, path: string, defaultValue: T): T {
 ...
 */
export function safeNumber(value, defaultValue: number = 0): number {
 ...
 */
export function safeString(value, defaultValue: string = ''): string {

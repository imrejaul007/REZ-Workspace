...
function processFile(filePath) {
  ...
  if (!content.includes('console.')) {
    logger.info(`✅ ${filePath} - No console statements found`);
  ...
  logger.info(`✅ ${filePath} - ${replacements} replacements made`);
...
function processAllFiles() {
  ...
  logger.info('\n📊 Summary:');
  logger.info(`   Files processed: ${filesProcessed}/${priorityFiles.length}`);
  logger.info(`   Files modified: ${filesWithReplacements}`);

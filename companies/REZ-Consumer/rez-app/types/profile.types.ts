...
export interface ProfileContextType {
  ...
  // Navigation
  navigateToScreen: (route: string, params?) => void;
}
...
export const PROFILE_COLORS = {
  ...
  primaryDark: colors.secondary[600], // Nile Blue
  secondary: colors.primary[500], // Light Mustard
  gold: colors.primary[500],
  goldDark: colors.primary[700],
  background: colors.linen, // Linen
  surface: colors.text.white,
...
export const PROFILE_GRADIENTS = {
  primary: gradients.nileBlue, // REZ Blue gradient
  secondary: gradients.primary, // Mustard gradient
  card: ['transparent', 'rgba(0, 0, 0, 0.1)'],
  referral: gradients.warmAccent, // Mustard for referral
  partner: gradients.nileBlue, // Blue for partner program
} as const;

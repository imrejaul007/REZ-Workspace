...
/**
 * GeoJSON standard: [longitude, latitude] tuple.
 ...
 * NOT as { lat, lng }.
 *
 * If you receive coordinates as { lat, lng } or { latitude, longitude }, use
 * normalizeCoordinates() from the storesApi utility to convert to GeoJSON.
 */
...
export interface Location {
  ...
  zip?: string;
  country?: string;
  /** GeoJSON [longitude, latitude] tuple — not { lat, lng } */

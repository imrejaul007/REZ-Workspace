...
// Cashback event payloads
export interface CashbackCreditedPayload {
  userId: string;
  orderId: string;
  amount: number;
  currency: string;
...
export interface CashbackReversedPayload {
  userId: string;
  orderId: string;
  amount: number;
  currency: string;
...
// Cashback callback types
export type CashbackCreditedCallback = (payload: CashbackCreditedPayload) => void;
export type CashbackReversedCallback = (payload: CashbackReversedPayload) => void;

// Streak/milestone event payloads
export interface StreakMilestonePayload {
  userId: string;
  streakCount: number;
  milestoneType: 'daily_checkin' | 'spending' | 'orders' | 'referral';
...
// Streak callback types
export type StreakMilestoneCallback = (payload: StreakMilestonePayload) => void;
export type StreakBrokenCallback = (payload: StreakBrokenPayload) => void;
...
export const config = {
  ...
  // Service URLs
  services: {
    marketing: process.env.MARKETING_SERVICE_URL || 'http://localhost:4000',
    notification: process.env.NOTIFICATION_SERVICE_URL || 'http://localhost:4011',
    profile: process.env.PROFILE_SERVICE_URL || 'http://localhost:4016',
    order: process.env.ORDER_SERVICE_URL || 'http://localhost:4012',
    intent: process.env.INTENT_SERVICE_URL || 'http://localhost:4009',
    mind: process.env.MIND_SERVICE_URL || 'http://localhost:4008',
  },
  ...
  ml: {
    modelServer: process.env.MODEL_SERVER_URL || 'http://localhost:5000',
    featureStore: process.env.FEATURE_STORE_URL || 'http://localhost:5001',
  },

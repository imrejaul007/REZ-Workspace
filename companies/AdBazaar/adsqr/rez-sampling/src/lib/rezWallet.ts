...
export async function debitCoins(
  ...
  try {
    ...
    logger.error('Debit coins error:', error);
...
export async function claimWelcomeCoins(): Promise<CreditResult> {
  try {
    ...
    logger.error('Claim welcome coins error:', error);
...
export async function creditBrandCoins(
  ...
  try {
    ...
    logger.error('Credit brand coins error:', error);
...
export async function getBrandCoinBalance(
  ...
  try {
    ...
    logger.error('Get brand coin balance error:', error);
    return null;
  }
}
...
export async function batchCreditRewards(
  ...
  try {
    ...
    logger.error('Batch credit error:', error);
    return {
      success: false,

...
export async function creditScanReward(
  ...
  try {
    ...
    logger.error('Credit scan reward error:', error);
...
export async function creditVisitReward(
  ...
  try {
    ...
    logger.error('Credit visit reward error:', error);
...
export async function creditPurchaseReward(
  ...
  try {
    ...
    logger.error('Credit purchase reward error:', error);
...
async function recordLocalTransaction(
  ...
  try {
    ...
    logger.error('Record local transaction error:', error);
  }
}
...
export async function creditFirstTimeBonus(
  ...
  try {
    ...
    logger.error('Credit first time bonus error:', error);

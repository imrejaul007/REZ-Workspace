...
export async function POST(req: NextRequest) {
  try {
    ...
    if (distError) {
      ...
      logger.error('[brand-coins/distribute] insert error:', distError)
      return NextResponse.json(
    ...
    if (updateError) {
      logger.error('[brand-coins/distribute] update error:', updateError)
    ...
    logger.error('[brand-coins/distribute] error:', e)
    return NextResponse.json(

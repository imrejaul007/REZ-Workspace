/**
 * Test Setup for Instagram Publishing Service
...
process.env.MONGODB_URI = 'mongodb://localhost:27017/instagram-publishing-test';
...
process.env.WEBHOOK_CALLBACK_URL = 'https://test.example.com/webhook';

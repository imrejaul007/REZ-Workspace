 ...
 */
router.post('/api/events/conversion', verifyInternal, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: internal service auth
 */
router.post('/api/events/attribution', verifyInternal, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: internal service auth
 */
router.post('/api/events/roi', verifyInternal, async (req: Request, res: Response) => {
  try {

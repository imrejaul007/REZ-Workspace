/**
 * Category Routes - Express routes for response category operations
 */
 ...
 */
categoryRoutes.post('/:id/toggle', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Failed to toggle category', { error, categoryId: req.params.id });

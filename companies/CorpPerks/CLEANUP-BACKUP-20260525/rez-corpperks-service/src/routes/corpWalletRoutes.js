...
// Auth middleware - validates JWT tokens via RABTUL
const requireAuth = async (req, res, next) => {
  ...
  try {
    ...
    console.error('[Auth] RABTUL verify failed:', e);
    return res.status(401).json({ success: false, message: 'Invalid token' });
  }
};
...
router.get('/personal/:employeeId', requireAuth, (req, res) => {
...
router.post('/personal/:employeeId/topup', requireAuth, (req, res) => {
...
router.post('/personal/:employeeId/spend', requireAuth, (req, res) => {
...
router.get('/corporate/:companyId', requireAuth, (req, res) => {
...
router.get('/employee-corporate/:employeeId', requireAuth, (req, res) => {
...
router.get('/employee-corporate/:employeeId/:type', requireAuth, (req, res) => {
  const wallet = employeeCorporateWallets.get(req.params.employeeId);
  if (!wallet) {
    return res.status(404).json({ success: false, message: 'Corporate wallet not found' });
  }
...
router.post('/employee-corporate/:employeeId/spend', requireAuth, (req, res) => {
...
router.get('/combined/:employeeId', requireAuth, (req, res) => {
...
router.post('/compare-benefits', requireAuth, (req, res) => {

...
const MOCK_EMPLOYEES: Employee[] = [
  {
    ...
    benefits: [
      { benefitType: 'meal', allocatedAmount: 2000, remainingAmount: 1500, isActive: true },
      { benefitType: 'travel', allocatedAmount: 10000, remainingAmount: 8000, isActive: true },
    ],
    stats: { totalOrders: 12, totalSpend: 45000 },
  },
  {
    _id: '2',
    userId: {
    ...
    benefits: [
      { benefitType: 'meal', allocatedAmount: 2000, remainingAmount: 800, isActive: true },
      { benefitType: 'travel', allocatedAmount: 10000, remainingAmount: 5000, isActive: true },
      { benefitType: 'gift', allocatedAmount: 5000, remainingAmount: 5000, isActive: true },
    ],
    stats: { totalOrders: 25, totalSpend: 120000 },
  },
  {
    _id: '3',
    userId: {
    ...
    corpRole: 'corp_hr',
    benefits: [
      { benefitType: 'meal', allocatedAmount: 2000, remainingAmount: 2000, isActive: true },
      { benefitType: 'wellness', allocatedAmount: 1500, remainingAmount: 1500, isActive: true },
    ],
    stats: { totalOrders: 8, totalSpend: 18000 },
  },
  {
    _id: '4',
    userId: {
    ...
    corpRole: 'corp_employee',
    benefits: [],
    stats: { totalOrders: 0, totalSpend: 0 },
  },
];

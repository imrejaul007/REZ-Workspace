...
const MOCK_INVOICES: GSTInvoice[] = [
  ...
  {
    _id: '3',
    invoiceNumber: 'CP/GFT/2024-04/00003',
    invoiceDate: '2024-04-20T09:00:00Z',
    recipient: {
      companyName: 'Acme Technologies Pvt Ltd',
      gstIn: '27AABCU9603R1ZM',
    },
    transaction: {
      type: 'gifting',
      description: 'Diwali Gift Hampers - 50 Employees',
    },
    taxSummary: {
      taxableAmount: 44643,
      cgstAmount: 2679,
  ...
  {
    _id: '4',
    invoiceNumber: 'CP/DIN/2024-04/00004',
    invoiceDate: '2024-04-22T20:00:00Z',
    recipient: {
      companyName: 'Beta Solutions Ltd',
      gstIn: '29AADCB2232M1ZX',
    },
    transaction: {
      type: 'dining',
      description: 'Client Dinner - Mumbai',
    },
    taxSummary: {
      taxableAmount: 8475,
      cgstAmount: 763,

...
Hotel booking and OTA (Online Travel Agency) microservice integrating with StayOwn API.
...
- Integration with StayOwn hotel inventory
...
4. Configure StayOwn credentials

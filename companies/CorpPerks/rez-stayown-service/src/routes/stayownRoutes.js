...
function secureRandom() {
  ...
  crypto.randomBytes(4).copy(array);
  return array[0];
}
...
router.post('/bookings', requireAuth, (req, res) => {
  ...
  const booking = {
    ...
    confirmationNumber: `MCB${new Date().getFullYear()}${String(new Date().getMonth() + 1).padStart(2, '0')}${String(secureRandom() % 10000).padStart(4, '0')}`,
    status: 'confirmed',

 ...
 * POST /connectors/corpperks/sync
 */
router.post('/connectors/corpperks/sync', async (req: Request, res: Response) => {
  try {
 ...
 * POST /connectors/corpperks/performance
 */
router.post('/connectors/corpperks/performance', async (req: Request, res: Response) => {
  try {
    const CORPPERKS_URL = process.env.CORPPERKS_URL || 'http://localhost:4006';
    const INTERNAL_TOKEN = process.env.INTERNAL_TOKEN || 'corpid-internal-token';
 ...
 * POST /connectors/memoryos/sync
 */
router.post('/connectors/memoryos/sync', async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/connectors/github/sync', async (req: Request, res: Response) => {
  try {
 ...
 * POST /connectors/lms/sync
 */
router.post('/connectors/lms/sync', async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/connectors/calendar/sync', async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/connectors/jira/sync', async (req: Request, res: Response) => {
  try {

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
              <a href="https://peopleos.vercel.app/demo" className="text-purple-600 font-medium hover:text-purple-700">Try Demo</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 py-4">
            <div className="px-4 space-y-4">
              ...
              <a href="https://peopleos.vercel.app/demo" className="block text-purple-600 font-medium">Try Demo</a>
              <a href="#pricing" className="block text-gray-600">Pricing</a>
              <a href="#contact" className="block text-gray-600">Contact</a>
              <a href="https://peopleos.vercel.app" className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-5 py-2 rounded-lg font-medium text-center">
                Get Started Free
              </a>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                features: ['StayOwn hotel network', 'GST invoices included', 'Approval workflows'],
              },
              {
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="https://peopleos.vercel.app" className="hover:text-white transition-colors">PeopleOS</a></li>
                <li><a href="https://talentai.vercel.app" className="hover:text-white transition-colors">TalentAI</a></li>
                <li><a href="https://insight-campus.vercel.app" className="hover:text-white transition-colors">Insight Campus</a></li>

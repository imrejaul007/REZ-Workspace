...
AI-powered financial analyst digital twin
...
|--------|----------|-------------|
| GET | `/health` | - |
| GET/POST/PUT/DELETE | `/api/analyze/{symbol}` | - |
| GET/POST/PUT/DELETE | `/api/earnings` | - |
| GET/POST/PUT/DELETE | `/api/valuation` | - |
...
```bash
# Build
docker build -t assetmind-analyst-twin .

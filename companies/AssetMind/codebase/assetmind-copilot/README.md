...
AI-powered investment copilot assistant
...
|--------|----------|-------------|
| GET | `/health` | - |
| GET/POST/PUT/DELETE | `/api/chat` | - |
| GET/POST/PUT/DELETE | `/api/recommend` | - |
...
```bash
# Build
docker build -t assetmind-copilot .

# Run
docker run -p 5295:5295 \

...
Institutional capital flow tracking and analysis
...
| `FLOW_DATA_API_KEY` | Yes | See description |
...
| GET/POST/PUT/DELETE | `/api/ownership/{symbol}` | - |
...
```bash
# Build
docker build -t assetmind-capital-flow .

    ...
    async function handleCallback() {
      try {
        ...
        if (!tokenRes.ok) {
          ...
          logger.error('[rez-callback] Token exchange failed:', errData);
        ...
        if (!access_token) {
          logger.error('[rez-callback] Missing access_token:', tokenData);
        ...
        if (!ssoRes.ok) {
          ...
          logger.error('[rez-callback] REZ SSO failed:', errData);
        ...
        logger.error('[rez-callback] Error:', err);

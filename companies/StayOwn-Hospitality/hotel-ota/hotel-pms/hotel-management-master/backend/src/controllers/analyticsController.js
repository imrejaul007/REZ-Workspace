...
export const getHotelMetrics = async (req, res) => {
  try {
    ...
    logger.info(🏨 HOTEL METRICS - Fetching metrics for hotel ${hotelId}`);
    ...
    logger.info(🏨 HOTEL METRICS - Date range: ${defaultStartDate.toISOString()} to ${defaultEndDate.toISOString()}`);
    ...
    logger.info(🏨 HOTEL METRICS - Total rooms: ${totalRooms}`);
    ...
    logger.info(🏨 HOTEL METRICS - Occupied: ${occupiedRooms}, Available: ${availableRooms}, Occupancy: ${occupancyRate}%`);
    ...
    logger.info(🏨 HOTEL METRICS - Revenue: ₹${totalRevenue}, ADR: ₹${averageDailyRate}, RevPAR: ₹${revenuePerAvailableRoom}`);
    ...
    logger.info(🏨 HOTEL METRICS - Final metrics:`, metrics);

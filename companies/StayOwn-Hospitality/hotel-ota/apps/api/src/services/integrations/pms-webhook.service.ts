...
export class PmsWebhookService {
  ...
  static notifyBookingConfirmed(params: {
    ...
    pmsNotificationQueue.add(
      ...
      logger.error('[PmsWebhook] Failed to enqueue booking_confirmed:', err.message)
    );
  }
  ...
  static notifyBookingCancelled(params: {
    ...
    pmsNotificationQueue.add(
      ...
      logger.error('[PmsWebhook] Failed to enqueue booking_cancelled:', err.message)
    );
  }
  ...
  static notifyCheckIn(params: {
    ...
    pmsNotificationQueue.add(
      ...
      logger.error('[PmsWebhook] Failed to enqueue booking_checkin:', err.message)
    );
  }
  ...
  static notifyCheckOut(params: {
    ...
    pmsNotificationQueue.add(
      ...
      logger.error('[PmsWebhook] Failed to enqueue booking_checkout:', err.message)
    );
  }
}

...
| **hotel-os-integration** | 3899 | Unified RTNM integration layer (BrandPulse, Sentiment, etc.) |

#### BrandPulse Integration (4770)

| Feature | Description | Endpoint |
|---------|-------------|----------|
| **Brand Overview** | Stats, trends, alerts | `/api/rtnm/brand/:id/overview` |
| **Sentiment Trend** | Day/Week/Month analysis | `/api/rtnm/brand/:id/sentiment` |
| **Rating Distribution** | 1-5 star breakdown | `/api/rtnm/brand/:id/ratings` |
| **Aspect Analysis** | Service, food, ambiance, etc. | `/api/rtnm/brand/:id/aspects` |
| **Create Review** | Add new review | `/api/rtnm/reviews` |
| **Brand Reputation** | Legacy compatibility | `/api/rtnm/reputation/:hotelId` |

**SDK Integration:** `RTNMHotelSDK.getBrandOverview()`, `RTNMHotelSDK.getSentimentTrend()`, `RTNMHotelSDK.createReview()`
...
## 1.6 BrandPulse - Real-time Brand Intelligence
...
### 9.2.1 RTNM Ecosystem Integration (NEW - June 2026)

StayOwn Hotel OS now integrates with all RTNM ecosystem companies.

#### Airzy Flight Integration

| Feature | Description | Status |
|---------|-------------|--------|
| Flight Delay Notification | Receive delays from Airzy | ✅ |
| Cancellation Alert | Notify of cancellations | ✅ |
| Guest Arrival Sync | Coordinate arrival times | ✅ |
| Room Prep Adjustment | Adjust based on delay | ✅ |

#### KHAIRMOVE Transfer Integration

| Feature | Description | Status |
|---------|-------------|--------|
| Transfer Requests | Get scheduled pickups | ✅ |
| Airport Transfer Booking | Book transfers | ✅ |
| Driver Status | Real-time driver location | ✅ |
| Guest Notification | Alert guest of ETA | ✅ |
| Ride Linking | Link to hotel booking | ✅ |

#### Nexha Procurement Integration

| Feature | Description | Status |
|---------|-------------|--------|
| Supply Requirements | Get hotel supply needs | ✅ |
| Supply Orders | Submit orders | ✅ |
| Approved Suppliers | Access supplier list | ✅ |
| Order Tracking | Track deliveries | ✅ |

#### RidZa Finance Integration

| Feature | Description | Status |
|---------|-------------|--------|
| Finance Overview | Complete financial picture | ✅ |
| Revenue Analytics | Revenue breakdown | ✅ |
| Expense Tracking | Cost analysis | ✅ |
| Occupancy Analytics | Occupancy metrics | ✅ |
| Credit Options | Hotel financing | ✅ |
| Insurance Needs | Recommended coverage | ✅ |

#### AdBazaar Marketing Integration

| Feature | Description | Status |
|---------|-------------|--------|
| Guest List | Get hotel guests | ✅ |
| Hotel Campaigns | Create targeted campaigns | ✅ |
| Campaign Tracking | Track conversions | ✅ |
| Guest Preferences | Personalization data | ✅ |
| Loyalty Members | Target loyalty tier | ✅ |
...
| Feature | Description | Status |
|---------|-------------|--------|
| Hotel Search | Search for corporate travel | ✅ |
| Corporate Booking | Book on behalf of company | ✅ |
| Booking Status | Track corporate bookings | ✅ |
| Policy Sync | Sync travel policies | ✅ |

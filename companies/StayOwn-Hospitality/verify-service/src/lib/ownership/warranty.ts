...
export async function setupWarranty(
  ...
  try {
    ...
    logger.error('Setup warranty error:', error)
...
export async function getWarrantyInfo(serialId: string): Promise<WarrantyInfo | null> {
  try {
    ...
    logger.error('Get warranty info error:', error)
    return null
  }
}
...
export async function extendWarranty(
  ...
  try {
    ...
    logger.error('Extend warranty error:', error)
...
export async function getUserWarrantyClaims(
  ...
  try {
    ...
    logger.error('Get user warranty claims error:', error)
    return []
  }
}

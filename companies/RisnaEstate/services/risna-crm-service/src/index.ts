...
process.env.SERVICE_NAME = process.env.SERVICE_NAME || 'risna-crm-service';
...
async function main(): Promise<void> {
  validateEnv();
  logger.info('Starting risna-crm-service...');
  ...
  const healthPort = parseInt(process.env.HEALTH_PORT || '4205', 10);
  ...
  logger.info('risna-crm-service ready');
}

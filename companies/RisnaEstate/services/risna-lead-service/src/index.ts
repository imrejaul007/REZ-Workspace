...
process.env.SERVICE_NAME = process.env.SERVICE_NAME || 'risna-lead-service';
...
async function main(): Promise<void> {
  validateEnv();
  logger.info('Starting risna-lead-service...');
  ...
  const healthPort = parseInt(process.env.HEALTH_PORT || '4201', 10);
  ...
  logger.info('risna-lead-service ready');
}

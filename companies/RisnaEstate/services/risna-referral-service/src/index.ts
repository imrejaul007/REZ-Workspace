...
process.env.SERVICE_NAME = process.env.SERVICE_NAME || 'risna-referral-service';
...
async function main(): Promise<void> {
  validateEnv();
  logger.info('Starting risna-referral-service...');
  ...
  const healthPort = parseInt(process.env.HEALTH_PORT || '4203', 10);
  ...
  logger.info('risna-referral-service ready');
}

...
import { CreateProjectSchema, UpdateProjectSchema, CreateTaskSchema, UpdateTaskSchema, CreateMilestoneSchema, ListProjectsQuerySchema, ListTasksQuerySchema, } from '../types.js';
...
router.patch('/milestones/:milestoneId/complete', asyncHandler(async (req, res) => {
    const userId = req.userId;
    const tenantId = req.tenantContext.tenant_id;
...
router.delete('/milestones/:milestoneId', asyncHandler(async (req, res) => {
    const userId = req.userId;
    const tenantId = req.tenantContext.tenant_id;
    const milestoneId = req.params.milestoneId;

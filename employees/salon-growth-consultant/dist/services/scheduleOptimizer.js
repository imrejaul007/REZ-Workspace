...
exports.scheduleOptimizerService = exports.ScheduleOptimizerService = void 0;
/**
...
class ScheduleOptimizerService {
     ...
     */
    analyzeSchedule(staff, services, appointments, targetUtilization) {
     ...
     */
    calculateHourlyDemand(appointments) {
     ...
     * Identify understaffed slots
     */
    identifyUnderstaffedSlots(hourlyDemand, staff) {
        const slots = [];
        // Check prime hours
     ...
     * Identify overstaffed slots
     */
    identifyOverstaffedSlots(hourlyDemand, staff, appointments) {
        const slots = [];
     ...
     */
    identifyRevenueOpportunities(hourlyDemand, services) {
        const opportunities = [];
     ...
     * Generate recommendations
     */
    generateRecommendations(optimization, staff) {
     ...
     * Create optimal schedule
     */
    createOptimalSchedule(staff, optimization) {
        const schedule = [];
     ...
     */
    generateBufferRecommendations(services) {
        const recommendations = [];
...
exports.ScheduleOptimizerService = ScheduleOptimizerService;
exports.scheduleOptimizerService = new ScheduleOptimizerService();
//# sourceMappingURL=scheduleOptimizer.js.map
...
exports.membershipManagerService = exports.MembershipManagerService = void 0;
/**
...
class MembershipManagerService {
     ...
     */
    generateMembershipProgram(avgServiceValue, goals) {
     ...
     */
    calculateMetrics(clientMetrics, program, avgServiceValue) {
        ...
        const monthlyRecurringRevenue = tierDistribution.reduce((sum, tier) => sum + tier.count * tier.revenue, 0);
        // Premium members count
        const premiumMembers = tierDistribution.find(t => t.tier === 'Gold').count +
     ...
     * Generate recommendations
     */
    generateRecommendations(clientMetrics, metrics, goals) {
     ...
     */
    generateCampaigns(clientMetrics, goals) {
        const campaigns = [];
     ...
     */
    projectImpact(clientMetrics, metrics) {
...
exports.MembershipManagerService = MembershipManagerService;
exports.membershipManagerService = new MembershipManagerService();

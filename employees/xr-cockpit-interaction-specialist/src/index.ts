/**
 * HOJAI XR Cockpit Interaction Specialist Agent
 * Port: 5123
 */
...
const PORT = 5123;
const SERVICE_NAME = 'xr-cockpit-interaction-specialist';
...
app.get('/api/info', (req, res) => {
  res.json({
    ...
    version: '1.0.0',
    description: 'Cockpit-based XR control systems specialist',
    capabilities: {
      cockpit_design: true,

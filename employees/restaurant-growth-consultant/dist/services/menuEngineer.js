...
exports.menuEngineerService = exports.MenuEngineerService = void 0;
/**
 ...
 */
class MenuEngineerService {
    TARGET_MARGIN = 0.68; // 68% gross margin (32% food cost)
    POPULARITY_THRESHOLD = 50;
    MARGIN_THRESHOLD = 0.60; // 60% margin
    /**
     * Analyze menu and provide engineering recommendations
     */
    async analyzeMenu(request) {
     ...
     */
    generateRecommendations(analysis, targetFoodCostPercent) {
     ...
     */
    suggestNewItems(analysis, existingItems) {
        const suggestions = [];
...
exports.MenuEngineerService = MenuEngineerService;
exports.menuEngineerService = new MenuEngineerService();

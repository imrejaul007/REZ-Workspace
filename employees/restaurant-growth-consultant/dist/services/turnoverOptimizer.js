...
exports.turnoverOptimizerService = exports.TurnoverOptimizerService = void 0;
/**
 ...
 */
class TurnoverOptimizerService {
    TARGET_TURN_TIME = {
    ...
    async analyze(request) {
        ...
        const recommendations = this.generateRecommendations(peakHours, tableMetrics, currentUtilization, request.avgOrderValue);
     ...
     */
    analyzePeakHours(peakHourCovers) {
     ...
     */
    calculateTableMetrics(tableConfigs, avgOrderValue) {
     ...
     */
    identifyBottlenecks(request, peakHours) {
        const bottlenecks = [];
     ...
     */
    calculateRevenuePerSeatHour(request, tableMetrics) {
     ...
     */
    generateRecommendations(peakHours, tableMetrics, currentUtilization, avgOrderValue) {
     ...
     * Generate schedule optimizations
     */
    generateScheduleOptimizations(peakHours) {
     ...
     */
    recommendAutomation(tableMetrics, bottlenecks) {
        const automation = [];
        // QR ordering
        automation.push({
     ...
     */
    async calculateOptimalLayout(totalSeats, avgPartySize, peakCovers) {
        const optimalMix = [];
...
exports.TurnoverOptimizerService = TurnoverOptimizerService;
exports.turnoverOptimizerService = new TurnoverOptimizerService();
//# sourceMappingURL=turnoverOptimizer.js.map
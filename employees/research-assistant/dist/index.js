/**
 * HOJAI Research Assistant - Main Entry Point
...
const SERVICE_NAME = 'research-assistant';
...
app.get('/health/ready', (_req, res) => {
    // Research assistant is stateless, always ready
    res.json({
        status: 'ready',
        checks: {
            service: 'ready',
...
app.get('/api/info', (_req, res) => {
    res.json({
        service: SERVICE_NAME,
        version: SERVICE_VERSION,
        description: 'AI-powered research assistant for market research, competitor analysis, and report generation',
        tagline: 'AI-powered research that delivers insights, not just data.',
        capabilities: {
            search: true,
        ...
        endpoints: {
            ...
            competitor: 'POST /api/research/competitor',
            report: 'POST /api/research/report',
            trends: 'GET /api/research/trends',
            summarize: 'POST /api/research/summarize',
            comprehensive: 'POST /api/research/comprehensive',
        },
        timestamp: new Date().toISOString(),
    });
});
...
app.use('/api/research/comprehensive', expensiveOperationsLimiter);
app.use('/api/research/report', expensiveOperationsLimiter);
// Research routes
...
║   Version: ${SERVICE_VERSION.padEnd(54)}║
║                                                                      ║
║   Capabilities:                                                      ║
║   - Web Search                                                       ║
║   - Competitor Analysis                                              ║
...
║                                                                      ║
║   "AI-powered research that delivers insights, not just data."       ║
║                                                                      ║
╚══════════════════════════════════════════════════════════════════════╝
      `);
        });

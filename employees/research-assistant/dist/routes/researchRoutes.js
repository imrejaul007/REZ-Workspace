...
import { SearchQuerySchema, CompetitorAnalysisSchema, ReportGenerationSchema, TrendsQuerySchema, SummarizeSchema, } from '../types.js';
...
// ============================================================================
router.post('/competitor', asyncHandler(async (req, res) => {
    const tenantId = req.tenantContext.tenant_id;
    const userId = req.userId;
    // Validate request body
...
// ============================================================================
router.get('/trends/:category', asyncHandler(async (req, res) => {
    const tenantId = req.tenantContext.tenant_id;
    const userId = req.userId;
...
// ============================================================================
router.get('/trends/search', asyncHandler(async (req, res) => {
    const tenantId = req.tenantContext.tenant_id;
    const userId = req.userId;
...
// ============================================================================
router.get('/trends/analytics', asyncHandler(async (req, res) => {
    const tenantId = req.tenantContext.tenant_id;
    const userId = req.userId;
...
router.post('/comprehensive', asyncHandler(async (req, res) => {
    ...
    const results = await researchService.comprehensiveResearch(topic, includeReport ?? true, includeTrends ?? true, includeCompetitors ?? false);
    res.json(createResponse(true, results, undefined, { tenantId }));
}));
// ============================================================================
...
//# sourceMappingURL=researchRoutes.js.map
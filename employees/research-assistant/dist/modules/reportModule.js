 ...
 */
function getReportTemplate(topic, format, audience) {
    const templates = {
        summary: {
 ...
 */
function generateSectionContent(title, contentTemplate, topic, format) {
...
export async function generateReport(input) {
    ...
    // Generate sections
    const reportSections = template.sections.map((section, index) => ({
        title: section.title,
 ...
 */
function generateChartData(topic) {
    return {
        marketSize: {
 ...
 */
export async function generateReportSummary(topic, length = 'medium') {

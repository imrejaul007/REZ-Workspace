 ...
 */
function getCompetitorList(company, customCompetitors) {
 ...
 */
function getSWOTAnalysis(companyKey) {
 ...
 */
function getProductOfferings(companyKey) {
 ...
 */
function generateMarketPosition(company) {
 ...
 */
function generatePricingComparison(company) {
    return [
        {
 ...
 */
function generateMarketShare(company) {
 ...
 */
export async function generateCompetitiveInsights(company) {
...
//# sourceMappingURL=analysisModule.js.map
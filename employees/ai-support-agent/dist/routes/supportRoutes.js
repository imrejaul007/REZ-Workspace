...
import { CreateTicketSchema, TicketQuerySchema, ResolveTicketSchema, AddMessageSchema, EscalateSchema, WarrantyCheckSchema, WarrantyClaimSchema, RefundProcessSchema, RefundPreviewSchema, CreateFAQSchema, FAQSearchSchema, } from '../types.js';
...
function createResponse(success, data, error, meta) {
    return {
        success,
        ...(data !== undefined && { data }),
        ...(error && { error }),
...
router.post('/tickets/:id/messages', asyncHandler(async (req, res) => {
    ...
    const message = await ticketService.addMessage(ticketId, authorId || req.userId, authorType || 'customer', content, attachments);
    if (!message) {
        res.status(404).json(createResponse(false, undefined, {
            code: 'NOT_FOUND',
            message: 'Ticket not found',
...
router.get('/tickets/stats', asyncHandler(async (req, res) => {
    const tenantId = req.tenantContext.tenant_id;
...
router.get('/escalate/rules', asyncHandler(async (_req, res) => {
...
router.get('/escalate/teams', asyncHandler(async (_req, res) => {
...
router.post('/warranty/check', asyncHandler(async (req, res) => {
...
router.post('/warranty/claim', asyncHandler(async (req, res) => {
...
router.get('/warranty/:id', asyncHandler(async (req, res) => {
...
router.get('/warranty/stats', asyncHandler(async (_req, res) => {
...
router.post('/refund/preview', asyncHandler(async (req, res) => {
    ...
    const preview = await refundService.previewRefund(parseResult.data.orderId, parseResult.data.customerId, parseResult.data.reason);
    res.json(createResponse(true, preview));
}));
// POST /api/support/refund/process - Process refund
router.post('/refund/process', asyncHandler(async (req, res) => {
...
router.get('/refund/:id', asyncHandler(async (req, res) => {
...
router.patch('/refund/:id/approve', asyncHandler(async (req, res) => {
    const refundId = req.params.id;
...
router.patch('/refund/:id/reject', asyncHandler(async (req, res) => {
    const refundId = req.params.id;
...
router.get('/refund/stats', asyncHandler(async (_req, res) => {
...
router.post('/faq/search', asyncHandler(async (req, res) => {
...
router.get('/faq/:id', asyncHandler(async (req, res) => {
...
router.post('/faq/:id/feedback', asyncHandler(async (req, res) => {
    const faqId = req.params.id;
...
router.get('/customer/:id/history', asyncHandler(async (req, res) => {
...
router.get('/customer/:id/profile', asyncHandler(async (req, res) => {
    const customerId = req.params.id;
...
router.get('/customer/:id/sentiment', asyncHandler(async (req, res) => {
    const customerId = req.params.id;
...
router.post('/customer/search', asyncHandler(async (req, res) => {
...
router.get('/customers/at-risk', asyncHandler(async (req, res) => {

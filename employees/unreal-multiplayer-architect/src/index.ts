/**
 * HOJAI Unreal Multiplayer Architect Agent
 * Port: 5110
 */
...
const PORT = 5110;
const SERVICE_NAME = 'unreal-multiplayer-architect';
...
app.get('/api/info', (req, res) => {
  res.json({
    ...
    version: '1.0.0',
    description: 'Unreal Engine networking specialist',
    capabilities: {
      actor_replication: true,
      game_mode: true,

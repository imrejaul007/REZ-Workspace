 ...
 */
router.post('/churn', (req: Request, res: Response) => {
 ...
 */
router.post('/ltv', (req: Request, res: Response) => {
  const ctx = req.tenantContext!;
  const { userId, features } = req.body;
 ...
 */
router.post('/propensity', (req: Request, res: Response) => {
  const ctx = req.tenantContext!;
  const { userId, features } = req.body;
 ...
 */
router.post('/revisit', (req: Request, res: Response) => {
  const ctx = req.tenantContext!;
  const { userId, features } = req.body;
...
router.post('/batch', (req: Request, res: Response) => {
  ...
  for (const item of batch) {
    ...
    let result: { score: number; confidence: number; [key: string]: unknown };

...
import { Insight, insightStore } from '../index.js';
 ...
 */
router.post('/generate/segment', (req: Request, res: Response) => {
  const ctx = req.tenantContext!;
 ...
 */
router.post('/generate/trend', (req: Request, res: Response) => {
  const ctx = req.tenantContext!;
 ...
 */
router.post('/generate/anomaly', (req: Request, res: Response) => {
  const ctx = req.tenantContext!;
 ...
 * Get severity levels
 */
router.get('/meta/severity', (req: Request, res: Response) => {
  const severity = [

...
import { Recommendation, recommendationStore, generateRecommendations } from '../index.js';
...
router.post('/personalized', (req: Request, res: Response) => {
  ...
  const allItems: Recommendation['items'] = [];
 ...
 */
router.get('/meta/strategies', (req: Request, res: Response) => {
  const strategies = [

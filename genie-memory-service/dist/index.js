/**
 * GENIE Memory Service - Main Entry Point
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/genie-memory';
const NODE_ENV = process.env.NODE_ENV || 'development';
const SERVICE_NAME = 'genie-memory-service';
...
app.use('/api/memories', writeLimiter);
// Memory routes

...
import { CreateMemorySchema, UpdateMemorySchema, SearchMemoriesSchema, ListMemoriesQuerySchema, RecallMemorySchema, AddTagsSchema, } from '../types.js';
...
router.post('/:id/link', asyncHandler(async (req, res) => {
    ...
    const tenantId = req.tenantContext.tenant_id;
    const memoryId = req.params.id;
    const related_memory_ids = req.body.related_memory_ids;

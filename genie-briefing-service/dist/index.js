/**
 * GENIE Briefing Service - Main Entry Point
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/genie-briefings';
const NODE_ENV = process.env.NODE_ENV || 'development';
const SERVICE_NAME = 'genie-briefing-service';
...
app.use('/api/briefings', writeLimiter);
// Briefing routes

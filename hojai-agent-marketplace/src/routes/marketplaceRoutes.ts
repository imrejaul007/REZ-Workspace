...
// Get featured agents
router.get('/agents/featured', async (req: res: Response) => {
  try {
...
// Get trending agents
router.get('/agents/trending', async (req: res: Response) => {
  try {
...
// Get new agents
router.get('/agents/new', async (req: res: Response) => {
  try {
...
router.get('/agents/industry/:industry', async (req: res: Response) => {
  try {
    const result = await marketplaceService.searchAgents({
...
router.get('/agents/category/:category', async (req: res: Response) => {
  try {
    const result = await marketplaceService.searchAgents({
...
// Get agent by slug
router.get('/agents/slug/:slug', async (req: res: Response) => {
  try {
...
// Update agent
router.put('/agents/:id', async (req: res: Response) => {
  try {
    const vendorId = req.headers['x-vendor-id'] as string;
...
// Delete agent
router.delete('/agents/:id', async (req: res: Response) => {
  try {
...
// Publish agent
router.post('/agents/:id/publish', async (req: res: Response) => {
  try {
...
// Archive agent
router.post('/agents/:id/archive', async (req: res: Response) => {
  try {
...
router.get('/installations', async (req: res: Response) => {
  try {
    const tenantId = req.headers['x-tenant-id'] as string;
...
router.get('/installations/:id', async (req: res: Response) => {
  try {
...
// Update installation
router.put('/installations/:id', async (req: res: Response) => {
  try {
    const tenantId = req.headers['x-tenant-id'] as string;
    const instance = await marketplaceService.getInstance(req.params.id);
...
// Uninstall agent
router.delete('/installations/:id', async (req: res: Response) => {
  try {
    const tenantId = req.headers['x-tenant-id'] as string;
    const instance = await marketplaceService.getInstance(req.params.id);
...
// Track usage
router.post('/installations/:id/usage', async (req: res: Response) => {
  try {
    const { type } = req.body;
...
// Get agent reviews
router.get('/agents/:id/reviews', async (req: res: Response) => {
  try {
...
// Mark review helpful
router.post('/reviews/:id/helpful', async (req: res: Response) => {
  try {
